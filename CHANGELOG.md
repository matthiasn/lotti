...
- **Goal agents get their first visible surface (experimental).** Behind the
  ...
  with its health at a glance — on/off-track verdict, percent of target, the
  agent's latest one-line report and a badge when a goal-change proposal
  awaits review. From there you can inspect an agent's interaction timeline,
