...
- **Rolling-week cards are better balanced.** Weekday labels now sit directly
  above their day squares and scroll with them, one legend serves all habit
  cards, and the reliability tail is captioned in weeks.
- **A design-panel polish pass across the goal-agent surfaces.** The banner's
  ...
  wide screens; day squares accept taps on a comfortably larger area; and
  chart target lines render at full strength.
