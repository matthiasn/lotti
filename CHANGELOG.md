...
- **Try an evidence-first task-agent mode with efficient models.** Enable the
  ...
  Melious model picker as an evaluated direct task-agent option. Custom report
  instructions and other executor models do not use the extra pass, and each
  model's token usage is tracked separately.
### Fixed
