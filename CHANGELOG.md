...
- Projects now expose a user-facing health band (`Surviving`, `On Track`,
  ...
  detail page, while keeping the underlying score internal.
- Project detail page now uses the cached `projectHealthMetricsProvider`
  instead of computing health metrics inline, eliminating duplicate work.
