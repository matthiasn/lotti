...
- The Habits tab was reworked to match the rest of the app. It now uses the same
  ...
  a habit is now a small celebration: the check pops in, the row gives a brief
  accent glow, its streak flame pulses and ticks up, the done count counts up and
  the progress bar eases forward, and finishing the last habit of the day lights
  the summary card with an all-done flourish.
