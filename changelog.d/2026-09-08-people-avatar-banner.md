### Added
- **A person can have a photo.** On a person's page, tap the avatar to choose a
  picture from your library and pick which part of it is the face — drag to
  move, pinch (or scroll) to zoom. The photo shows on the People list and on the
