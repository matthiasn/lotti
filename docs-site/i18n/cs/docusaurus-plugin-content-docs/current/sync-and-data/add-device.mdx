...
kterémkoli, telefonu i počítači. Žádné „hlavní“ zařízení neexistuje. Pokud ještě není připojené žádné
zařízení, tato stránka nepomůže — tvůj úplně první kód přichází ze strany
serveru: viz [Tvé první zařízení](./first-device.mdx).
...
Zařízení** a zvol **Nastavit synchronizaci**. Na telefonu se fotoaparát otevře hned; namiř ho na první zařízení. Na
počítači, nebo když fotoaparát není dostupný, zvol **Raději kód vložit** a použij zkopírovaný kód.
...
se neobjeví. Když všechno souhlasí, zvol **Kódy se shodují — připojit**.
