...
hvilken som helst, telefon eller computer. Der findes ingen «hovedenhed». Er ingen enhed forbundet endnu, kan denne
side ikke hjælpe — din allerførste kode kommer i stedet fra serversiden: se
[Din første enhed](./first-device.mdx).
...
Enheder**, og vælg **Konfigurer synkronisering**. På en telefon åbner kameraet med det samme; ret det mod den første
enhed. På computer, eller hvis kameraet ikke er tilgængeligt, vælg **Indsæt koden i stedet** for at bruge den kopierede kode.
...
ikke på den anden enhed. Når alt stemmer, vælg **Koderne matcher — forbind**.
