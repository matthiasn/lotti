...
2. Aktualisiere die gleichnamige deutsche Datei unter
...
3. Hinterlege sichtbare Demo-Texte über `manualScreenshotText(en: …, de: …)`.
4. Erfasse mit `make manual_screenshots` beide Sprachen in `../lotti-docs` –
...
Desktop-Dunkel für Englisch und Deutsch. Die Komponente wählt Sprache und
Design automatisch. Eine Änderung von Mobil/Desktop an einem Bild aktualisiert
sofort alle Screenshots und bleibt über Seiten und offene Tabs hinweg erhalten.
