...
egal welches, Telefon oder Desktop. Es gibt kein „Hauptgerät“. Ist noch gar kein Gerät verbunden, hilft diese
Seite nicht weiter — dein allererster Code kommt stattdessen von der
Serverseite: siehe [Dein erstes Gerät](./first-device.mdx).
...
Synchronisierungseinstellungen → Geräte** und wähle **Sync einrichten**. Auf dem Telefon öffnet sich die Kamera sofort;
richte sie auf das erste Gerät. Auf dem Desktop, oder wenn keine Kamera
verfügbar ist, wähle **Code stattdessen einfügen**, um den kopierten Code zu verwenden.
...
erscheinen auf dem anderen Gerät nicht. Wenn alles passt, wähle **Die Codes stimmen
überein — verbinden**.
