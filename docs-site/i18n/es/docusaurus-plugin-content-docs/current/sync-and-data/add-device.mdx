...
cualquiera, móvil u ordenador. No hay un dispositivo «principal». Si aún no hay ningún dispositivo
conectado, esta página no puede ayudarte — tu primer código viene del lado
del servidor: consulta [Tu primer dispositivo](./first-device.mdx).
...
dispositivo. En ordenador, o si la cámara no está disponible, elige **Pegar el código en su lugar** para usar el código copiado.
...
aparecen en el otro dispositivo. Cuando todo coincida, elige **Los códigos coinciden:
conectar**.
