...
[Examiner les changements proposés](../organize-and-reflect/task-agents.mdx#examiner-les-modifications-proposées)
pour les contrôles d’approbation de chaque tâche et leurs exceptions limitées
de titre initial et de langue.

L’utilisation de jetons des agents est suivie avec tout le reste du travail IA dans [Examiner l’utilisation et l’impact de l’IA](./usage.mdx).
