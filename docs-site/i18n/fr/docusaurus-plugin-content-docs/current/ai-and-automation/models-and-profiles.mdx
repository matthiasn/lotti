...
Utilise l’identifiant exact attendu par le fournisseur. Le nom d’affichage
n’existe que pour la lecture humaine ; le modifier ne change pas le modèle
exécuté par le fournisseur. N’annonce pas la prise en charge des images, de l’audio, des
