...
date attendent que tu les confirmes ou les écartes. Les exceptions sont le titre
et la langue : chacun est appliqué immédiatement lorsque *ce champ* est encore
vide et que l’agent le renseigne pour la première fois. Le reste de la tâche peut
être plein de travail — une tâche avec une description, des listes de contrôle et
du temps enregistré, mais sans langue définie, verra sa première langue appliquée
sans qu’on te demande. Dès qu’un champ a une valeur, la même règle d’approbation
humaine s’applique.
