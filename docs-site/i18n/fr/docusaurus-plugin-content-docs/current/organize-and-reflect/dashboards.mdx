...
Les tableaux de bord sont actuellement une fonctionnalité optionnelle, désactivée par défaut. Ouvre **Paramètres → Paramètres avancés → Flags** et active **Activer la page Tableaux de bord**. La destination **Tableaux de bord** et l’entrée **Gestion du tableau de bord** sous **Paramètres → Définitions** apparaissent alors.
...
1. Ouvre **Paramètres → Définitions → Gestion du tableau de bord**.
