...
La couverture est l’une des photos liées à l’événement. Tant que tu n’en
choisis pas, Lotti affiche la photo liée la plus récente et l’en-tête propose
**Définir couverture**, pour que la valeur par défaut ne passe jamais pour un
choix. Ouvre n’importe quelle photo en plein écran et touche **Définir
couverture** pour en faire la couverture ; la photo qui l’est déjà affiche
**Couverture** à cet endroit, et la galerie la signale. **Changer la
couverture** dans le menu de débordement ouvre le même sélecteur, où tu peux
aussi ajouter une nouvelle photo.
