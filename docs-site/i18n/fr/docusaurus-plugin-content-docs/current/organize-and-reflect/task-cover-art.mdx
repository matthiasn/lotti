---
title: Générer une illustration de couverture de tâche
description: Transforme le contexte propre à une tâche et des images de référence en illustration de couverture grâce à une compétence de génération d’images configurée.
---

# Générer une illustration de couverture de tâche
...
Consulte [Travailler avec les tâches](./tasks.mdx) pour savoir où apparaît l’illustration de couverture une fois créée.
