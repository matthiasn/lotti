...
## Explorer les connexions d’une tâche

Sur ordinateur, utilise l’action du graphe dans l’en-tête d’une tâche pour ouvrir son espace de
connaissances. La vue principale **Graphe** affiche un voisinage local lisible
autour de la tâche actuelle au lieu de comprimer tout le journal dans un seul
schéma. Sélectionne un nœud pour t’y déplacer. Utilise Revenir et Suivant pour
...
et le résumé IA détaillé reste replié jusqu’à ce que tu choisisses de le lire.
Au clavier, utilise les flèches pour déplacer la sélection, Entrée ou Espace
pour la suivre et Échap pour revenir.
