...
Une tâche peut avoir un agent de tâche : un assistant IA permanent avec sa propre configuration d'inférence, son rapport et son historique de propositions — voir [Affecter un agent de tâche](./task-agents.mdx).
...
Si une compétence de génération d'images est configurée, Lotti peut transformer le contexte d'une tâche et des images de référence en illustration de couverture — voir [Générer une illustration de couverture à partir d'images réelles de la tâche](./task-cover-art.mdx).
