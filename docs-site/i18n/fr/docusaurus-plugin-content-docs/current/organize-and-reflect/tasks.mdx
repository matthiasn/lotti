...
Utilise l’action du graphe dans l’en-tête d’une tâche pour ouvrir son espace de
...
schéma. Sélectionne un nœud pour t’y déplacer. Utilise Retour et Suivant pour
