...
Ouvre ensuite **Paramètres → Catégories** et active **Planification du jour** seulement pour les catégories que le planificateur peut utiliser. Cette liste d'autorisation garde les tâches sans rapport hors du plan et évite que Daily OS modifie du travail hors de ces catégories.
