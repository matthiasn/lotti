...
Ouvre **Paramètres → Définitions → Tableaux de bord**, modifie un tableau de bord et ajoute un graphique depuis **Questionnaires**. Les instruments disponibles sont :
...
Fermer le questionnaire demande si tu veux abandonner le résultat en cours. Un questionnaire annulé n'est pas enregistré, y compris les réponses déjà saisies. Si la réponse compte, termine l'étape de fin avant de quitter la feuille.
