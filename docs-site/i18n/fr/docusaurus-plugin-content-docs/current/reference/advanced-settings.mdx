...
français, italien, espagnol, tchèque, roumain ou portugais selon la langue de
ton appareil. Choisis **Anglais**, **Allemand**, **Français**, **Italien**,
**Espagnol**, **Tchèque**, **Roumain** ou **Portugais** pour conserver un autre
choix. L’entrée **Manuel** en bas des Réglages et **Aide → Manuel** sur macOS
utilisent toutes deux ce réglage.
