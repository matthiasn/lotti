...
Avant toute analyse, les données personnelles sont retirées des lignes de
journal : adresses e-mail, identifiants, jetons d'accès, chemins de fichiers
contenant ton nom d'utilisateur, adresses IP et numéros de téléphone sont
remplacés par des espaces réservés. Le rapport présente les trois constats qui
