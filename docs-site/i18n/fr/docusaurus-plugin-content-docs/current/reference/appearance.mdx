...
Ouvre **Paramètres → Thème** pour contrôler l’aspect de Lotti. Le mode
...
<ManualScreenshot
  ...
  alt="Paramètres Thème de Lotti avec les modes Apparence sombre, Automatique et Apparence claire, ainsi que les sélections de thèmes Sakura et Outer Space"
