...
contextuelles. Ouvre **Paramètres → Préférences → Raccourcis clavier** pour voir
chaque commande avec le raccourci adapté à ta plateforme.

<ManualScreenshot
  caseId="keyboard-shortcuts/catalog"
  alt="Paramètres Raccourcis clavier Lotti affichant les commandes de bureau regroupées par usage et leurs combinaisons de touches actuelles"
...
| Ouvrir Tableaux de bord, Journal, Événements ou Paramètres | Touche principale + 5 / 6 / 7 / 8 |
