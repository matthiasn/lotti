...
Ouvre **Paramètres → Préférences → Style d’enregistrement** pour choisir la
visualisation affichée pendant que Lotti enregistre de l’audio. Cela ne modifie
que la présentation : les deux styles représentent le même processus
d’enregistrement.
