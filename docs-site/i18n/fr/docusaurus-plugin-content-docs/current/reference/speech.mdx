...
Lorsque la lecture à voix haute est disponible, ouvre **Paramètres → Préférences
→ Parole**. Ces contrôles s’appliquent aux résumés IA des tâches ; ils ne
modifient ni la capture par microphone ni le fournisseur IA qui transcrit un
enregistrement.
