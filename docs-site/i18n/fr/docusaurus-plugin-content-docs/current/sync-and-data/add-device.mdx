...
« principal ». Si aucun appareil n'est encore connecté, cette page ne peut
pas t'aider — ton tout premier code vient du côté serveur : voir
...
Paramètres de synchronisation → Appareils** et choisis **Configurer la synchronisation**. Sur un
téléphone la caméra s'ouvre aussitôt ;
vise le premier appareil. Sur un ordinateur, ou si la caméra est indisponible,
choisis **Coller le code à la place** pour utiliser le code copié.
...
choisis **Les codes correspondent — connecter**.
