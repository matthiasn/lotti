...
Ouvre **Paramètres → Paramètres de synchronisation → Maintenance** pour les réparations et le
...
<ManualScreenshot
  ...
  caption="La maintenance réunit actions destructives, rejeu et nettoyage sur une même page. Le texte de confirmation définit la portée de chaque opération."
/>
