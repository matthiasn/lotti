...
Ouvre **Paramètres → Paramètres de synchronisation** pour accéder aux pages de configuration,
...
<ManualScreenshot
  ...
  alt="Vérification d’appareil Lotti comparant une séquence d’emoji manchot, poisson, fusée, glace, Terre, lune et étoile"
...
**Ils correspondent** sur les deux appareils seulement lorsque la séquence complète est
...
**Cet appareil** (« Nom et capacités de l’appareil ») identifie l’appareil
actuel auprès du reste du groupe de synchronisation. Donne-lui un nom qui distingue la machine
