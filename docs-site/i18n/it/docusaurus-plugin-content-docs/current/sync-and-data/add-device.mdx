...
qualsiasi, telefono o computer. Non esiste un dispositivo «principale». Se nessun dispositivo è ancora
connesso, questa pagina non può aiutarti — il tuo primissimo codice arriva
dal lato server: vedi [Il tuo primo dispositivo](./first-device.mdx).
...
Impostazioni di sincronizzazione → Dispositivi** e scegli **Configura la sincronizzazione**. Sul
telefono la fotocamera si apre subito:
inquadra il primo dispositivo. Su computer, o se la fotocamera non è
disponibile, scegli **Incolla invece il codice** per usare il codice copiato.
...
compaiono sull'altro dispositivo. Quando tutto corrisponde, scegli **I codici coincidono —
collega**.
...
- **Il nuovo dispositivo è connesso ma resta vuoto.** È lo stato previsto prima
  ...
  [Sincronizza i dispositivi](./sync.mdx) per posta in uscita e recupero.

Prosegui con [Sincronizza i dispositivi](./sync.mdx) per stato quotidiano,
