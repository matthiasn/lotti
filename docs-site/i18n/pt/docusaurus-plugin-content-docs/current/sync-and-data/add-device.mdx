...
qualquer um, telemóvel ou computador. Não há dispositivo «principal». Se ainda não há nenhum dispositivo ligado,
esta página não pode ajudar — o teu primeiríssimo código vem do lado do
servidor: vê [O teu primeiro dispositivo](./first-device.mdx).
...
Dispositivos** e escolhe **Configurar sincronização**. No telemóvel a câmara abre de imediato; aponta ao primeiro
dispositivo. No computador, ou se a câmara não estiver disponível, escolhe
**Colar o código em alternativa** para usares o código copiado.
...
não aparecem no outro dispositivo. Quando tudo coincidir, escolhe **Os códigos coincidem — ligar**.
