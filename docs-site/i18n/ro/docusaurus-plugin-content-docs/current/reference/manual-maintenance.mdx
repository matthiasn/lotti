...
Rulați `npm --prefix docs-site run coverage:complete` pentru pragul de lansare. Comanda eșuează până când fiecare suprafață inventariată este verificată; buildurile obișnuite incrementale ale manualului continuă să raporteze numerele rămase fără a bloca commituri pe subiecte.
