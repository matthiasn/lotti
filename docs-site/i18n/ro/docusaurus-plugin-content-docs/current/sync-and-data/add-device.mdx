...
oricare, telefon sau calculator. Nu există un dispozitiv „principal”. Dacă niciun dispozitiv nu este încă
conectat, această pagină nu vă poate ajuta — primul dumneavoastră cod vine
de pe partea de server: vedeți
...
Setări sincronizare → Dispozitive** și alegeți **Configurați sincronizarea**. Pe telefon camera se deschide imediat; îndreptați-o
spre primul dispozitiv. Pe calculator, sau dacă nu există cameră, alegeți
**Lipiți codul în schimb** pentru a folosi codul copiat.
...
pe celălalt dispozitiv. Când totul se potrivește, alegeți **Codurile coincid —
conectați**.
