...
som helst, telefon eller dator. Det finns ingen ”huvudenhet”. Är ingen enhet ansluten ännu kan den här
sidan inte hjälpa — din allra första kod kommer i stället från serversidan:
se [Din första enhet](./first-device.mdx).
...
Synkroniseringsinställningar → Enheter** och välj **Konfigurera synk**. På en telefon öppnas kameran direkt; rikta den mot
den första enheten. På dator, eller om kameran inte är tillgänglig, välj **Klistra in koden i stället** för att använda den kopierade koden.
...
inte på den andra enheten. När allt stämmer väljer du **Koderna stämmer — anslut**.
