...
test('browser locale matching uses the first supported language', () => {
  assert.equal(
    preferredSupportedLocale(
      ...
      ['en', 'de', 'fr', 'it', 'es', 'cs', 'nl', 'ro', 'pt', 'da', 'sv'],
      'en',
    ),
    'ro',
  );
...
test('locale root URLs preserve the default route and add alternatives', () => {
  ...
  assert.equal(
    localeRootUrl('/lotti/manual/development/', 'nl', 'en'),
    '/lotti/manual/development/nl/',
  );
  assert.equal(
  ...
  assert.equal(
    localeRootUrl('/lotti/manual/development/', 'da', 'en'),
    '/lotti/manual/development/da/',
  );
  assert.equal(
  ...
  assert.equal(
    localeRootUrl('/lotti/manual/development/', 'sv', 'en'),
    '/lotti/manual/development/sv/',
  );
});
