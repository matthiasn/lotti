...
![Category Settings - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/categories_empty.png)

Tap the plus icon at the bottom right to create a new category, and enter the name and hex color as
desired, for example:

![Health Category](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/category_health.png)
...
![Health Category - Color Picker](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/category_health_picker.png)
...
![Category Settings](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/categories.png)
...
![Habit Settings - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habits_empty.png)

Tap the plus icon and add a title:

![New Habit - 10k+ Steps](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit3_initial.png)

Here, you can also assign the category you created earlier, in this case `Fitness`:

![New Habit - Select Category](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit3_category.png)

Finally, save the habit:

![New Habit - 10k+ Steps](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit3_final.png)

Repeat creating habits until all the ones you want to start with are defined, for example:

![New Habit - 10k+ Steps](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habits.png)
...
![Habit - 10k+ Steps](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit_completions1.png)
...
![Habit - 10k+ Steps](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit_completion_10k_steps.png)
...
![Habit - 10k+ Steps backfilled](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit_completion_10k_all.png)
...
![Habit - 10k+ Steps now](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit_completion_10k_steps_now.png)
...
![Habits - done](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/habit_completions_done.png)
...
![Measurable Data Types - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/measurables_empty.png)

You can add new measurable data types with the **+** icon on the Measurables page, and existing ones
can be searched and edited:

![Measurable Data Type - Pull-ups](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/measurable_pull_ups.png)
...
![Measurable Data Types](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/measurables.png)


## Creating Dashboards
Dashboards are managed in `Settings > Dashboard Management`:

![Dashboards - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboards_empty.png)
...
![Dashboard - Exercises](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboard_exercise.png)

Next, select one or more `Measurable Data Chart` items, followed by tapping `OK`:

![Dashboard - Exercises](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboard_exercise2.png)

Finally, save the dashboard.

![Dashboard - Exercises](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboard_exercise3.png)

![Dashboards - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboards.png)
...
![Dashboards - empty](https://raw.githubusercontent.com/matthiasn/lotti-docs/main/images/0.9.376+2236/dashboards_tab.png)
