# ADR 0063: Agent-Worded Alerts Restate an Armed Episode
...
ADR 0061 and ADR 0062 kept model-authored copy off the OS channel: a
...
4. **After the transaction, best-effort, for this wake's banner only.** The
   ...
   never surfaced as a failed wake — the sink contract of ADR 0061.
...
- [ADR 0061: Notification Producers, One Episode Contract](./0061-notification-producers-one-episode-contract.md) — the sink this extends
- [ADR 0062: Goal Off-Track Alerts on the OS Channel](./0062-goal-off-track-alerts-on-the-os-channel.md) — the alert this re-words
