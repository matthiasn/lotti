...
* [Device location](device-location.md) - how a new entry gets its geolocation: platform routing, the open-source native sources, permission, timeouts and the IP fallback.
