...
The token-driven UI layer: a generated theme, a reusable component library, and a
Widgetbook review surface.
...
* [Icon tokens](icons.md) - the semantic icon vocabulary bound to Lucide, and the ratcheted guard that keeps call sites off raw Material glyphs.
* [Completion celebration](celebration.md) - one choreography with a swappable particle painter.

# Related

* [Architecture overview](../../architecture/overview.md) - where the design system sits in the tree.
