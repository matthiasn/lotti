...
sources:
  ...
  - id: adr-0062
    resource: ../../docs/adr/0062-goal-off-track-alerts-on-the-os-channel.md
    title: ADR 0062 — Goal off-track alerts on the OS channel
    last_modified: 2026-09-16
  - id: phase-a
...
the app open. ADR 0062 adds the case it cannot cover — the device the user is
...
- **Copy is deterministic and content-minimal by default**: the goal's title
  ...
  restate the armed row in the banner's own words afterwards (ADR 0063, the
