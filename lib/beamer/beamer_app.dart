  ...
  final routerDelegate = BeamerDelegate(
    ...
    locationBuilder: RoutesLocationBuilder(
      routes: {
        '*': (context, state, data) {
          debugPrint(
            'MyBeamerApp locationBuilder ${context.currentBeamLocation.state.routeInformation.location} ${state.uri}',
          );
            ...
            ThemeConfigWrapper(
              MaterialApp.router(
                ...
                routeInformationParser: BeamerParser(
                  onParse: (RouteInformation routeInformation) {
                    debugPrint('BeamerParser onParse: $routeInformation');
