...
mixin _$SyncProvisioningBundle {
  ...
  @override
  String toString() {
    return 'SyncProvisioningBundle(v: $v, homeServer: $homeServer, user: $user, password: $password, roomId: $roomId)';
  }
}
...
/// @nodoc
@JsonSerializable()
class _SyncProvisioningBundle implements SyncProvisioningBundle {
