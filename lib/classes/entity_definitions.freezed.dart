...
return categoryDefinition(_that.id,_that.createdAt,_that.updatedAt,_that.name,_that.vectorClock,_that.private,_that.active,_that.favorite,_that.color,_that.categoryId,_that.deletedAt,_that.defaultLanguageCode,_that.allowedPromptIds,_that.automaticPrompts,_that.icon,_that.speechDictionary,_that.correctionExamples);case LabelDefinition() when labelDefinition != null:
...
return categoryDefinition(_that.id,_that.createdAt,_that.updatedAt,_that.name,_that.vectorClock,_that.private,_that.active,_that.favorite,_that.color,_that.categoryId,_that.deletedAt,_that.defaultLanguageCode,_that.allowedPromptIds,_that.automaticPrompts,_that.icon,_that.speechDictionary,_that.correctionExamples);case LabelDefinition():
...
class CategoryDefinition implements EntityDefinition {
  const CategoryDefinition({required this.id, required this.createdAt, required this.updatedAt, required this.name, required this.vectorClock, required this.private, required this.active, this.favorite, this.color, this.categoryId, this.deletedAt, this.defaultLanguageCode, final  List<String>? allowedPromptIds, final  Map<AiResponseType, List<String>>? automaticPrompts, @CategoryIconConverter() this.icon, final  List<String>? speechDictionary, final  List<ChecklistCorrectionExample>? correctionExamples, final  String? $type}): _allowedPromptIds = allowedPromptIds,_automaticPrompts = automaticPrompts,_speechDictionary = speechDictionary,_correctionExamples = correctionExamples,$type = $type ?? 'categoryDefinition';
...
@override final  DateTime? deletedAt;
 ...
 List<String>? get allowedPromptIds {
  ...
  if (_allowedPromptIds is EqualUnmodifiableListView) return _allowedPromptIds;
  // ignore: implicit_dynamic_type
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryDefinition&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.name, name) || other.name == name)&&(identical(other.vectorClock, vectorClock) || other.vectorClock == vectorClock)&&(identical(other.private, private) || other.private == private)&&(identical(other.active, active) || other.active == active)&&(identical(other.favorite, favorite) || other.favorite == favorite)&&(identical(other.color, color) || other.color == color)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.defaultLanguageCode, defaultLanguageCode) || other.defaultLanguageCode == defaultLanguageCode)&&const DeepCollectionEquality().equals(other._allowedPromptIds, _allowedPromptIds)&&const DeepCollectionEquality().equals(other._automaticPrompts, _automaticPrompts)&&(identical(other.icon, icon) || other.icon == icon)&&const DeepCollectionEquality().equals(other._speechDictionary, _speechDictionary)&&const DeepCollectionEquality().equals(other._correctionExamples, _correctionExamples));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,name,vectorClock,private,active,favorite,color,categoryId,deletedAt,defaultLanguageCode,const DeepCollectionEquality().hash(_allowedPromptIds),const DeepCollectionEquality().hash(_automaticPrompts),icon,const DeepCollectionEquality().hash(_speechDictionary),const DeepCollectionEquality().hash(_correctionExamples));
...
@override @useResult
$Res call({
 String id, DateTime createdAt, DateTime updatedAt, String name, VectorClock? vectorClock, bool private, bool active, bool? favorite, String? color, String? categoryId, DateTime? deletedAt, String? defaultLanguageCode, List<String>? allowedPromptIds, Map<AiResponseType, List<String>>? automaticPrompts,@CategoryIconConverter() CategoryIcon? icon, List<String>? speechDictionary, List<ChecklistCorrectionExample>? correctionExamples
});
...
/// Create a copy of EntityDefinition
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? name = null,Object? vectorClock = freezed,Object? private = null,Object? active = null,Object? favorite = freezed,Object? color = freezed,Object? categoryId = freezed,Object? deletedAt = freezed,Object? defaultLanguageCode = freezed,Object? allowedPromptIds = freezed,Object? automaticPrompts = freezed,Object? icon = freezed,Object? speechDictionary = freezed,Object? correctionExamples = freezed,}) {
...
as String?,allowedPromptIds: freezed == allowedPromptIds ? _self._allowedPromptIds : allowedPromptIds // ignore: cast_nullable_to_non_nullable
as List<String>?,automaticPrompts: freezed == automaticPrompts ? _self._automaticPrompts : automaticPrompts // ignore: cast_nullable_to_non_nullable
as Map<AiResponseType, List<String>>?,icon: freezed == icon ? _self.icon : icon // ignore: cast_nullable_to_non_nullable
...
mixin _$AiResponseData {
 ...
 String get model; String get systemMessage; String get prompt; String get thoughts; String get response; String? get promptId; List<AiActionItem>? get suggestedActionItems; AiResponseType? get type; double? get temperature;// Usage statistics (nullable for backward compatibility)
...
@useResult
$Res call({
 String model, String systemMessage, String prompt, String thoughts, String response, String? promptId, List<AiActionItem>? suggestedActionItems, AiResponseType? type, double? temperature, int? inputTokens, int? outputTokens, int? thoughtsTokens, int? cachedInputTokens, int? durationMs
});
...
as AiResponseType?,temperature: freezed == temperature ? _self.temperature : temperature // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String model,  String systemMessage,  String prompt,  String thoughts,  String response,  String? promptId,  List<AiActionItem>? suggestedActionItems,  AiResponseType? type,  double? temperature,  int? inputTokens,  int? outputTokens,  int? thoughtsTokens,  int? cachedInputTokens,  int? durationMs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiResponseData() when $default != null:
return $default(_that.model,_that.systemMessage,_that.prompt,_that.thoughts,_that.response,_that.promptId,_that.suggestedActionItems,_that.type,_that.temperature,_that.inputTokens,_that.outputTokens,_that.thoughtsTokens,_that.cachedInputTokens,_that.durationMs);case _:
  return orElse();
...
class _AiResponseData implements AiResponseData {
  const _AiResponseData({required this.model, required this.systemMessage, required this.prompt, required this.thoughts, required this.response, this.promptId, final  List<AiActionItem>? suggestedActionItems, this.type, this.temperature, this.inputTokens, this.outputTokens, this.thoughtsTokens, this.cachedInputTokens, this.durationMs}): _suggestedActionItems = suggestedActionItems;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AiResponseData&&(identical(other.model, model) || other.model == model)&&(identical(other.systemMessage, systemMessage) || other.systemMessage == systemMessage)&&(identical(other.prompt, prompt) || other.prompt == prompt)&&(identical(other.thoughts, thoughts) || other.thoughts == thoughts)&&(identical(other.response, response) || other.response == response)&&(identical(other.promptId, promptId) || other.promptId == promptId)&&const DeepCollectionEquality().equals(other._suggestedActionItems, _suggestedActionItems)&&(identical(other.type, type) || other.type == type)&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.inputTokens, inputTokens) || other.inputTokens == inputTokens)&&(identical(other.outputTokens, outputTokens) || other.outputTokens == outputTokens)&&(identical(other.thoughtsTokens, thoughtsTokens) || other.thoughtsTokens == thoughtsTokens)&&(identical(other.cachedInputTokens, cachedInputTokens) || other.cachedInputTokens == cachedInputTokens)&&(identical(other.durationMs, durationMs) || other.durationMs == durationMs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,model,systemMessage,prompt,thoughts,response,promptId,const DeepCollectionEquality().hash(_suggestedActionItems),type,temperature,inputTokens,outputTokens,thoughtsTokens,cachedInputTokens,durationMs);
