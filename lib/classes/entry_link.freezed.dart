...
mixin _$EntryLink {
 ...
 String get id; String get fromId; String get toId; DateTime get createdAt; DateTime get updatedAt; VectorClock? get vectorClock; bool? get hidden; bool? get collapsed; DateTime? get deletedAt;
/// Create a copy of EntryLink
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EntryLinkCopyWith<EntryLink> get copyWith => _$EntryLinkCopyWithImpl<EntryLink>(this as EntryLink, _$identity);
...
@override
String toString() {
  return 'EntryLink(id: $id, fromId: $fromId, toId: $toId, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, hidden: $hidden, collapsed: $collapsed, deletedAt: $deletedAt)';
}
...
abstract mixin class $EntryLinkCopyWith<$Res>  {
  factory $EntryLinkCopyWith(EntryLink value, $Res Function(EntryLink) _then) = _$EntryLinkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$EntryLinkCopyWithImpl<$Res>
...
/// Create a copy of EntryLink
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fromId = null,Object? toId = null,Object? createdAt = null,Object? updatedAt = null,Object? vectorClock = freezed,Object? hidden = freezed,Object? collapsed = freezed,Object? deletedAt = freezed,}) {
...
class BasicLink implements EntryLink {
  const BasicLink({required this.id, required this.fromId, required this.toId, required this.createdAt, required this.updatedAt, required this.vectorClock, this.hidden, this.collapsed, this.deletedAt, final  String? $type}): $type = $type ?? 'basic';
  factory BasicLink.fromJson(Map<String, dynamic> json) => _$BasicLinkFromJson(json);
...
@pragma('vm:prefer-inline')
$BasicLinkCopyWith<BasicLink> get copyWith => _$BasicLinkCopyWithImpl<BasicLink>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BasicLinkToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BasicLink&&(identical(other.id, id) || other.id == id)&&(identical(other.fromId, fromId) || other.fromId == fromId)&&(identical(other.toId, toId) || other.toId == toId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.vectorClock, vectorClock) || other.vectorClock == vectorClock)&&(identical(other.hidden, hidden) || other.hidden == hidden)&&(identical(other.collapsed, collapsed) || other.collapsed == collapsed)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}
...
/// @nodoc
abstract mixin class $BasicLinkCopyWith<$Res> implements $EntryLinkCopyWith<$Res> {
  factory $BasicLinkCopyWith(BasicLink value, $Res Function(BasicLink) _then) = _$BasicLinkCopyWithImpl;
@override @useResult
$Res call({
 String id, String fromId, String toId, DateTime createdAt, DateTime updatedAt, VectorClock? vectorClock, bool? hidden, bool? collapsed, DateTime? deletedAt
});
...
/// @nodoc
class _$BasicLinkCopyWithImpl<$Res>
    implements $BasicLinkCopyWith<$Res> {
...
class RatingLink implements EntryLink {
  const RatingLink({required this.id, required this.fromId, required this.toId, required this.createdAt, required this.updatedAt, required this.vectorClock, this.hidden, this.collapsed, this.deletedAt, final  String? $type}): $type = $type ?? 'rating';
  factory RatingLink.fromJson(Map<String, dynamic> json) => _$RatingLinkFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RatingLinkCopyWith<RatingLink> get copyWith => _$RatingLinkCopyWithImpl<RatingLink>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingLink&&(identical(other.id, id) || other.id == id)&&(identical(other.fromId, fromId) || other.fromId == fromId)&&(identical(other.toId, toId) || other.toId == toId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.vectorClock, vectorClock) || other.vectorClock == vectorClock)&&(identical(other.hidden, hidden) || other.hidden == hidden)&&(identical(other.collapsed, collapsed) || other.collapsed == collapsed)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}
...
@override
String toString() {
  return 'EntryLink.rating(id: $id, fromId: $fromId, toId: $toId, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, hidden: $hidden, collapsed: $collapsed, deletedAt: $deletedAt)';
}
...
/// @nodoc
abstract mixin class $RatingLinkCopyWith<$Res> implements $EntryLinkCopyWith<$Res> {
