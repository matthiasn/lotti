...
mixin _$Geolocation {
 ...
 DateTime get createdAt; double get latitude; double get longitude; String get geohashString; int? get utcOffset; String? get timezone; double? get accuracy; double? get speed; double? get speedAccuracy; double? get heading; double? get headingAccuracy; double? get altitude;
...
@useResult
$Res call({
 DateTime createdAt, double latitude, double longitude, String geohashString, int? utcOffset, String? timezone, double? accuracy, double? speed, double? speedAccuracy, double? heading, double? headingAccuracy, double? altitude
});
...
/// Create a copy of Geolocation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = null,Object? latitude = null,Object? longitude = null,Object? geohashString = null,Object? utcOffset = freezed,Object? timezone = freezed,Object? accuracy = freezed,Object? speed = freezed,Object? speedAccuracy = freezed,Object? heading = freezed,Object? headingAccuracy = freezed,Object? altitude = freezed,}) {
...
as double,geohashString: null == geohashString ? _self.geohashString : geohashString // ignore: cast_nullable_to_non_nullable
...
as double?,speedAccuracy: freezed == speedAccuracy ? _self.speedAccuracy : speedAccuracy // ignore: cast_nullable_to_non_nullable
as double?,heading: freezed == heading ? _self.heading : heading // ignore: cast_nullable_to_non_nullable
as double?,headingAccuracy: freezed == headingAccuracy ? _self.headingAccuracy : headingAccuracy // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime createdAt,  double latitude,  double longitude,  String geohashString,  int? utcOffset,  String? timezone,  double? accuracy,  double? speed,  double? speedAccuracy,  double? heading,  double? headingAccuracy,  double? altitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Geolocation() when $default != null:
return $default(_that.createdAt,_that.latitude,_that.longitude,_that.geohashString,_that.utcOffset,_that.timezone,_that.accuracy,_that.speed,_that.speedAccuracy,_that.heading,_that.headingAccuracy,_that.altitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime createdAt,  double latitude,  double longitude,  String geohashString,  int? utcOffset,  String? timezone,  double? accuracy,  double? speed,  double? speedAccuracy,  double? heading,  double? headingAccuracy,  double? altitude)  $default,) {final _that = this;
switch (_that) {
case _Geolocation():
return $default(_that.createdAt,_that.latitude,_that.longitude,_that.geohashString,_that.utcOffset,_that.timezone,_that.accuracy,_that.speed,_that.speedAccuracy,_that.heading,_that.headingAccuracy,_that.altitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime createdAt,  double latitude,  double longitude,  String geohashString,  int? utcOffset,  String? timezone,  double? accuracy,  double? speed,  double? speedAccuracy,  double? heading,  double? headingAccuracy,  double? altitude)?  $default,) {final _that = this;
switch (_that) {
case _Geolocation() when $default != null:
return $default(_that.createdAt,_that.latitude,_that.longitude,_that.geohashString,_that.utcOffset,_that.timezone,_that.accuracy,_that.speed,_that.speedAccuracy,_that.heading,_that.headingAccuracy,_that.altitude);case _:
  return null;
...
class _Geolocation implements Geolocation {
  const _Geolocation({required this.createdAt, required this.latitude, required this.longitude, required this.geohashString, this.utcOffset, this.timezone, this.accuracy, this.speed, this.speedAccuracy, this.heading, this.headingAccuracy, this.altitude});
  factory _Geolocation.fromJson(Map<String, dynamic> json) => _$GeolocationFromJson(json);

@override final  DateTime createdAt;
@override final  double latitude;
@override final  double longitude;
@override final  String geohashString;
@override final  int? utcOffset;
@override final  String? timezone;
@override final  double? accuracy;
@override final  double? speed;
@override final  double? speedAccuracy;
@override final  double? heading;
@override final  double? headingAccuracy;
