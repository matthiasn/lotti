...
mixin _$AudioData {
 ...
 DateTime get dateFrom; DateTime get dateTo; String get audioFile; String get audioDirectory; Duration get duration; bool get autoTranscribeWasActive; String? get language; List<AudioTranscript>? get transcripts; Map<String, AudioTranscriptTiming> get transcriptTimings; DayAudioContext? get dayContext;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AudioData&&(identical(other.dateFrom, dateFrom) || other.dateFrom == dateFrom)&&(identical(other.dateTo, dateTo) || other.dateTo == dateTo)&&(identical(other.audioFile, audioFile) || other.audioFile == audioFile)&&(identical(other.audioDirectory, audioDirectory) || other.audioDirectory == audioDirectory)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.autoTranscribeWasActive, autoTranscribeWasActive) || other.autoTranscribeWasActive == autoTranscribeWasActive)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other.transcripts, transcripts)&&const DeepCollectionEquality().equals(other.transcriptTimings, transcriptTimings)&&(identical(other.dayContext, dayContext) || other.dayContext == dayContext));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dateFrom,dateTo,audioFile,audioDirectory,duration,autoTranscribeWasActive,language,const DeepCollectionEquality().hash(transcripts),const DeepCollectionEquality().hash(transcriptTimings),dayContext);

@override
String toString() {
  return 'AudioData(dateFrom: $dateFrom, dateTo: $dateTo, audioFile: $audioFile, audioDirectory: $audioDirectory, duration: $duration, autoTranscribeWasActive: $autoTranscribeWasActive, language: $language, transcripts: $transcripts, transcriptTimings: $transcriptTimings, dayContext: $dayContext)';
}
...
@useResult
$Res call({
 DateTime dateFrom, DateTime dateTo, String audioFile, String audioDirectory, Duration duration, bool autoTranscribeWasActive, String? language, List<AudioTranscript>? transcripts, Map<String, AudioTranscriptTiming> transcriptTimings, DayAudioContext? dayContext
});
...
/// Create a copy of AudioData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dateFrom = null,Object? dateTo = null,Object? audioFile = null,Object? audioDirectory = null,Object? duration = null,Object? autoTranscribeWasActive = null,Object? language = freezed,Object? transcripts = freezed,Object? transcriptTimings = null,Object? dayContext = freezed,}) {
  return _then(_self.copyWith(
...
as List<AudioTranscript>?,transcriptTimings: null == transcriptTimings ? _self.transcriptTimings : transcriptTimings // ignore: cast_nullable_to_non_nullable
as Map<String, AudioTranscriptTiming>,dayContext: freezed == dayContext ? _self.dayContext : dayContext // ignore: cast_nullable_to_non_nullable
as DayAudioContext?,
  ));
}
/// Create a copy of AudioData
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime dateFrom,  DateTime dateTo,  String audioFile,  String audioDirectory,  Duration duration,  bool autoTranscribeWasActive,  String? language,  List<AudioTranscript>? transcripts,  Map<String, AudioTranscriptTiming> transcriptTimings,  DayAudioContext? dayContext)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioData() when $default != null:
return $default(_that.dateFrom,_that.dateTo,_that.audioFile,_that.audioDirectory,_that.duration,_that.autoTranscribeWasActive,_that.language,_that.transcripts,_that.transcriptTimings,_that.dayContext);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime dateFrom,  DateTime dateTo,  String audioFile,  String audioDirectory,  Duration duration,  bool autoTranscribeWasActive,  String? language,  List<AudioTranscript>? transcripts,  Map<String, AudioTranscriptTiming> transcriptTimings,  DayAudioContext? dayContext)  $default,) {final _that = this;
switch (_that) {
case _AudioData():
return $default(_that.dateFrom,_that.dateTo,_that.audioFile,_that.audioDirectory,_that.duration,_that.autoTranscribeWasActive,_that.language,_that.transcripts,_that.transcriptTimings,_that.dayContext);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime dateFrom,  DateTime dateTo,  String audioFile,  String audioDirectory,  Duration duration,  bool autoTranscribeWasActive,  String? language,  List<AudioTranscript>? transcripts,  Map<String, AudioTranscriptTiming> transcriptTimings,  DayAudioContext? dayContext)?  $default,) {final _that = this;
switch (_that) {
case _AudioData() when $default != null:
return $default(_that.dateFrom,_that.dateTo,_that.audioFile,_that.audioDirectory,_that.duration,_that.autoTranscribeWasActive,_that.language,_that.transcripts,_that.transcriptTimings,_that.dayContext);case _:
  return null;
...
class _AudioData implements AudioData {
  const _AudioData({required this.dateFrom, required this.dateTo, required this.audioFile, required this.audioDirectory, required this.duration, this.autoTranscribeWasActive = false, this.language, final  List<AudioTranscript>? transcripts, final  Map<String, AudioTranscriptTiming> transcriptTimings = const <String, AudioTranscriptTiming>{}, this.dayContext}): _transcripts = transcripts,_transcriptTimings = transcriptTimings;
...
@override@JsonKey() final  bool autoTranscribeWasActive;
@override final  String? language;
 final  List<AudioTranscript>? _transcripts;
@override List<AudioTranscript>? get transcripts {
 ...
 final  Map<String, AudioTranscriptTiming> _transcriptTimings;
@override@JsonKey() Map<String, AudioTranscriptTiming> get transcriptTimings {
  if (_transcriptTimings is EqualUnmodifiableMapView) return _transcriptTimings;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_transcriptTimings);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AudioData&&(identical(other.dateFrom, dateFrom) || other.dateFrom == dateFrom)&&(identical(other.dateTo, dateTo) || other.dateTo == dateTo)&&(identical(other.audioFile, audioFile) || other.audioFile == audioFile)&&(identical(other.audioDirectory, audioDirectory) || other.audioDirectory == audioDirectory)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.autoTranscribeWasActive, autoTranscribeWasActive) || other.autoTranscribeWasActive == autoTranscribeWasActive)&&(identical(other.language, language) || other.language == language)&&const DeepCollectionEquality().equals(other._transcripts, _transcripts)&&const DeepCollectionEquality().equals(other._transcriptTimings, _transcriptTimings)&&(identical(other.dayContext, dayContext) || other.dayContext == dayContext));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dateFrom,dateTo,audioFile,audioDirectory,duration,autoTranscribeWasActive,language,const DeepCollectionEquality().hash(_transcripts),const DeepCollectionEquality().hash(_transcriptTimings),dayContext);
...
/// Create a copy of AudioData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dateFrom = null,Object? dateTo = null,Object? audioFile = null,Object? audioDirectory = null,Object? duration = null,Object? autoTranscribeWasActive = null,Object? language = freezed,Object? transcripts = freezed,Object? transcriptTimings = null,Object? dayContext = freezed,}) {
...
as List<AudioTranscript>?,transcriptTimings: null == transcriptTimings ? _self._transcriptTimings : transcriptTimings // ignore: cast_nullable_to_non_nullable
as Map<String, AudioTranscriptTiming>,dayContext: freezed == dayContext ? _self.dayContext : dayContext // ignore: cast_nullable_to_non_nullable
as DayAudioContext?,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AudioTranscriptCopyWith<AudioTranscript> get copyWith => _$AudioTranscriptCopyWithImpl<AudioTranscript>(this as AudioTranscript, _$identity);
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AudioTranscript value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AudioTranscript value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AudioTranscript value)?  $default,){
final _that = this;
switch (_that) {
case _AudioTranscript() when $default != null:
return $default(_that);case _:
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$AudioTranscriptCopyWith<_AudioTranscript> get copyWith => __$AudioTranscriptCopyWithImpl<_AudioTranscript>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AudioTranscriptToJson(this, );
}
...
/// @nodoc
abstract mixin class _$AudioTranscriptCopyWith<$Res> implements $AudioTranscriptCopyWith<$Res> {
...
mixin _$SurveyData {
 ...
 RPTaskResult get taskResult; Map<String, Set<String>> get scoreDefinitions; Map<String, int> get calculatedScores;
/// Create a copy of SurveyData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SurveyDataCopyWith<SurveyData> get copyWith => _$SurveyDataCopyWithImpl<SurveyData>(this as SurveyData, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SurveyData&&(identical(other.taskResult, taskResult) || other.taskResult == taskResult)&&const DeepCollectionEquality().equals(other.scoreDefinitions, scoreDefinitions)&&const DeepCollectionEquality().equals(other.calculatedScores, calculatedScores));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,taskResult,const DeepCollectionEquality().hash(scoreDefinitions),const DeepCollectionEquality().hash(calculatedScores));
...
abstract mixin class $SurveyDataCopyWith<$Res>  {
  factory $SurveyDataCopyWith(SurveyData value, $Res Function(SurveyData) _then) = _$SurveyDataCopyWithImpl;
@useResult
$Res call({
 RPTaskResult taskResult, Map<String, Set<String>> scoreDefinitions, Map<String, int> calculatedScores
});
...
/// @nodoc
class _$SurveyDataCopyWithImpl<$Res>
...
/// Create a copy of SurveyData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? taskResult = null,Object? scoreDefinitions = null,Object? calculatedScores = null,}) {
  return _then(_self.copyWith(
taskResult: null == taskResult ? _self.taskResult : taskResult // ignore: cast_nullable_to_non_nullable
as RPTaskResult,scoreDefinitions: null == scoreDefinitions ? _self.scoreDefinitions : scoreDefinitions // ignore: cast_nullable_to_non_nullable
as Map<String, Set<String>>,calculatedScores: null == calculatedScores ? _self.calculatedScores : calculatedScores // ignore: cast_nullable_to_non_nullable
as Map<String, int>,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SurveyData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SurveyData value)  $default,){
final _that = this;
switch (_that) {
case _SurveyData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SurveyData value)?  $default,){
final _that = this;
switch (_that) {
case _SurveyData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RPTaskResult taskResult,  Map<String, Set<String>> scoreDefinitions,  Map<String, int> calculatedScores)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SurveyData() when $default != null:
return $default(_that.taskResult,_that.scoreDefinitions,_that.calculatedScores);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RPTaskResult taskResult,  Map<String, Set<String>> scoreDefinitions,  Map<String, int> calculatedScores)  $default,) {final _that = this;
switch (_that) {
case _SurveyData():
return $default(_that.taskResult,_that.scoreDefinitions,_that.calculatedScores);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RPTaskResult taskResult,  Map<String, Set<String>> scoreDefinitions,  Map<String, int> calculatedScores)?  $default,) {final _that = this;
switch (_that) {
case _SurveyData() when $default != null:
return $default(_that.taskResult,_that.scoreDefinitions,_that.calculatedScores);case _:
  return null;
...
class _SurveyData implements SurveyData {
  const _SurveyData({required this.taskResult, required final  Map<String, Set<String>> scoreDefinitions, required final  Map<String, int> calculatedScores}): _scoreDefinitions = scoreDefinitions,_calculatedScores = calculatedScores;
  factory _SurveyData.fromJson(Map<String, dynamic> json) => _$SurveyDataFromJson(json);

@override final  RPTaskResult taskResult;
 final  Map<String, Set<String>> _scoreDefinitions;
@override Map<String, Set<String>> get scoreDefinitions {
...
@override Map<String, int> get calculatedScores {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SurveyDataCopyWith<_SurveyData> get copyWith => __$SurveyDataCopyWithImpl<_SurveyData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SurveyDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SurveyData&&(identical(other.taskResult, taskResult) || other.taskResult == taskResult)&&const DeepCollectionEquality().equals(other._scoreDefinitions, _scoreDefinitions)&&const DeepCollectionEquality().equals(other._calculatedScores, _calculatedScores));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,taskResult,const DeepCollectionEquality().hash(_scoreDefinitions),const DeepCollectionEquality().hash(_calculatedScores));
...
/// @nodoc
abstract mixin class _$SurveyDataCopyWith<$Res> implements $SurveyDataCopyWith<$Res> {
  factory _$SurveyDataCopyWith(_SurveyData value, $Res Function(_SurveyData) _then) = __$SurveyDataCopyWithImpl;
@override @useResult
$Res call({
 RPTaskResult taskResult, Map<String, Set<String>> scoreDefinitions, Map<String, int> calculatedScores
});
...
/// @nodoc
class __$SurveyDataCopyWithImpl<$Res>
    implements _$SurveyDataCopyWith<$Res> {
...
/// Create a copy of SurveyData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? taskResult = null,Object? scoreDefinitions = null,Object? calculatedScores = null,}) {
  return _then(_SurveyData(
taskResult: null == taskResult ? _self.taskResult : taskResult // ignore: cast_nullable_to_non_nullable
as RPTaskResult,scoreDefinitions: null == scoreDefinitions ? _self._scoreDefinitions : scoreDefinitions // ignore: cast_nullable_to_non_nullable
as Map<String, Set<String>>,calculatedScores: null == calculatedScores ? _self._calculatedScores : calculatedScores // ignore: cast_nullable_to_non_nullable
as Map<String, int>,
  ));
}
...
JournalEntity _$JournalEntityFromJson(
        ...
        switch (json['runtimeType']) {
          ...
          return JournalEntry.fromJson(
            json
                ...
                case 'journalImage':
          return JournalImage.fromJson(
            json
          );
                case 'journalAudio':
          return JournalAudio.fromJson(
            json
          );
                case 'task':
          ...
          return Checklist.fromJson(
            json
                ...
                case 'quantitative':
          return QuantitativeEntry.fromJson(
            json
          );
                case 'measurement':
          return MeasurementEntry.fromJson(
            json
                ...
                case 'aiResponse':
          return AiResponseEntry.fromJson(
            json
          );
                case 'workout':
          return WorkoutEntry.fromJson(
            json
          );
                case 'habitCompletion':
          return HabitCompletionEntry.fromJson(
            json
          );
                case 'survey':
          return SurveyEntry.fromJson(
            json
          );
                case 'dayPlan':
          return DayPlanEntry.fromJson(
            json
          );
                case 'rating':
          return RatingEntry.fromJson(
            json
          );
                case 'project':
          return ProjectEntry.fromJson(
            json
          );
                case 'relationship':
...
mixin _$JournalEntity {
 ...
 Metadata get meta; EntryText? get entryText; Geolocation? get geolocation;
/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JournalEntityCopyWith<JournalEntity> get copyWith => _$JournalEntityCopyWithImpl<JournalEntity>(this as JournalEntity, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JournalEntity&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
abstract mixin class $JournalEntityCopyWith<$Res>  {
  factory $JournalEntityCopyWith(JournalEntity value, $Res Function(JournalEntity) _then) = _$JournalEntityCopyWithImpl;
@useResult
$Res call({
...
$MetadataCopyWith<$Res> get meta;$EntryTextCopyWith<$Res>? get entryText;$GeolocationCopyWith<$Res>? get geolocation;
...
/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? meta = null,Object? entryText = freezed,Object? geolocation = freezed,}) {
  return _then(_self.copyWith(
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
...
return journalEntry(_that);case JournalImage() when journalImage != null:
return journalImage(_that);case JournalAudio() when journalAudio != null:
return journalAudio(_that);case Task() when task != null:
return task(_that);case JournalEvent() when event != null:
return event(_that);case ChecklistItem() when checklistItem != null:
return checklistItem(_that);case Checklist() when checklist != null:
return checklist(_that);case QuantitativeEntry() when quantitative != null:
return quantitative(_that);case MeasurementEntry() when measurement != null:
return measurement(_that);case AiResponseEntry() when aiResponse != null:
return aiResponse(_that);case WorkoutEntry() when workout != null:
return workout(_that);case HabitCompletionEntry() when habitCompletion != null:
return habitCompletion(_that);case SurveyEntry() when survey != null:
return survey(_that);case DayPlanEntry() when dayPlan != null:
return dayPlan(_that);case RatingEntry() when rating != null:
...
switch (_that) {
case JournalEntry():
return journalEntry(_that);case JournalImage():
return journalImage(_that);case JournalAudio():
return journalAudio(_that);case Task():
return task(_that);case JournalEvent():
return event(_that);case ChecklistItem():
return checklistItem(_that);case Checklist():
return checklist(_that);case QuantitativeEntry():
return quantitative(_that);case MeasurementEntry():
return measurement(_that);case AiResponseEntry():
return aiResponse(_that);case WorkoutEntry():
return workout(_that);case HabitCompletionEntry():
return habitCompletion(_that);case SurveyEntry():
return survey(_that);case DayPlanEntry():
return dayPlan(_that);case RatingEntry():
...
return journalImage(_that.meta,_that.data,_that.entryText,_that.geolocation);case JournalAudio() when journalAudio != null:
return journalAudio(_that.meta,_that.data,_that.entryText,_that.geolocation);case Task() when task != null:
return task(_that.meta,_that.data,_that.entryText,_that.geolocation);case JournalEvent() when event != null:
return event(_that.meta,_that.data,_that.entryText,_that.geolocation);case ChecklistItem() when checklistItem != null:
return checklistItem(_that.meta,_that.data,_that.entryText,_that.geolocation);case Checklist() when checklist != null:
return checklist(_that.meta,_that.data,_that.entryText,_that.geolocation);case QuantitativeEntry() when quantitative != null:
return quantitative(_that.meta,_that.data,_that.entryText,_that.geolocation);case MeasurementEntry() when measurement != null:
return measurement(_that.meta,_that.data,_that.entryText,_that.geolocation);case AiResponseEntry() when aiResponse != null:
return aiResponse(_that.meta,_that.data,_that.entryText,_that.geolocation);case WorkoutEntry() when workout != null:
return workout(_that.meta,_that.data,_that.entryText,_that.geolocation);case HabitCompletionEntry() when habitCompletion != null:
return habitCompletion(_that.meta,_that.data,_that.entryText,_that.geolocation);case SurveyEntry() when survey != null:
return survey(_that.meta,_that.data,_that.entryText,_that.geolocation);case DayPlanEntry() when dayPlan != null:
return dayPlan(_that.meta,_that.data,_that.entryText,_that.geolocation);case RatingEntry() when rating != null:
...
return journalImage(_that.meta,_that.data,_that.entryText,_that.geolocation);case JournalAudio():
return journalAudio(_that.meta,_that.data,_that.entryText,_that.geolocation);case Task():
return task(_that.meta,_that.data,_that.entryText,_that.geolocation);case JournalEvent():
return event(_that.meta,_that.data,_that.entryText,_that.geolocation);case ChecklistItem():
return checklistItem(_that.meta,_that.data,_that.entryText,_that.geolocation);case Checklist():
return checklist(_that.meta,_that.data,_that.entryText,_that.geolocation);case QuantitativeEntry():
return quantitative(_that.meta,_that.data,_that.entryText,_that.geolocation);case MeasurementEntry():
return measurement(_that.meta,_that.data,_that.entryText,_that.geolocation);case AiResponseEntry():
return aiResponse(_that.meta,_that.data,_that.entryText,_that.geolocation);case WorkoutEntry():
return workout(_that.meta,_that.data,_that.entryText,_that.geolocation);case HabitCompletionEntry():
return habitCompletion(_that.meta,_that.data,_that.entryText,_that.geolocation);case SurveyEntry():
return survey(_that.meta,_that.data,_that.entryText,_that.geolocation);case DayPlanEntry():
return dayPlan(_that.meta,_that.data,_that.entryText,_that.geolocation);case RatingEntry():
...
class JournalEntry implements JournalEntity {
  const JournalEntry({required this.meta, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'journalEntry';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JournalEntryCopyWith<JournalEntry> get copyWith => _$JournalEntryCopyWithImpl<JournalEntry>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JournalEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $JournalEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
...
@override $MetadataCopyWith<$Res> get meta;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? meta = null,Object? entryText = freezed,Object? geolocation = freezed,}) {
...
class JournalImage implements JournalEntity {
  const JournalImage({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'journalImage';
  factory JournalImage.fromJson(Map<String, dynamic> json) => _$JournalImageFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JournalImageCopyWith<JournalImage> get copyWith => _$JournalImageCopyWithImpl<JournalImage>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JournalImageToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JournalImage&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $JournalImageCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $JournalImageCopyWith(JournalImage value, $Res Function(JournalImage) _then) = _$JournalImageCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, ImageData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$ImageDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$JournalImageCopyWithImpl<$Res>
    implements $JournalImageCopyWith<$Res> {
...
as ImageData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class JournalAudio implements JournalEntity {
  const JournalAudio({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'journalAudio';
  factory JournalAudio.fromJson(Map<String, dynamic> json) => _$JournalAudioFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JournalAudioCopyWith<JournalAudio> get copyWith => _$JournalAudioCopyWithImpl<JournalAudio>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JournalAudioToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JournalAudio&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $JournalAudioCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $JournalAudioCopyWith(JournalAudio value, $Res Function(JournalAudio) _then) = _$JournalAudioCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, AudioData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$AudioDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$JournalAudioCopyWithImpl<$Res>
    implements $JournalAudioCopyWith<$Res> {
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as AudioData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class Task implements JournalEntity {
  const Task({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'task';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Task&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $TaskCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $TaskCopyWith(Task value, $Res Function(Task) _then) = _$TaskCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, TaskData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$TaskDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as TaskData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class JournalEvent implements JournalEntity {
  const JournalEvent({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'event';
  factory JournalEvent.fromJson(Map<String, dynamic> json) => _$JournalEventFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JournalEventCopyWith<JournalEvent> get copyWith => _$JournalEventCopyWithImpl<JournalEvent>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JournalEventToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JournalEvent&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $JournalEventCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $JournalEventCopyWith(JournalEvent value, $Res Function(JournalEvent) _then) = _$JournalEventCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, EventData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$EventDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$JournalEventCopyWithImpl<$Res>
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as EventData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class ChecklistItem implements JournalEntity {
  const ChecklistItem({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'checklistItem';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ChecklistItemCopyWith<ChecklistItem> get copyWith => _$ChecklistItemCopyWithImpl<ChecklistItem>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChecklistItem&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $ChecklistItemCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $ChecklistItemCopyWith(ChecklistItem value, $Res Function(ChecklistItem) _then) = _$ChecklistItemCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, ChecklistItemData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$ChecklistItemDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as ChecklistItemData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class Checklist implements JournalEntity {
  const Checklist({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'checklist';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ChecklistCopyWith<Checklist> get copyWith => _$ChecklistCopyWithImpl<Checklist>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Checklist&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $ChecklistCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $ChecklistCopyWith(Checklist value, $Res Function(Checklist) _then) = _$ChecklistCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, ChecklistData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$ChecklistDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as ChecklistData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class QuantitativeEntry implements JournalEntity {
  const QuantitativeEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'quantitative';
  factory QuantitativeEntry.fromJson(Map<String, dynamic> json) => _$QuantitativeEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$QuantitativeEntryCopyWith<QuantitativeEntry> get copyWith => _$QuantitativeEntryCopyWithImpl<QuantitativeEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$QuantitativeEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QuantitativeEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $QuantitativeEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $QuantitativeEntryCopyWith(QuantitativeEntry value, $Res Function(QuantitativeEntry) _then) = _$QuantitativeEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, QuantitativeData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$QuantitativeDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as QuantitativeData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class MeasurementEntry implements JournalEntity {
  const MeasurementEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'measurement';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MeasurementEntryCopyWith<MeasurementEntry> get copyWith => _$MeasurementEntryCopyWithImpl<MeasurementEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MeasurementEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MeasurementEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $MeasurementEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
...
@override @useResult
$Res call({
 Metadata meta, MeasurementData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$MeasurementDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as MeasurementData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class AiResponseEntry implements JournalEntity {
  const AiResponseEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'aiResponse';
  factory AiResponseEntry.fromJson(Map<String, dynamic> json) => _$AiResponseEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AiResponseEntryCopyWith<AiResponseEntry> get copyWith => _$AiResponseEntryCopyWithImpl<AiResponseEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AiResponseEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AiResponseEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $AiResponseEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $AiResponseEntryCopyWith(AiResponseEntry value, $Res Function(AiResponseEntry) _then) = _$AiResponseEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, AiResponseData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$AiResponseDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as AiResponseData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class WorkoutEntry implements JournalEntity {
  const WorkoutEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'workout';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WorkoutEntryCopyWith<WorkoutEntry> get copyWith => _$WorkoutEntryCopyWithImpl<WorkoutEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WorkoutEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WorkoutEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $WorkoutEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
...
@override $MetadataCopyWith<$Res> get meta;$WorkoutDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as WorkoutData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class HabitCompletionEntry implements JournalEntity {
  const HabitCompletionEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'habitCompletion';
  factory HabitCompletionEntry.fromJson(Map<String, dynamic> json) => _$HabitCompletionEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$HabitCompletionEntryCopyWith<HabitCompletionEntry> get copyWith => _$HabitCompletionEntryCopyWithImpl<HabitCompletionEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$HabitCompletionEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HabitCompletionEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $HabitCompletionEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $HabitCompletionEntryCopyWith(HabitCompletionEntry value, $Res Function(HabitCompletionEntry) _then) = _$HabitCompletionEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, HabitCompletionData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$HabitCompletionDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as HabitCompletionData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class SurveyEntry implements JournalEntity {
  const SurveyEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'survey';
  factory SurveyEntry.fromJson(Map<String, dynamic> json) => _$SurveyEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SurveyEntryCopyWith<SurveyEntry> get copyWith => _$SurveyEntryCopyWithImpl<SurveyEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SurveyEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SurveyEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $SurveyEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $SurveyEntryCopyWith(SurveyEntry value, $Res Function(SurveyEntry) _then) = _$SurveyEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, SurveyData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$SurveyDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$SurveyEntryCopyWithImpl<$Res>
    implements $SurveyEntryCopyWith<$Res> {
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as SurveyData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class DayPlanEntry implements JournalEntity {
  const DayPlanEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'dayPlan';
  factory DayPlanEntry.fromJson(Map<String, dynamic> json) => _$DayPlanEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DayPlanEntryCopyWith<DayPlanEntry> get copyWith => _$DayPlanEntryCopyWithImpl<DayPlanEntry>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DayPlanEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
/// @nodoc
abstract mixin class $DayPlanEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $DayPlanEntryCopyWith(DayPlanEntry value, $Res Function(DayPlanEntry) _then) = _$DayPlanEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, DayPlanData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$DayPlanDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as DayPlanData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
class RatingEntry implements JournalEntity {
  const RatingEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'rating';
  factory RatingEntry.fromJson(Map<String, dynamic> json) => _$RatingEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RatingEntryCopyWith<RatingEntry> get copyWith => _$RatingEntryCopyWithImpl<RatingEntry>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
@override
String toString() {
  return 'JournalEntity.rating(meta: $meta, data: $data, entryText: $entryText, geolocation: $geolocation)';
}
...
/// @nodoc
abstract mixin class $RatingEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $RatingEntryCopyWith(RatingEntry value, $Res Function(RatingEntry) _then) = _$RatingEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, RatingData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$RatingDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$RatingEntryCopyWithImpl<$Res>
    implements $RatingEntryCopyWith<$Res> {
  _$RatingEntryCopyWithImpl(this._self, this._then);

  final RatingEntry _self;
  final $Res Function(RatingEntry) _then;
...
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as RatingData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$RatingDataCopyWith<$Res> get data {
  
  return $RatingDataCopyWith<$Res>(_self.data, (value) {
    return _then(_self.copyWith(data: value));
  });
}/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
...
class ProjectEntry implements JournalEntity {
  const ProjectEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'project';
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ProjectEntryCopyWith<ProjectEntry> get copyWith => _$ProjectEntryCopyWithImpl<ProjectEntry>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
@override
String toString() {
  return 'JournalEntity.project(meta: $meta, data: $data, entryText: $entryText, geolocation: $geolocation)';
}
...
/// @nodoc
abstract mixin class $ProjectEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $ProjectEntryCopyWith(ProjectEntry value, $Res Function(ProjectEntry) _then) = _$ProjectEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, ProjectData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$ProjectDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;
...
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? meta = null,Object? data = null,Object? entryText = freezed,Object? geolocation = freezed,}) {
  return _then(ProjectEntry(
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as ProjectData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$ProjectDataCopyWith<$Res> get data {
  
  return $ProjectDataCopyWith<$Res>(_self.data, (value) {
    return _then(_self.copyWith(data: value));
  });
}/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
...
class RelationshipEntry implements JournalEntity {
  const RelationshipEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'relationship';
  factory RelationshipEntry.fromJson(Map<String, dynamic> json) => _$RelationshipEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RelationshipEntryCopyWith<RelationshipEntry> get copyWith => _$RelationshipEntryCopyWithImpl<RelationshipEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RelationshipEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RelationshipEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
@override
String toString() {
  return 'JournalEntity.relationship(meta: $meta, data: $data, entryText: $entryText, geolocation: $geolocation)';
}
...
/// @nodoc
abstract mixin class $RelationshipEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $RelationshipEntryCopyWith(RelationshipEntry value, $Res Function(RelationshipEntry) _then) = _$RelationshipEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, RelationshipData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$RelationshipDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$RelationshipEntryCopyWithImpl<$Res>
    implements $RelationshipEntryCopyWith<$Res> {
  _$RelationshipEntryCopyWithImpl(this._self, this._then);

  final RelationshipEntry _self;
  final $Res Function(RelationshipEntry) _then;

/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? meta = null,Object? data = null,Object? entryText = freezed,Object? geolocation = freezed,}) {
  return _then(RelationshipEntry(
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as RelationshipData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$RelationshipDataCopyWith<$Res> get data {
  
  return $RelationshipDataCopyWith<$Res>(_self.data, (value) {
    return _then(_self.copyWith(data: value));
  });
}/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
...
class CheckInEntry implements JournalEntity {
  const CheckInEntry({required this.meta, required this.data, this.entryText, this.geolocation, final  String? $type}): $type = $type ?? 'checkIn';
  factory CheckInEntry.fromJson(Map<String, dynamic> json) => _$CheckInEntryFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CheckInEntryCopyWith<CheckInEntry> get copyWith => _$CheckInEntryCopyWithImpl<CheckInEntry>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CheckInEntryToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CheckInEntry&&(identical(other.meta, meta) || other.meta == meta)&&(identical(other.data, data) || other.data == data)&&(identical(other.entryText, entryText) || other.entryText == entryText)&&(identical(other.geolocation, geolocation) || other.geolocation == geolocation));
}
...
@override
String toString() {
  return 'JournalEntity.checkIn(meta: $meta, data: $data, entryText: $entryText, geolocation: $geolocation)';
}
...
/// @nodoc
abstract mixin class $CheckInEntryCopyWith<$Res> implements $JournalEntityCopyWith<$Res> {
  factory $CheckInEntryCopyWith(CheckInEntry value, $Res Function(CheckInEntry) _then) = _$CheckInEntryCopyWithImpl;
@override @useResult
$Res call({
 Metadata meta, CheckInData data, EntryText? entryText, Geolocation? geolocation
});


@override $MetadataCopyWith<$Res> get meta;$CheckInDataCopyWith<$Res> get data;@override $EntryTextCopyWith<$Res>? get entryText;@override $GeolocationCopyWith<$Res>? get geolocation;

}
/// @nodoc
class _$CheckInEntryCopyWithImpl<$Res>
    implements $CheckInEntryCopyWith<$Res> {
  _$CheckInEntryCopyWithImpl(this._self, this._then);

  final CheckInEntry _self;
  final $Res Function(CheckInEntry) _then;

/// Create a copy of JournalEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? meta = null,Object? data = null,Object? entryText = freezed,Object? geolocation = freezed,}) {
  return _then(CheckInEntry(
meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
as Metadata,data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as CheckInData,entryText: freezed == entryText ? _self.entryText : entryText // ignore: cast_nullable_to_non_nullable
as EntryText?,geolocation: freezed == geolocation ? _self.geolocation : geolocation // ignore: cast_nullable_to_non_nullable
as Geolocation?,
  ));
}
