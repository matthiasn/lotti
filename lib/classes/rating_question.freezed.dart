...
/// Stable identifier for this question (e.g., "productivity").
 String get key;/// Localized question text shown to the user.
...
/// "good" vs "bad" outcomes without external schema knowledge.
 String get description;/// Input type for the UI and value interpretation.
...
/// - 'boolean': yes/no (0.0 or 1.0)
 String get inputType;/// Available options for 'segmented' input type.
...
abstract mixin class $RatingQuestionCopyWith<$Res>  {
  factory $RatingQuestionCopyWith(RatingQuestion value, $Res Function(RatingQuestion) _then) = _$RatingQuestionCopyWithImpl;
@useResult
$Res call({
 String key, String question, String description, String inputType, List<RatingQuestionOption>? options
});
...
/// Create a copy of RatingQuestion
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = null,Object? question = null,Object? description = null,Object? inputType = null,Object? options = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RatingQuestion value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RatingQuestion value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RatingQuestion value)?  $default,){
final _that = this;
switch (_that) {
case _RatingQuestion() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String key,  String question,  String description,  String inputType,  List<RatingQuestionOption>? options)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RatingQuestion() when $default != null:
return $default(_that.key,_that.question,_that.description,_that.inputType,_that.options);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String key,  String question,  String description,  String inputType,  List<RatingQuestionOption>? options)  $default,) {final _that = this;
switch (_that) {
case _RatingQuestion():
return $default(_that.key,_that.question,_that.description,_that.inputType,_that.options);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String key,  String question,  String description,  String inputType,  List<RatingQuestionOption>? options)?  $default,) {final _that = this;
switch (_that) {
case _RatingQuestion() when $default != null:
return $default(_that.key,_that.question,_that.description,_that.inputType,_that.options);case _:
  return null;
...
/// Available options for 'segmented' input type.
/// Each option has a display label and a normalized value.
@override List<RatingQuestionOption>? get options {
...
/// @nodoc
abstract mixin class _$RatingQuestionCopyWith<$Res> implements $RatingQuestionCopyWith<$Res> {
  factory _$RatingQuestionCopyWith(_RatingQuestion value, $Res Function(_RatingQuestion) _then) = __$RatingQuestionCopyWithImpl;
@override @useResult
$Res call({
 String key, String question, String description, String inputType, List<RatingQuestionOption>? options
});
...
/// Create a copy of RatingQuestion
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? question = null,Object? description = null,Object? inputType = null,Object? options = freezed,}) {
...
/// Display label for this option (localized).
 String get label;/// Normalized value (0.0-1.0) assigned when this option is selected.
 double get value;
...
abstract mixin class $RatingQuestionOptionCopyWith<$Res>  {
  factory $RatingQuestionOptionCopyWith(RatingQuestionOption value, $Res Function(RatingQuestionOption) _then) = _$RatingQuestionOptionCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RatingQuestionOption value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RatingQuestionOption value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RatingQuestionOption value)?  $default,){
final _that = this;
switch (_that) {
case _RatingQuestionOption() when $default != null:
return $default(_that);case _:
...
/// @nodoc
abstract mixin class _$RatingQuestionOptionCopyWith<$Res> implements $RatingQuestionOptionCopyWith<$Res> {
  factory _$RatingQuestionOptionCopyWith(_RatingQuestionOption value, $Res Function(_RatingQuestionOption) _then) = __$RatingQuestionOptionCopyWithImpl;
@override @useResult
$Res call({
 String label, double value
});
