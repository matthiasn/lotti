...
mixin _$TaskData {
 ...
 TaskStatus get status; DateTime get dateFrom; DateTime get dateTo; List<TaskStatus> get statusHistory; String get title; DateTime? get due; Duration? get estimate; List<String>? get checklistIds; String? get languageCode;/// Who last set the language — `user` (via UI) or `agent` (tool call).
///
...
@JsonKey(unknownEnumValue: ChangeSource.user) ChangeSource get languageSource;/// Set of label IDs the user explicitly removed and does not want suggested by AI.
...
as String?,languageSource: null == languageSource ? _self.languageSource : languageSource // ignore: cast_nullable_to_non_nullable
as ChangeSource,aiSuppressedLabelIds: freezed == aiSuppressedLabelIds ? _self.aiSuppressedLabelIds : aiSuppressedLabelIds // ignore: cast_nullable_to_non_nullable
...
/// Defaults to [ChangeSource.user] so that existing tasks with a language
/// already set are treated as user-set (safe default — never overwrite).
@override@JsonKey(unknownEnumValue: ChangeSource.user) final  ChangeSource languageSource;
...
as List<String>?,languageCode: freezed == languageCode ? _self.languageCode : languageCode // ignore: cast_nullable_to_non_nullable
as String?,languageSource: null == languageSource ? _self.languageSource : languageSource // ignore: cast_nullable_to_non_nullable
as ChangeSource,aiSuppressedLabelIds: freezed == aiSuppressedLabelIds ? _self._aiSuppressedLabelIds : aiSuppressedLabelIds // ignore: cast_nullable_to_non_nullable
as Set<String>?,priority: null == priority ? _self.priority : priority // ignore: cast_nullable_to_non_nullable
as TaskPriority,coverArtId: freezed == coverArtId ? _self.coverArtId : coverArtId // ignore: cast_nullable_to_non_nullable
as String?,coverArtCropX: null == coverArtCropX ? _self.coverArtCropX : coverArtCropX // ignore: cast_nullable_to_non_nullable
as double,
