...
class Journal extends Table with TableInfo<Journal, JournalDbEntity> {
  ...
  static const VerificationMeta _taskPriorityRankMeta = const VerificationMeta(
    'taskPriorityRank',
  );
  ...
  static const VerificationMeta _geohashStringMeta = const VerificationMeta(
    'geohashString',
  );
  ...
  static const VerificationMeta _geohashIntMeta = const VerificationMeta(
    'geohashInt',
  );
  ...
  VerificationContext validateIntegrity(
    Insertable<JournalDbEntity> instance, {
    ...
    if (data.containsKey('geohash_int')) {
      context.handle(
        _geohashIntMeta,
        geohashInt.isAcceptableOrUnknown(data['geohash_int']!, _geohashIntMeta),
      );
    }
  ...
  JournalDbEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return JournalDbEntity(
      ...
      taskPriorityRank: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}task_priority_rank'],
      ),
      ...
      geohashString: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}geohash_string'],
      ),
      geohashInt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}geohash_int'],
      ),
...
class JournalDbEntity extends DataClass implements Insertable<JournalDbEntity> {
  ...
  factory JournalDbEntity.fromJson(
  ...
  JournalDbEntity copyWith({
    ...
    taskPriority: taskPriority.present ? taskPriority.value : this.taskPriority,
    ...
    geohashString: geohashString.present
        ? geohashString.value
        : this.geohashString,
  ...
  JournalDbEntity copyWithCompanion(JournalCompanion data) {
    return JournalDbEntity(
      ...
      geohashString: data.geohashString.present
          ...
          : this.geohashString,
      geohashInt: data.geohashInt.present
          ? data.geohashInt.value
          : this.geohashInt,
...
class MeasurableTypes extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<MeasurableDbEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class MeasurableDbEntity extends DataClass
  ...
  factory MeasurableDbEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class HabitDefinitionDbEntity extends DataClass
  ...
  factory HabitDefinitionDbEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CategoryDefinitions extends Table
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CategoryDefinitionDbEntity map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class CategoryDefinitionDbEntity extends DataClass
  ...
  factory CategoryDefinitionDbEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class LabelDefinitionDbEntity extends DataClass
  ...
  factory LabelDefinitionDbEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class DashboardDefinitions extends Table
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DashboardDefinitionDbEntity map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class DashboardDefinitionDbEntity extends DataClass
  ...
  factory DashboardDefinitionDbEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class ConfigFlags extends Table with TableInfo<ConfigFlags, ConfigFlag> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ConfigFlag> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class Labeled extends Table with TableInfo<Labeled, LabeledWith> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<LabeledWith> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class LinkedEntries extends Table with TableInfo<LinkedEntries, LinkedDbEntry> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<LinkedDbEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class LinkedDbEntry extends DataClass implements Insertable<LinkedDbEntry> {
  ...
  factory LinkedDbEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$JournalDb extends GeneratedDatabase {
  ...
  late final Index idxJournalDateFromAsc = Index(
  ...
  late final Index idxJournalProjectTaskStatus = Index(
  ...
  late final Index idxLinkedEntriesToIdType = Index(
    'idx_linked_entries_to_id_type',
    'CREATE INDEX idx_linked_entries_to_id_type ON linked_entries (to_id COLLATE BINARY ASC, type COLLATE BINARY ASC)',
  );
  late final Index idxLinkedEntriesRatingToId = Index(
    'idx_linked_entries_rating_to_id',
    'CREATE INDEX idx_linked_entries_rating_to_id ON linked_entries (to_id COLLATE BINARY ASC, from_id COLLATE BINARY ASC) WHERE type = \'RatingLink\' AND COALESCE(hidden, FALSE) = FALSE',
  );
  ...
  Selectable<JournalDbEntity> filteredJournalFast(
    List<String> types,
    List<bool> privateStatuses,
    int limit,
    int offset,
  ...
  Selectable<JournalDbEntity> filteredJournalFastAllPrivate(
    List<String> types,
    int limit,
    int offset,
  ) {
  ...
  Selectable<JournalDbEntity> filteredJournalByIds(
    List<String> types,
    List<String> ids,
    List<bool> starredStatuses,
    List<bool> privateStatuses,
  ...
  Selectable<JournalDbEntity> filteredTasksFastAllPrivateAllStarred(
    ...
    $arrayStartIndex += categories.length;
    return customSelect(
      'SELECT * FROM journal WHERE type = \'Task\' AND deleted = FALSE AND task = 1 AND task_status IN ($expandedtaskStatuses) AND category IN ($expandedcategories) ORDER BY task_priority_rank ASC, date_from DESC LIMIT ?1 OFFSET ?2',
      variables: [
        Variable<int>(limit),
        Variable<int>(offset),
        for (var $ in taskStatuses) Variable<String>($),
  ...
  filteredTasksFastAllPrivateAllStarredWithPriorities(
    ...
    $arrayStartIndex += priorities.length;
    return customSelect(
      'SELECT * FROM journal WHERE type = \'Task\' AND deleted = FALSE AND task = 1 AND task_status IN ($expandedtaskStatuses) AND category IN ($expandedcategories) AND task_priority IN ($expandedpriorities) ORDER BY task_priority_rank ASC, date_from DESC LIMIT ?1 OFFSET ?2',
      variables: [
        Variable<int>(limit),
        Variable<int>(offset),
        for (var $ in taskStatuses) Variable<String>($),
  ...
  Selectable<JournalDbEntity> filteredTasksFast(
    ...
    $arrayStartIndex += categories.length;
    return customSelect(
      'SELECT * FROM journal WHERE type = \'Task\' AND deleted = FALSE AND private IN ($expandedprivateStatuses) AND starred IN ($expandedstarredStatuses) AND task = 1 AND task_status IN ($expandedtaskStatuses) AND category IN ($expandedcategories) ORDER BY task_priority_rank ASC, date_from DESC LIMIT ?1 OFFSET ?2',
      variables: [
        Variable<int>(limit),
        Variable<int>(offset),
        for (var $ in privateStatuses) Variable<bool>($),
  ...
  Selectable<JournalDbEntity> filteredTasksFastWithPriorities(
    ...
    $arrayStartIndex += priorities.length;
    return customSelect(
      'SELECT * FROM journal WHERE type = \'Task\' AND deleted = FALSE AND private IN ($expandedprivateStatuses) AND starred IN ($expandedstarredStatuses) AND task = 1 AND task_status IN ($expandedtaskStatuses) AND category IN ($expandedcategories) AND task_priority IN ($expandedpriorities) ORDER BY task_priority_rank ASC, date_from DESC LIMIT ?1 OFFSET ?2',
      variables: [
        Variable<int>(limit),
        Variable<int>(offset),
        for (var $ in privateStatuses) Variable<bool>($),
  ...
  Selectable<int> countInProgressTasks(
    List<bool> privateStatuses,
    List<String?> taskStatuses,
  ) {
  ...
  Selectable<String> journalEntityIdsByDateFromDesc(
    List<String> ids,
    List<bool> privateStatuses,
  ) {
    var $arrayStartIndex = 1;
    ...
    $arrayStartIndex += privateStatuses.length;
    return customSelect(
      'SELECT id FROM journal WHERE deleted = FALSE AND id IN ($expandedids) AND private IN ($expandedprivateStatuses) ORDER BY date_from DESC',
      variables: [
        for (var $ in ids) Variable<String>($),
        for (var $ in privateStatuses) Variable<bool>($),
      ],
  ...
  Selectable<JournalDbEntity> workEntriesInDateRange(
    ...
    final expandedtypes = $expandVar($arrayStartIndex, types.length);
    $arrayStartIndex += types.length;
    final expandedcategoryIds = $expandVar(
      $arrayStartIndex,
      categoryIds.length,
    );
  ...
  Selectable<JournalDbEntity> tasksForProject(String? projectId) {
    return customSelect(
      'SELECT * FROM journal WHERE project_id = ?1 AND deleted = FALSE AND type = \'Task\' AND task = 1 ORDER BY task_priority_rank ASC, date_from DESC',
  ...
  Selectable<JournalDbEntity> tasksForProjectByPrivateStatuses(
    ...
    $arrayStartIndex += privateStatuses.length;
    return customSelect(
      'SELECT * FROM journal WHERE project_id = ?1 AND deleted = FALSE AND type = \'Task\' AND task = 1 AND private IN ($expandedprivateStatuses) ORDER BY task_priority_rank ASC, date_from DESC',
      variables: [
...
class $JournalTableManager
    extends
        RootTableManager<
          ...
          (
            JournalDbEntity,
            BaseReferences<_$JournalDb, Journal, JournalDbEntity>,
          ),
          JournalDbEntity,
...
typedef $JournalProcessedTableManager =
...
typedef $ConflictsProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $MeasurableTypesCreateCompanionBuilder =
    MeasurableTypesCompanion Function({
      required String id,
      required String uniqueName,
      required DateTime createdAt,
      required DateTime updatedAt,
...
typedef $MeasurableTypesUpdateCompanionBuilder =
    MeasurableTypesCompanion Function({
      Value<String> id,
      Value<String> uniqueName,
      Value<DateTime> createdAt,
...
class $MeasurableTypesTableManager
    extends
        RootTableManager<
          _$JournalDb,
          MeasurableTypes,
...
typedef $MeasurableTypesProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      MeasurableTypes,
      MeasurableDbEntity,
      ...
      PrefetchHooks Function()
    >;
typedef $HabitDefinitionsCreateCompanionBuilder =
...
typedef $HabitDefinitionsUpdateCompanionBuilder =
    HabitDefinitionsCompanion Function({
      Value<String> id,
      Value<String> name,
      Value<DateTime> createdAt,
...
class $HabitDefinitionsTableManager
    extends
        RootTableManager<
          _$JournalDb,
          HabitDefinitions,
...
typedef $HabitDefinitionsProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      HabitDefinitions,
      HabitDefinitionDbEntity,
...
class $CategoryDefinitionsTableManager
    extends
        RootTableManager<
          _$JournalDb,
          CategoryDefinitions,
...
typedef $CategoryDefinitionsProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      CategoryDefinitions,
      CategoryDefinitionDbEntity,
      ...
      PrefetchHooks Function()
    >;
typedef $LabelDefinitionsCreateCompanionBuilder =
    LabelDefinitionsCompanion Function({
      required String id,
      required String name,
      required String color,
      required DateTime createdAt,
...
typedef $LabelDefinitionsUpdateCompanionBuilder =
    LabelDefinitionsCompanion Function({
      Value<String> id,
      Value<String> name,
      Value<String> color,
...
class $LabelDefinitionsTableManager
    extends
        RootTableManager<
          _$JournalDb,
          LabelDefinitions,
...
typedef $LabelDefinitionsProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      LabelDefinitions,
      LabelDefinitionDbEntity,
...
class $DashboardDefinitionsTableManager
    extends
        RootTableManager<
          _$JournalDb,
          DashboardDefinitions,
...
typedef $DashboardDefinitionsProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      DashboardDefinitions,
      DashboardDefinitionDbEntity,
      ...
      PrefetchHooks Function()
    >;
typedef $ConfigFlagsCreateCompanionBuilder =
    ConfigFlagsCompanion Function({
      required String name,
      required String description,
      Value<bool> status,
      Value<int> rowid,
    });
typedef $ConfigFlagsUpdateCompanionBuilder =
    ConfigFlagsCompanion Function({
      Value<String> name,
      Value<String> description,
      Value<bool> status,
...
typedef $ConfigFlagsProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      ConfigFlags,
      ConfigFlag,
...
typedef $LabeledUpdateCompanionBuilder =
    LabeledCompanion Function({
      Value<String> id,
      Value<String> journalId,
      Value<String> labelId,
...
typedef $LabeledProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      Labeled,
      LabeledWith,
      ...
      PrefetchHooks Function()
    >;
typedef $LinkedEntriesCreateCompanionBuilder =
    LinkedEntriesCompanion Function({
      required String id,
      required String fromId,
      required String toId,
      required String type,
...
typedef $LinkedEntriesUpdateCompanionBuilder =
    LinkedEntriesCompanion Function({
      Value<String> id,
      Value<String> fromId,
      Value<String> toId,
...
class $LinkedEntriesTableManager
    extends
        RootTableManager<
          _$JournalDb,
          LinkedEntries,
          ...
          (
            LinkedDbEntry,
            BaseReferences<_$JournalDb, LinkedEntries, LinkedDbEntry>,
          ),
          LinkedDbEntry,
          PrefetchHooks Function()
        > {
...
typedef $LinkedEntriesProcessedTableManager =
    ProcessedTableManager<
      _$JournalDb,
      LinkedEntries,
      LinkedDbEntry,
