...
3. Improver Agents: scheduled weekly rituals that extract feedback from agent instances and propose directive improvements.
4. Meta-Improver: recursive self-improvement (depth 1) that evaluates and improves the improver agents themselves on a monthly cadence.
