...
class AgentDbConversions {
  ...
  static AgentEntitiesCompanion toEntityCompanion(AgentDomainEntity entity) {
    ...
    final deletedAt = entity.map(
      ...
      dayDirective: (e) => e.deletedAt,
      dayStatusEvent: (e) => e.deletedAt,
      weekRollup: (e) => e.deletedAt,
      ...
      projectRecommendationRun: (e) => e.deletedAt,
  ...
  static String entityType(AgentDomainEntity entity) {
    return entity.map(
      ...
      dayDirective: (_) => AgentEntityTypes.dayDirective,
      dayStatusEvent: (_) => AgentEntityTypes.dayStatusEvent,
      weekRollup: (_) => AgentEntityTypes.weekRollup,
      ...
      projectRecommendationRun: (_) =>
          AgentEntityTypes.projectRecommendationRun,
  ...
  static DateTime entityCreatedAt(AgentDomainEntity entity) {
    return entity.map(
      ...
      dayDirective: (e) => e.createdAt,
      dayStatusEvent: (e) => e.createdAt,
      weekRollup: (e) => e.createdAt,
