...
return projectRecommendation(_that.id,_that.agentId,_that.projectId,_that.title,_that.position,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.sourceRunId,_that.sourceChangeSetId,_that.sourceDecisionId,_that.rationale,_that.priority,_that.resolvedAt,_that.dismissedAt,_that.supersededAt,_that.deletedAt);case WakeTokenUsageEntity() when wakeTokenUsage != null:
...
return projectRecommendation(_that.id,_that.agentId,_that.projectId,_that.title,_that.position,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.sourceRunId,_that.sourceChangeSetId,_that.sourceDecisionId,_that.rationale,_that.priority,_that.resolvedAt,_that.dismissedAt,_that.supersededAt,_that.deletedAt);case WakeTokenUsageEntity():
return wakeTokenUsage(_that.id,_that.agentId,_that.runKey,_that.threadId,_that.modelId,_that.createdAt,_that.vectorClock,_that.templateId,_that.templateVersionId,_that.soulDocumentId,_that.soulDocumentVersionId,_that.inputTokens,_that.outputTokens,_that.thoughtsTokens,_that.cachedInputTokens,_that.deletedAt);case SoulDocumentEntity():
...
class ProjectRecommendationEntity implements AgentDomainEntity {
  const ProjectRecommendationEntity({required this.id, required this.agentId, required this.projectId, required this.title, required this.position, required this.status, required this.createdAt, required this.updatedAt, required this.vectorClock, this.sourceRunId, this.sourceChangeSetId, this.sourceDecisionId, this.rationale, this.priority, this.resolvedAt, this.dismissedAt, this.supersededAt, this.deletedAt, final  String? $type}): $type = $type ?? 'projectRecommendation';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,projectId,title,position,status,createdAt,updatedAt,vectorClock,sourceRunId,sourceChangeSetId,sourceDecisionId,rationale,priority,resolvedAt,dismissedAt,supersededAt,deletedAt);
...
@override @useResult
$Res call({
 String id, String agentId, String projectId, String title, int position, ProjectRecommendationStatus status, DateTime createdAt, DateTime updatedAt, VectorClock? vectorClock, String? sourceRunId, String? sourceChangeSetId, String? sourceDecisionId, String? rationale, String? priority, DateTime? resolvedAt, DateTime? dismissedAt, DateTime? supersededAt, DateTime? deletedAt
});
