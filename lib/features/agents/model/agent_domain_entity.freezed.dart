...
return capture(_that.id,_that.agentId,_that.transcript,_that.capturedAt,_that.createdAt,_that.vectorClock,_that.dayId,_that.audioRef,_that.deletedAt);case PlannerKnowledgeEntity() when plannerKnowledge != null:
...
return capture(_that.id,_that.agentId,_that.transcript,_that.capturedAt,_that.createdAt,_that.vectorClock,_that.dayId,_that.audioRef,_that.deletedAt);case PlannerKnowledgeEntity():
...
class CaptureEntity implements AgentDomainEntity {
  const CaptureEntity({required this.id, required this.agentId, required this.transcript, required this.capturedAt, required this.createdAt, required this.vectorClock, this.dayId = '', this.audioRef, this.deletedAt, final  String? $type}): $type = $type ?? 'capture';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,transcript,capturedAt,createdAt,vectorClock,dayId,audioRef,deletedAt);

@override
String toString() {
  return 'AgentDomainEntity.capture(id: $id, agentId: $agentId, transcript: $transcript, capturedAt: $capturedAt, createdAt: $createdAt, vectorClock: $vectorClock, dayId: $dayId, audioRef: $audioRef, deletedAt: $deletedAt)';
}
...
@override @useResult
$Res call({
 String id, String agentId, String transcript, DateTime capturedAt, DateTime createdAt, VectorClock? vectorClock, String dayId, String? audioRef, DateTime? deletedAt
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? transcript = null,Object? capturedAt = null,Object? createdAt = null,Object? vectorClock = freezed,Object? dayId = null,Object? audioRef = freezed,Object? deletedAt = freezed,}) {
