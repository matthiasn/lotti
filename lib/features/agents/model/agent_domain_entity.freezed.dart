...
return plannerKnowledge(_that.id,_that.agentId,_that.key,_that.hook,_that.statementText,_that.source,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.value,_that.scope,_that.supersedesId,_that.confirmedAt,_that.retractedAt,_that.reviewAfter,_that.deletedAt);case ParsedItemEntity():
...
class PlannerKnowledgeEntity implements AgentDomainEntity {
  const PlannerKnowledgeEntity({required this.id, required this.agentId, required this.key, required this.hook, required this.statementText, required this.source, required this.status, required this.createdAt, required this.updatedAt, required this.vectorClock, this.value = '', this.scope = 'global', this.supersedesId, this.confirmedAt, this.retractedAt, this.reviewAfter, this.deletedAt, final  String? $type}): $type = $type ?? 'plannerKnowledge';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,key,hook,statementText,source,status,createdAt,updatedAt,vectorClock,value,scope,supersedesId,confirmedAt,retractedAt,reviewAfter,deletedAt);

@override
String toString() {
  return 'AgentDomainEntity.plannerKnowledge(id: $id, agentId: $agentId, key: $key, hook: $hook, statementText: $statementText, source: $source, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, value: $value, scope: $scope, supersedesId: $supersedesId, confirmedAt: $confirmedAt, retractedAt: $retractedAt, reviewAfter: $reviewAfter, deletedAt: $deletedAt)';
}
...
as String,scope: null == scope ? _self.scope : scope // ignore: cast_nullable_to_non_nullable
as String,supersedesId: freezed == supersedesId ? _self.supersedesId : supersedesId // ignore: cast_nullable_to_non_nullable
