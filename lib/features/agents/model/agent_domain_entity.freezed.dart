...
return goalNudge(_that.id,_that.agentId,_that.status,_that.brief,_that.briefDigest,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.imageEntryId,_that.runKey,_that.threadId,_that.triggerProgressId,_that.reasonSummary,_that.staleAt,_that.activatedAt,_that.dismissedAt,_that.retiredAt,_that.expiredAt,_that.ratings,_that.totalVisibleMs,_that.impressionCount,_that.firstShownAt,_that.lastShownAt,_that.provenance,_that.deletedAt);case AgentUnknownEntity() when unknown != null:
...
class GoalNudgeEntity implements AgentDomainEntity {
  const GoalNudgeEntity({required this.id, required this.agentId, required this.status, required this.brief, required this.briefDigest, required this.createdAt, required this.updatedAt, required this.vectorClock, this.imageEntryId, this.runKey, this.threadId, this.triggerProgressId, this.reasonSummary, this.staleAt, this.activatedAt, this.dismissedAt, this.retiredAt, this.expiredAt, final  List<GoalNudgeRating> ratings = const <GoalNudgeRating>[], this.totalVisibleMs = 0, this.impressionCount = 0, this.firstShownAt, this.lastShownAt, final  Map<String, String> provenance = const <String, String>{}, this.deletedAt, final  String? $type}): _ratings = ratings,_provenance = provenance,$type = $type ?? 'goalNudge';
...
@JsonKey() final  int totalVisibleMs;
@JsonKey() final  int impressionCount;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoalNudgeEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.agentId, agentId) || other.agentId == agentId)&&(identical(other.status, status) || other.status == status)&&(identical(other.brief, brief) || other.brief == brief)&&(identical(other.briefDigest, briefDigest) || other.briefDigest == briefDigest)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.vectorClock, vectorClock) || other.vectorClock == vectorClock)&&(identical(other.imageEntryId, imageEntryId) || other.imageEntryId == imageEntryId)&&(identical(other.runKey, runKey) || other.runKey == runKey)&&(identical(other.threadId, threadId) || other.threadId == threadId)&&(identical(other.triggerProgressId, triggerProgressId) || other.triggerProgressId == triggerProgressId)&&(identical(other.reasonSummary, reasonSummary) || other.reasonSummary == reasonSummary)&&(identical(other.staleAt, staleAt) || other.staleAt == staleAt)&&(identical(other.activatedAt, activatedAt) || other.activatedAt == activatedAt)&&(identical(other.dismissedAt, dismissedAt) || other.dismissedAt == dismissedAt)&&(identical(other.retiredAt, retiredAt) || other.retiredAt == retiredAt)&&(identical(other.expiredAt, expiredAt) || other.expiredAt == expiredAt)&&const DeepCollectionEquality().equals(other._ratings, _ratings)&&(identical(other.totalVisibleMs, totalVisibleMs) || other.totalVisibleMs == totalVisibleMs)&&(identical(other.impressionCount, impressionCount) || other.impressionCount == impressionCount)&&(identical(other.firstShownAt, firstShownAt) || other.firstShownAt == firstShownAt)&&(identical(other.lastShownAt, lastShownAt) || other.lastShownAt == lastShownAt)&&const DeepCollectionEquality().equals(other._provenance, _provenance)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,agentId,status,brief,briefDigest,createdAt,updatedAt,vectorClock,imageEntryId,runKey,threadId,triggerProgressId,reasonSummary,staleAt,activatedAt,dismissedAt,retiredAt,expiredAt,const DeepCollectionEquality().hash(_ratings),totalVisibleMs,impressionCount,firstShownAt,lastShownAt,const DeepCollectionEquality().hash(_provenance),deletedAt]);

@override
String toString() {
  return 'AgentDomainEntity.goalNudge(id: $id, agentId: $agentId, status: $status, brief: $brief, briefDigest: $briefDigest, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, imageEntryId: $imageEntryId, runKey: $runKey, threadId: $threadId, triggerProgressId: $triggerProgressId, reasonSummary: $reasonSummary, staleAt: $staleAt, activatedAt: $activatedAt, dismissedAt: $dismissedAt, retiredAt: $retiredAt, expiredAt: $expiredAt, ratings: $ratings, totalVisibleMs: $totalVisibleMs, impressionCount: $impressionCount, firstShownAt: $firstShownAt, lastShownAt: $lastShownAt, provenance: $provenance, deletedAt: $deletedAt)';
}
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? status = null,Object? brief = null,Object? briefDigest = null,Object? createdAt = null,Object? updatedAt = null,Object? vectorClock = freezed,Object? imageEntryId = freezed,Object? runKey = freezed,Object? threadId = freezed,Object? triggerProgressId = freezed,Object? reasonSummary = freezed,Object? staleAt = freezed,Object? activatedAt = freezed,Object? dismissedAt = freezed,Object? retiredAt = freezed,Object? expiredAt = freezed,Object? ratings = null,Object? totalVisibleMs = null,Object? impressionCount = null,Object? firstShownAt = freezed,Object? lastShownAt = freezed,Object? provenance = null,Object? deletedAt = freezed,}) {
...
as DateTime,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,vectorClock: freezed == vectorClock ? _self.vectorClock : vectorClock // ignore: cast_nullable_to_non_nullable
as VectorClock?,imageEntryId: freezed == imageEntryId ? _self.imageEntryId : imageEntryId // ignore: cast_nullable_to_non_nullable
as String?,runKey: freezed == runKey ? _self.runKey : runKey // ignore: cast_nullable_to_non_nullable
...
as DateTime?,ratings: null == ratings ? _self._ratings : ratings // ignore: cast_nullable_to_non_nullable
...
as int,impressionCount: null == impressionCount ? _self.impressionCount : impressionCount // ignore: cast_nullable_to_non_nullable
as int,firstShownAt: freezed == firstShownAt ? _self.firstShownAt : firstShownAt // ignore: cast_nullable_to_non_nullable
