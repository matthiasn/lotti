...
return changeDecision(_that);case WakeTokenUsageEntity() when wakeTokenUsage != null:
...
return changeDecision(_that);case WakeTokenUsageEntity():
...
return agentState(_that.id,_that.agentId,_that.revision,_that.slots,_that.updatedAt,_that.vectorClock,_that.lastWakeAt,_that.nextWakeAt,_that.sleepUntil,_that.scheduledWakeAt,_that.recentHeadMessageId,_that.latestSummaryMessageId,_that.consecutiveFailureCount,_that.wakeCounter,_that.processedCounterByHost,_that.deletedAt);case AgentMessageEntity() when agentMessage != null:
...
return changeDecision(_that.id,_that.agentId,_that.changeSetId,_that.itemIndex,_that.toolName,_that.verdict,_that.createdAt,_that.vectorClock,_that.taskId,_that.rejectionReason,_that.humanSummary,_that.args,_that.deletedAt);case WakeTokenUsageEntity() when wakeTokenUsage != null:
...
return agentState(_that.id,_that.agentId,_that.revision,_that.slots,_that.updatedAt,_that.vectorClock,_that.lastWakeAt,_that.nextWakeAt,_that.sleepUntil,_that.scheduledWakeAt,_that.recentHeadMessageId,_that.latestSummaryMessageId,_that.consecutiveFailureCount,_that.wakeCounter,_that.processedCounterByHost,_that.deletedAt);case AgentMessageEntity():
...
return changeDecision(_that.id,_that.agentId,_that.changeSetId,_that.itemIndex,_that.toolName,_that.verdict,_that.createdAt,_that.vectorClock,_that.taskId,_that.rejectionReason,_that.humanSummary,_that.args,_that.deletedAt);case WakeTokenUsageEntity():
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,revision,slots,updatedAt,vectorClock,lastWakeAt,nextWakeAt,sleepUntil,scheduledWakeAt,recentHeadMessageId,latestSummaryMessageId,consecutiveFailureCount,wakeCounter,const DeepCollectionEquality().hash(_processedCounterByHost),deletedAt);
...
as Map<String, int>,deletedAt: freezed == deletedAt ? _self.deletedAt : deletedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
