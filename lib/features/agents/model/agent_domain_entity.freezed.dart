...
return weekRollup(_that.id,_that.agentId,_that.weekStart,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.plannedMinutesByCategory,_that.recordedMinutesByCategory,_that.daysWithPlans,_that.deletedAt);case AttentionRequestEntity() when attentionRequest != null:
...
return weekRollup(_that.id,_that.agentId,_that.weekStart,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.plannedMinutesByCategory,_that.recordedMinutesByCategory,_that.daysWithPlans,_that.deletedAt);case AttentionRequestEntity():
return attentionRequest(_that.id,_that.agentId,_that.kind,_that.title,_that.categoryId,_that.requestedMinutes,_that.impact,_that.urgency,_that.energyFit,_that.evidenceRefs,_that.createdAt,_that.vectorClock,_that.scopeKind,_that.status,_that.rangeStart,_that.rangeEnd,_that.earliestStart,_that.latestEnd,_that.deadline,_that.nextReviewAt,_that.targetId,_that.targetKind,_that.cadence,_that.rationale,_that.deletedAt);case AttentionClaimDispositionEntity():
...
class WeekRollupEntity implements AgentDomainEntity {
  const WeekRollupEntity({required this.id, required this.agentId, required this.weekStart, required this.createdAt, required this.updatedAt, required this.vectorClock, final  Map<String, int> plannedMinutesByCategory = const <String, int>{}, final  Map<String, int> recordedMinutesByCategory = const <String, int>{}, this.daysWithPlans = 0, this.deletedAt, final  String? $type}): _plannedMinutesByCategory = plannedMinutesByCategory,_recordedMinutesByCategory = recordedMinutesByCategory,$type = $type ?? 'weekRollup';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,weekStart,createdAt,updatedAt,vectorClock,const DeepCollectionEquality().hash(_plannedMinutesByCategory),const DeepCollectionEquality().hash(_recordedMinutesByCategory),daysWithPlans,deletedAt);

@override
String toString() {
  return 'AgentDomainEntity.weekRollup(id: $id, agentId: $agentId, weekStart: $weekStart, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, plannedMinutesByCategory: $plannedMinutesByCategory, recordedMinutesByCategory: $recordedMinutesByCategory, daysWithPlans: $daysWithPlans, deletedAt: $deletedAt)';
}
...
@override @useResult
$Res call({
 String id, String agentId, DateTime weekStart, DateTime createdAt, DateTime updatedAt, VectorClock? vectorClock, Map<String, int> plannedMinutesByCategory, Map<String, int> recordedMinutesByCategory, int daysWithPlans, DateTime? deletedAt
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? weekStart = null,Object? createdAt = null,Object? updatedAt = null,Object? vectorClock = freezed,Object? plannedMinutesByCategory = null,Object? recordedMinutesByCategory = null,Object? daysWithPlans = null,Object? deletedAt = freezed,}) {
