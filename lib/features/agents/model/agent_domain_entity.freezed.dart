...
return evolutionSession(_that.id,_that.agentId,_that.templateId,_that.sessionNumber,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.proposedVersionId,_that.feedbackSummary,_that.userRating,_that.completedAt,_that.deletedAt);case EvolutionSessionRecapEntity() when evolutionSessionRecap != null:
...
return evolutionSession(_that.id,_that.agentId,_that.templateId,_that.sessionNumber,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.proposedVersionId,_that.feedbackSummary,_that.userRating,_that.completedAt,_that.deletedAt);case EvolutionSessionRecapEntity():
...
return wakeTokenUsage(_that.id,_that.agentId,_that.runKey,_that.threadId,_that.modelId,_that.createdAt,_that.vectorClock,_that.templateId,_that.templateVersionId,_that.inputTokens,_that.outputTokens,_that.thoughtsTokens,_that.cachedInputTokens,_that.deletedAt);case SoulDocumentEntity():
