...
return dayPlan(_that);case AgentTemplateEntity() when agentTemplate != null:
...
return dayPlan(_that);case AgentTemplateEntity():
...
return agentState(_that.id,_that.agentId,_that.revision,_that.slots,_that.updatedAt,_that.vectorClock,_that.lastWakeAt,_that.nextWakeAt,_that.sleepUntil,_that.scheduledWakeAt,_that.recentHeadMessageId,_that.latestSummaryMessageId,_that.consecutiveFailureCount,_that.wakeCounter,_that.processedCounterByHost,_that.toolCounterByKey,_that.awaitingContent,_that.deletedAt);case AgentMessageEntity() when agentMessage != null:
...
return dayPlan(_that.id,_that.agentId,_that.dayId,_that.planDate,_that.data,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.captureId,_that.energyBands,_that.capacityMinutes,_that.scheduledMinutes,_that.deletedAt);case AgentTemplateEntity() when agentTemplate != null:
...
return dayPlan(_that.id,_that.agentId,_that.dayId,_that.planDate,_that.data,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.captureId,_that.energyBands,_that.capacityMinutes,_that.scheduledMinutes,_that.deletedAt);case AgentTemplateEntity():
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,revision,slots,updatedAt,vectorClock,lastWakeAt,nextWakeAt,sleepUntil,scheduledWakeAt,recentHeadMessageId,latestSummaryMessageId,consecutiveFailureCount,wakeCounter,const DeepCollectionEquality().hash(_processedCounterByHost),const DeepCollectionEquality().hash(_toolCounterByKey),awaitingContent,deletedAt);
