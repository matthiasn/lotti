...
return agentReportHead(_that);case CaptureEntity() when capture != null:
...
return attentionRequest(_that);case AttentionAwardEntity() when attentionAward != null:
return attentionAward(_that);case AgentTemplateEntity() when agentTemplate != null:
...
return agentReportHead(_that);case CaptureEntity():
...
return attentionRequest(_that);case AttentionAwardEntity():
return attentionAward(_that);case AgentTemplateEntity():
...
return agentReportHead(_that.id,_that.agentId,_that.scope,_that.reportId,_that.updatedAt,_that.vectorClock,_that.deletedAt);case CaptureEntity() when capture != null:
...
return attentionRequest(_that.id,_that.agentId,_that.dayId,_that.kind,_that.title,_that.categoryId,_that.requestedMinutes,_that.impact,_that.urgency,_that.energyFit,_that.evidenceRefs,_that.createdAt,_that.vectorClock,_that.status,_that.earliestStart,_that.latestEnd,_that.deadline,_that.targetId,_that.targetKind,_that.cadence,_that.rationale,_that.deletedAt);case AttentionAwardEntity() when attentionAward != null:
return attentionAward(_that.id,_that.agentId,_that.requestId,_that.dayId,_that.planId,_that.blockId,_that.categoryId,_that.title,_that.startTime,_that.endTime,_that.rank,_that.utilityScore,_that.createdAt,_that.vectorClock,_that.status,_that.taskId,_that.rationale,_that.deletedAt);case AgentTemplateEntity() when agentTemplate != null:
...
return agentReportHead(_that.id,_that.agentId,_that.scope,_that.reportId,_that.updatedAt,_that.vectorClock,_that.deletedAt);case CaptureEntity():
...
return attentionRequest(_that.id,_that.agentId,_that.dayId,_that.kind,_that.title,_that.categoryId,_that.requestedMinutes,_that.impact,_that.urgency,_that.energyFit,_that.evidenceRefs,_that.createdAt,_that.vectorClock,_that.status,_that.earliestStart,_that.latestEnd,_that.deadline,_that.targetId,_that.targetKind,_that.cadence,_that.rationale,_that.deletedAt);case AttentionAwardEntity():
return attentionAward(_that.id,_that.agentId,_that.requestId,_that.dayId,_that.planId,_that.blockId,_that.categoryId,_that.title,_that.startTime,_that.endTime,_that.rank,_that.utilityScore,_that.createdAt,_that.vectorClock,_that.status,_that.taskId,_that.rationale,_that.deletedAt);case AgentTemplateEntity():
...
class AttentionRequestEntity implements AgentDomainEntity {
  const AttentionRequestEntity({required this.id, required this.agentId, required this.dayId, required this.kind, required this.title, required this.categoryId, required this.requestedMinutes, required this.impact, required this.urgency, required this.energyFit, required final  List<AttentionEvidenceRef> evidenceRefs, required this.createdAt, required this.vectorClock, this.status = AttentionRequestStatus.pending, this.earliestStart, this.latestEnd, this.deadline, this.targetId, this.targetKind, this.cadence, this.rationale, this.deletedAt, final  String? $type}): _evidenceRefs = evidenceRefs,$type = $type ?? 'attentionRequest';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,agentId,dayId,kind,title,categoryId,requestedMinutes,impact,urgency,energyFit,const DeepCollectionEquality().hash(_evidenceRefs),createdAt,vectorClock,status,earliestStart,latestEnd,deadline,targetId,targetKind,cadence,rationale,deletedAt]);

@override
String toString() {
  return 'AgentDomainEntity.attentionRequest(id: $id, agentId: $agentId, dayId: $dayId, kind: $kind, title: $title, categoryId: $categoryId, requestedMinutes: $requestedMinutes, impact: $impact, urgency: $urgency, energyFit: $energyFit, evidenceRefs: $evidenceRefs, createdAt: $createdAt, vectorClock: $vectorClock, status: $status, earliestStart: $earliestStart, latestEnd: $latestEnd, deadline: $deadline, targetId: $targetId, targetKind: $targetKind, cadence: $cadence, rationale: $rationale, deletedAt: $deletedAt)';
}
...
@override @useResult
$Res call({
 String id, String agentId, String dayId, AttentionRequestKind kind, String title, String categoryId, int requestedMinutes, int impact, int urgency, AttentionEnergyFit energyFit, List<AttentionEvidenceRef> evidenceRefs, DateTime createdAt, VectorClock? vectorClock, AttentionRequestStatus status, DateTime? earliestStart, DateTime? latestEnd, DateTime? deadline, String? targetId, String? targetKind, String? cadence, String? rationale, DateTime? deletedAt
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? dayId = null,Object? kind = null,Object? title = null,Object? categoryId = null,Object? requestedMinutes = null,Object? impact = null,Object? urgency = null,Object? energyFit = null,Object? evidenceRefs = null,Object? createdAt = null,Object? vectorClock = freezed,Object? status = null,Object? earliestStart = freezed,Object? latestEnd = freezed,Object? deadline = freezed,Object? targetId = freezed,Object? targetKind = freezed,Object? cadence = freezed,Object? rationale = freezed,Object? deletedAt = freezed,}) {
...
as AttentionRequestStatus,earliestStart: freezed == earliestStart ? _self.earliestStart : earliestStart // ignore: cast_nullable_to_non_nullable
