...
return agentReportHead(_that);case AgentTemplateEntity() when agentTemplate != null:
...
return evolutionSession(_that);case EvolutionNoteEntity() when evolutionNote != null:
...
return agentReportHead(_that);case AgentTemplateEntity():
...
return evolutionSession(_that);case EvolutionNoteEntity():
...
return agentState(_that.id,_that.agentId,_that.revision,_that.slots,_that.updatedAt,_that.vectorClock,_that.lastWakeAt,_that.nextWakeAt,_that.sleepUntil,_that.scheduledWakeAt,_that.recentHeadMessageId,_that.latestSummaryMessageId,_that.consecutiveFailureCount,_that.wakeCounter,_that.processedCounterByHost,_that.awaitingContent,_that.deletedAt);case AgentMessageEntity() when agentMessage != null:
...
return agentReport(_that.id,_that.agentId,_that.scope,_that.createdAt,_that.vectorClock,_that.content,_that.tldr,_that.confidence,_that.provenance,_that.deletedAt,_that.threadId);case AgentReportHeadEntity() when agentReportHead != null:
return agentReportHead(_that.id,_that.agentId,_that.scope,_that.reportId,_that.updatedAt,_that.vectorClock,_that.deletedAt);case AgentTemplateEntity() when agentTemplate != null:
...
return evolutionSession(_that.id,_that.agentId,_that.templateId,_that.sessionNumber,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.proposedVersionId,_that.feedbackSummary,_that.userRating,_that.completedAt,_that.deletedAt);case EvolutionNoteEntity() when evolutionNote != null:
...
return projectRecommendation(_that.id,_that.agentId,_that.projectId,_that.changeSetId,_that.decisionId,_that.title,_that.createdAt,_that.vectorClock,_that.rationale,_that.priority,_that.deletedAt);case WakeTokenUsageEntity() when wakeTokenUsage != null:
...
return agentReport(_that.id,_that.agentId,_that.scope,_that.createdAt,_that.vectorClock,_that.content,_that.tldr,_that.confidence,_that.provenance,_that.deletedAt,_that.threadId);case AgentReportHeadEntity():
return agentReportHead(_that.id,_that.agentId,_that.scope,_that.reportId,_that.updatedAt,_that.vectorClock,_that.deletedAt);case AgentTemplateEntity():
...
return evolutionSession(_that.id,_that.agentId,_that.templateId,_that.sessionNumber,_that.status,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.proposedVersionId,_that.feedbackSummary,_that.userRating,_that.completedAt,_that.deletedAt);case EvolutionNoteEntity():
...
return projectRecommendation(_that.id,_that.agentId,_that.projectId,_that.changeSetId,_that.decisionId,_that.title,_that.createdAt,_that.vectorClock,_that.rationale,_that.priority,_that.deletedAt);case WakeTokenUsageEntity():
...
class AgentStateEntity implements AgentDomainEntity {
  const AgentStateEntity({required this.id, required this.agentId, required this.revision, required this.slots, required this.updatedAt, required this.vectorClock, this.lastWakeAt, this.nextWakeAt, this.sleepUntil, this.scheduledWakeAt, this.recentHeadMessageId, this.latestSummaryMessageId, this.consecutiveFailureCount = 0, this.wakeCounter = 0, final  Map<String, int> processedCounterByHost = const {}, this.awaitingContent = false, this.deletedAt, final  String? $type}): _processedCounterByHost = processedCounterByHost,$type = $type ?? 'agentState';
...
@override @useResult
$Res call({
 String id, String agentId, int revision, AgentSlots slots, DateTime updatedAt, VectorClock? vectorClock, DateTime? lastWakeAt, DateTime? nextWakeAt, DateTime? sleepUntil, DateTime? scheduledWakeAt, String? recentHeadMessageId, String? latestSummaryMessageId, int consecutiveFailureCount, int wakeCounter, Map<String, int> processedCounterByHost, bool awaitingContent, DateTime? deletedAt
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? revision = null,Object? slots = null,Object? updatedAt = null,Object? vectorClock = freezed,Object? lastWakeAt = freezed,Object? nextWakeAt = freezed,Object? sleepUntil = freezed,Object? scheduledWakeAt = freezed,Object? recentHeadMessageId = freezed,Object? latestSummaryMessageId = freezed,Object? consecutiveFailureCount = null,Object? wakeCounter = null,Object? processedCounterByHost = null,Object? awaitingContent = null,Object? deletedAt = freezed,}) {
...
as DateTime,vectorClock: freezed == vectorClock ? _self.vectorClock : vectorClock // ignore: cast_nullable_to_non_nullable
as VectorClock?,lastWakeAt: freezed == lastWakeAt ? _self.lastWakeAt : lastWakeAt // ignore: cast_nullable_to_non_nullable
...
as int,processedCounterByHost: null == processedCounterByHost ? _self._processedCounterByHost : processedCounterByHost // ignore: cast_nullable_to_non_nullable
...
class AgentReportEntity implements AgentDomainEntity {
  const AgentReportEntity({required this.id, required this.agentId, required this.scope, required this.createdAt, required this.vectorClock, this.content = '', this.tldr, this.confidence, final  Map<String, Object?> provenance = const {}, this.deletedAt, this.threadId, final  String? $type}): _provenance = provenance,$type = $type ?? 'agentReport';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,scope,createdAt,vectorClock,content,tldr,confidence,const DeepCollectionEquality().hash(_provenance),deletedAt,threadId);
...
@override @useResult
$Res call({
 String id, String agentId, String scope, DateTime createdAt, VectorClock? vectorClock, String content, String? tldr, double? confidence, Map<String, Object?> provenance, DateTime? deletedAt, String? threadId
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? scope = null,Object? createdAt = null,Object? vectorClock = freezed,Object? content = null,Object? tldr = freezed,Object? confidence = freezed,Object? provenance = null,Object? deletedAt = freezed,Object? threadId = freezed,}) {
...
class EvolutionSessionEntity implements AgentDomainEntity {
  const EvolutionSessionEntity({required this.id, required this.agentId, required this.templateId, required this.sessionNumber, required this.status, required this.createdAt, required this.updatedAt, required this.vectorClock, this.proposedVersionId, this.feedbackSummary, this.userRating, this.completedAt, this.deletedAt, final  String? $type}): $type = $type ?? 'evolutionSession';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,templateId,sessionNumber,status,createdAt,updatedAt,vectorClock,proposedVersionId,feedbackSummary,userRating,completedAt,deletedAt);
...
@override @useResult
$Res call({
 String id, String agentId, String templateId, int sessionNumber, EvolutionSessionStatus status, DateTime createdAt, DateTime updatedAt, VectorClock? vectorClock, String? proposedVersionId, String? feedbackSummary, double? userRating, DateTime? completedAt, DateTime? deletedAt
});
...
class ChangeDecisionEntity implements AgentDomainEntity {
  const ChangeDecisionEntity({required this.id, required this.agentId, required this.changeSetId, required this.itemIndex, required this.toolName, required this.verdict, required this.createdAt, required this.vectorClock, this.taskId, this.rejectionReason, this.humanSummary, final  Map<String, dynamic>? args, this.deletedAt, final  String? $type}): _args = args,$type = $type ?? 'changeDecision';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,changeSetId,itemIndex,toolName,verdict,createdAt,vectorClock,taskId,rejectionReason,humanSummary,const DeepCollectionEquality().hash(_args),deletedAt);
...
@override @useResult
$Res call({
 String id, String agentId, String changeSetId, int itemIndex, String toolName, ChangeDecisionVerdict verdict, DateTime createdAt, VectorClock? vectorClock, String? taskId, String? rejectionReason, String? humanSummary, Map<String, dynamic>? args, DateTime? deletedAt
});
...
as DateTime,vectorClock: freezed == vectorClock ? _self.vectorClock : vectorClock // ignore: cast_nullable_to_non_nullable
as VectorClock?,taskId: freezed == taskId ? _self.taskId : taskId // ignore: cast_nullable_to_non_nullable
...
class ProjectRecommendationEntity implements AgentDomainEntity {
  const ProjectRecommendationEntity({required this.id, required this.agentId, required this.projectId, required this.changeSetId, required this.decisionId, required this.title, required this.createdAt, required this.vectorClock, this.rationale, this.priority, this.deletedAt, final  String? $type}): $type = $type ?? 'projectRecommendation';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,projectId,changeSetId,decisionId,title,createdAt,vectorClock,rationale,priority,deletedAt);

@override
String toString() {
  return 'AgentDomainEntity.projectRecommendation(id: $id, agentId: $agentId, projectId: $projectId, changeSetId: $changeSetId, decisionId: $decisionId, title: $title, createdAt: $createdAt, vectorClock: $vectorClock, rationale: $rationale, priority: $priority, deletedAt: $deletedAt)';
}
...
@override @useResult
$Res call({
 String id, String agentId, String projectId, String changeSetId, String decisionId, String title, DateTime createdAt, VectorClock? vectorClock, String? rationale, String? priority, DateTime? deletedAt
});
...
/// Create a copy of AgentDomainEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? agentId = null,Object? projectId = null,Object? changeSetId = null,Object? decisionId = null,Object? title = null,Object? createdAt = null,Object? vectorClock = freezed,Object? rationale = freezed,Object? priority = freezed,Object? deletedAt = freezed,}) {
...
as String,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,vectorClock: freezed == vectorClock ? _self.vectorClock : vectorClock // ignore: cast_nullable_to_non_nullable
as VectorClock?,rationale: freezed == rationale ? _self.rationale : rationale // ignore: cast_nullable_to_non_nullable
