...
return goalProgress(_that.id,_that.agentId,_that.periodKey,_that.trackStatus,_that.attainment,_that.dataCoverage,_that.satisfied,_that.specVersionId,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.criterionResults,_that.paceFeasible,_that.shortTermAttainment,_that.deletedAt);case GoalNudgeEntity() when goalNudge != null:
...
return goalProgress(_that.id,_that.agentId,_that.periodKey,_that.trackStatus,_that.attainment,_that.dataCoverage,_that.satisfied,_that.specVersionId,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.criterionResults,_that.paceFeasible,_that.shortTermAttainment,_that.deletedAt);case GoalNudgeEntity():
...
class GoalProgressEntity implements AgentDomainEntity {
  const GoalProgressEntity({required this.id, required this.agentId, required this.periodKey, required this.trackStatus, required this.attainment, required this.dataCoverage, required this.satisfied, required this.specVersionId, required this.createdAt, required this.updatedAt, required this.vectorClock, final  List<GoalCriterionProgress> criterionResults = const <GoalCriterionProgress>[], this.paceFeasible, this.shortTermAttainment, this.deletedAt, final  String? $type}): _criterionResults = criterionResults,$type = $type ?? 'goalProgress';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,agentId,periodKey,trackStatus,attainment,dataCoverage,satisfied,specVersionId,createdAt,updatedAt,vectorClock,const DeepCollectionEquality().hash(_criterionResults),paceFeasible,shortTermAttainment,deletedAt);

@override
String toString() {
  return 'AgentDomainEntity.goalProgress(id: $id, agentId: $agentId, periodKey: $periodKey, trackStatus: $trackStatus, attainment: $attainment, dataCoverage: $dataCoverage, satisfied: $satisfied, specVersionId: $specVersionId, createdAt: $createdAt, updatedAt: $updatedAt, vectorClock: $vectorClock, criterionResults: $criterionResults, paceFeasible: $paceFeasible, shortTermAttainment: $shortTermAttainment, deletedAt: $deletedAt)';
}
...
@override @useResult
$Res call({
 String id, String agentId, String periodKey, GoalTrackStatus trackStatus, double attainment, double dataCoverage, bool satisfied, String specVersionId, DateTime createdAt, DateTime updatedAt, VectorClock? vectorClock, List<GoalCriterionProgress> criterionResults, bool? paceFeasible, double? shortTermAttainment, DateTime? deletedAt
});
