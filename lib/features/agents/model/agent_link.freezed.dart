...
return improverTarget(_that);case _:
  return orElse();
...
return improverTarget(_that.id,_that.fromId,_that.toId,_that.createdAt,_that.updatedAt,_that.vectorClock,_that.deletedAt);case _:
  return orElse();
