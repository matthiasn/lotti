...
const taskPlanningTools = <AgentToolDefinition>[
  ...
  AgentToolDefinition(
    ...
    description:
        ...
        'A new investigation or checklist follow-up alone does not require '
        'planner time soon: without evidence of timing urgency or an explicit '
        'reservation request, leave that work on the task. Never invent a deadline '
        'or time window to justify planner attention. '
