...
///
/// Watches [templateWakeRunTimeSeriesProvider] and renders:
/// - Success rate sparkline
/// - Wake history bar chart
/// - Version performance line chart
...
class EvolutionChartsSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return timeSeriesAsync.when(
      data: (timeSeries) => _buildCharts(context, timeSeries),
      loading: SizedBox.shrink,
      error: (_, __) => const SizedBox.shrink(),
    );
  }

  Widget _buildCharts(BuildContext context, WakeRunTimeSeries timeSeries) {
            ...
            children: [
              ...
              Expanded(
                child: _MiniChartCard(
                  ...
                  child: EvolutionMttrChart(buckets: daily),
                ),
              ),
            ],
          ),
