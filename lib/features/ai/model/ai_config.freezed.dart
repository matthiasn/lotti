...
return model(_that.id,_that.name,_that.providerModelId,_that.inferenceProviderId,_that.createdAt,_that.inputModalities,_that.outputModalities,_that.isReasoningModel,_that.supportsFunctionCalling,_that.geminiThinkingMode,_that.updatedAt,_that.description,_that.maxCompletionTokens);case AiConfigPrompt() when prompt != null:
...
return inferenceProfile(_that.id,_that.name,_that.createdAt,_that.thinkingModelId,_that.thinkingHighEndModelId,_that.imageRecognitionModelId,_that.transcriptionModelId,_that.imageGenerationModelId,_that.isDefault,_that.desktopOnly,_that.skillAssignments,_that.pinnedHostId,_that.updatedAt,_that.description);case AiConfigSkill() when skill != null:
...
return model(_that.id,_that.name,_that.providerModelId,_that.inferenceProviderId,_that.createdAt,_that.inputModalities,_that.outputModalities,_that.isReasoningModel,_that.supportsFunctionCalling,_that.geminiThinkingMode,_that.updatedAt,_that.description,_that.maxCompletionTokens);case AiConfigPrompt():
...
class AiConfigModel implements AiConfig {
  const AiConfigModel({required this.id, required this.name, required this.providerModelId, required this.inferenceProviderId, required this.createdAt, required final  List<Modality> inputModalities, required final  List<Modality> outputModalities, required this.isReasoningModel, this.supportsFunctionCalling = false, this.geminiThinkingMode = GeminiThinkingMode.low, this.updatedAt, this.description, this.maxCompletionTokens, final  String? $type}): _inputModalities = inputModalities,_outputModalities = outputModalities,$type = $type ?? 'model';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,providerModelId,inferenceProviderId,createdAt,const DeepCollectionEquality().hash(_inputModalities),const DeepCollectionEquality().hash(_outputModalities),isReasoningModel,supportsFunctionCalling,geminiThinkingMode,updatedAt,description,maxCompletionTokens);
...
/// Create a copy of AiConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? providerModelId = null,Object? inferenceProviderId = null,Object? createdAt = null,Object? inputModalities = null,Object? outputModalities = null,Object? isReasoningModel = null,Object? supportsFunctionCalling = null,Object? geminiThinkingMode = null,Object? updatedAt = freezed,Object? description = freezed,Object? maxCompletionTokens = freezed,}) {
...
as bool,supportsFunctionCalling: null == supportsFunctionCalling ? _self.supportsFunctionCalling : supportsFunctionCalling // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,createdAt,thinkingModelId,thinkingHighEndModelId,imageRecognitionModelId,transcriptionModelId,imageGenerationModelId,isDefault,desktopOnly,const DeepCollectionEquality().hash(_skillAssignments),pinnedHostId,updatedAt,description);
...
/// Create a copy of AiConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? createdAt = null,Object? thinkingModelId = null,Object? thinkingHighEndModelId = freezed,Object? imageRecognitionModelId = freezed,Object? transcriptionModelId = freezed,Object? imageGenerationModelId = freezed,Object? isDefault = null,Object? desktopOnly = null,Object? skillAssignments = null,Object? pinnedHostId = freezed,Object? updatedAt = freezed,Object? description = freezed,}) {
