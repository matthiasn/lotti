...
return inferenceProfile(_that.id,_that.name,_that.createdAt,_that.thinkingModelId,_that.thinkingHighEndModelId,_that.imageRecognitionModelId,_that.transcriptionModelId,_that.imageGenerationModelId,_that.isDefault,_that.desktopOnly,_that.skillAssignments,_that.updatedAt,_that.description);case AiConfigSkill() when skill != null:
...
class AiConfigModel implements AiConfig {
  const AiConfigModel({required this.id, required this.name, required this.providerModelId, required this.inferenceProviderId, required this.createdAt, required final  List<Modality> inputModalities, required final  List<Modality> outputModalities, required this.isReasoningModel, this.supportsFunctionCalling = false, this.updatedAt, this.description, this.maxCompletionTokens, final  String? $type}): _inputModalities = inputModalities,_outputModalities = outputModalities,$type = $type ?? 'model';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,providerModelId,inferenceProviderId,createdAt,const DeepCollectionEquality().hash(_inputModalities),const DeepCollectionEquality().hash(_outputModalities),isReasoningModel,supportsFunctionCalling,updatedAt,description,maxCompletionTokens);
...
@override @useResult
$Res call({
 String id, String name, String providerModelId, String inferenceProviderId, DateTime createdAt, List<Modality> inputModalities, List<Modality> outputModalities, bool isReasoningModel, bool supportsFunctionCalling, DateTime? updatedAt, String? description, int? maxCompletionTokens
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,createdAt,thinkingModelId,thinkingHighEndModelId,imageRecognitionModelId,transcriptionModelId,imageGenerationModelId,isDefault,desktopOnly,const DeepCollectionEquality().hash(_skillAssignments),updatedAt,description);
...
@override @useResult
$Res call({
 String id, String name, DateTime createdAt, String thinkingModelId, String? thinkingHighEndModelId, String? imageRecognitionModelId, String? transcriptionModelId, String? imageGenerationModelId, bool isDefault, bool desktopOnly, List<SkillAssignment> skillAssignments, DateTime? updatedAt, String? description
});
...
/// Create a copy of AiConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? createdAt = null,Object? thinkingModelId = null,Object? thinkingHighEndModelId = freezed,Object? imageRecognitionModelId = freezed,Object? transcriptionModelId = freezed,Object? imageGenerationModelId = freezed,Object? isDefault = null,Object? desktopOnly = null,Object? skillAssignments = null,Object? updatedAt = freezed,Object? description = freezed,}) {
