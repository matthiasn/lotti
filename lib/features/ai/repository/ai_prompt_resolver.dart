...
/// (it needs only [ref]): filters non-archived, non-legacy prompts by their
/// required input-data modalities and the entity's task linkage, then applies
/// the platform capability filter.
class AiPromptResolver {
  AiPromptResolver({required this.ref});
