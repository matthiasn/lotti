...
mixin _$ChatSession {
 ...
 String get id; String get title; DateTime get createdAt; DateTime get lastMessageAt; List<ChatMessage> get messages; String? get categoryId; Map<String, dynamic>? get metadata;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatSession&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.lastMessageAt, lastMessageAt) || other.lastMessageAt == lastMessageAt)&&const DeepCollectionEquality().equals(other.messages, messages)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&const DeepCollectionEquality().equals(other.metadata, metadata));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,createdAt,lastMessageAt,const DeepCollectionEquality().hash(messages),categoryId,const DeepCollectionEquality().hash(metadata));

@override
String toString() {
  return 'ChatSession(id: $id, title: $title, createdAt: $createdAt, lastMessageAt: $lastMessageAt, messages: $messages, categoryId: $categoryId, metadata: $metadata)';
}
...
@useResult
$Res call({
 String id, String title, DateTime createdAt, DateTime lastMessageAt, List<ChatMessage> messages, String? categoryId, Map<String, dynamic>? metadata
});
...
/// Create a copy of ChatSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? createdAt = null,Object? lastMessageAt = null,Object? messages = null,Object? categoryId = freezed,Object? metadata = freezed,}) {
...
as List<ChatMessage>,categoryId: freezed == categoryId ? _self.categoryId : categoryId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  DateTime createdAt,  DateTime lastMessageAt,  List<ChatMessage> messages,  String? categoryId,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatSession() when $default != null:
return $default(_that.id,_that.title,_that.createdAt,_that.lastMessageAt,_that.messages,_that.categoryId,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  DateTime createdAt,  DateTime lastMessageAt,  List<ChatMessage> messages,  String? categoryId,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _ChatSession():
return $default(_that.id,_that.title,_that.createdAt,_that.lastMessageAt,_that.messages,_that.categoryId,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  DateTime createdAt,  DateTime lastMessageAt,  List<ChatMessage> messages,  String? categoryId,  Map<String, dynamic>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _ChatSession() when $default != null:
return $default(_that.id,_that.title,_that.createdAt,_that.lastMessageAt,_that.messages,_that.categoryId,_that.metadata);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatSession&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.lastMessageAt, lastMessageAt) || other.lastMessageAt == lastMessageAt)&&const DeepCollectionEquality().equals(other._messages, _messages)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&const DeepCollectionEquality().equals(other._metadata, _metadata));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,createdAt,lastMessageAt,const DeepCollectionEquality().hash(_messages),categoryId,const DeepCollectionEquality().hash(_metadata));
...
/// Create a copy of ChatSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? createdAt = null,Object? lastMessageAt = null,Object? messages = null,Object? categoryId = freezed,Object? metadata = freezed,}) {
