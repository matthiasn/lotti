...
/// legacy events captured before attribution was introduced.
 String? get attributionId;/// Stable order of this interaction inside its logical work operation.
 int get sequenceIndex;/// Backend operation and terminal outcome. Legacy rows may not identify
/// the operation more precisely than [responseType].
 ...
 DateTime? get completedAt;/// Provider request id used for reconciliation when the backend exposes
/// one. It must never contain credentials.
 ...
 String? get errorCode; String? get errorSummary;/// Reference-only sync-safe interaction evidence and cost assessment.
 AiInteractionPayload? get payload; AiInteractionCost? get cost;/// Durable publication-saga evidence written before an output is allowed
/// into the journal/agent sync path.
 AiAttributionRecoveryCapsule? get recoveryCapsule;/// The causal parent call/context ("the call that made it"). For agent
...
@useResult
$Res call({
 String id, DateTime createdAt, InferenceProviderType providerType, AiConsumptionResponseType responseType, VectorClock? vectorClock, String? attributionId, int sequenceIndex, AiInteractionKind? interactionKind, AiInteractionStatus interactionStatus, DateTime? completedAt, String? providerRequestId, String? errorCode, String? errorSummary, AiInteractionPayload? payload, AiInteractionCost? cost, AiAttributionRecoveryCapsule? recoveryCapsule, String? parentId, String? taskId, String? categoryId, String? entryId, String? agentId, String? wakeRunKey, String? threadId, int? turnIndex, String? promptId, String? skillId, String? configId, String? modelId, String? providerModelId, int? durationMs, int? inputTokens, int? outputTokens, int? cachedInputTokens, int? thoughtsTokens, int? totalTokens, double? credits, double? energyKwh, double? carbonGCo2, double? waterLiters, double? renewablePercent, double? pue, String? dataCenter, String? upstreamProviderId
});


$AiInteractionPayloadCopyWith<$Res>? get payload;$AiInteractionCostCopyWith<$Res>? get cost;$AiAttributionRecoveryCapsuleCopyWith<$Res>? get recoveryCapsule;
...
as int,interactionKind: freezed == interactionKind ? _self.interactionKind : interactionKind // ignore: cast_nullable_to_non_nullable
...
as AiInteractionPayload?,cost: freezed == cost ? _self.cost : cost // ignore: cast_nullable_to_non_nullable
as AiInteractionCost?,recoveryCapsule: freezed == recoveryCapsule ? _self.recoveryCapsule : recoveryCapsule // ignore: cast_nullable_to_non_nullable
as AiAttributionRecoveryCapsule?,parentId: freezed == parentId ? _self.parentId : parentId // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$AiInteractionPayloadCopyWith<$Res>? get payload {
    if (_self.payload == null) {
    return null;
  }

  return $AiInteractionPayloadCopyWith<$Res>(_self.payload!, (value) {
...
@override
@pragma('vm:prefer-inline')
$AiInteractionCostCopyWith<$Res>? get cost {
    if (_self.cost == null) {
    return null;
  }

  return $AiInteractionCostCopyWith<$Res>(_self.cost!, (value) {
...
@override
@pragma('vm:prefer-inline')
$AiAttributionRecoveryCapsuleCopyWith<$Res>? get recoveryCapsule {
    if (_self.recoveryCapsule == null) {
    return null;
  }

  return $AiAttributionRecoveryCapsuleCopyWith<$Res>(_self.recoveryCapsule!, (value) {
    return _then(_self.copyWith(recoveryCapsule: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  InferenceProviderType providerType,  AiConsumptionResponseType responseType,  VectorClock? vectorClock,  String? attributionId,  int sequenceIndex,  AiInteractionKind? interactionKind,  AiInteractionStatus interactionStatus,  DateTime? completedAt,  String? providerRequestId,  String? errorCode,  String? errorSummary,  AiInteractionPayload? payload,  AiInteractionCost? cost,  AiAttributionRecoveryCapsule? recoveryCapsule,  String? parentId,  String? taskId,  String? categoryId,  String? entryId,  String? agentId,  String? wakeRunKey,  String? threadId,  int? turnIndex,  String? promptId,  String? skillId,  String? configId,  String? modelId,  String? providerModelId,  int? durationMs,  int? inputTokens,  int? outputTokens,  int? cachedInputTokens,  int? thoughtsTokens,  int? totalTokens,  double? credits,  double? energyKwh,  double? carbonGCo2,  double? waterLiters,  double? renewablePercent,  double? pue,  String? dataCenter,  String? upstreamProviderId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiConsumptionEvent() when $default != null:
return $default(_that.id,_that.createdAt,_that.providerType,_that.responseType,_that.vectorClock,_that.attributionId,_that.sequenceIndex,_that.interactionKind,_that.interactionStatus,_that.completedAt,_that.providerRequestId,_that.errorCode,_that.errorSummary,_that.payload,_that.cost,_that.recoveryCapsule,_that.parentId,_that.taskId,_that.categoryId,_that.entryId,_that.agentId,_that.wakeRunKey,_that.threadId,_that.turnIndex,_that.promptId,_that.skillId,_that.configId,_that.modelId,_that.providerModelId,_that.durationMs,_that.inputTokens,_that.outputTokens,_that.cachedInputTokens,_that.thoughtsTokens,_that.totalTokens,_that.credits,_that.energyKwh,_that.carbonGCo2,_that.waterLiters,_that.renewablePercent,_that.pue,_that.dataCenter,_that.upstreamProviderId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  InferenceProviderType providerType,  AiConsumptionResponseType responseType,  VectorClock? vectorClock,  String? attributionId,  int sequenceIndex,  AiInteractionKind? interactionKind,  AiInteractionStatus interactionStatus,  DateTime? completedAt,  String? providerRequestId,  String? errorCode,  String? errorSummary,  AiInteractionPayload? payload,  AiInteractionCost? cost,  AiAttributionRecoveryCapsule? recoveryCapsule,  String? parentId,  String? taskId,  String? categoryId,  String? entryId,  String? agentId,  String? wakeRunKey,  String? threadId,  int? turnIndex,  String? promptId,  String? skillId,  String? configId,  String? modelId,  String? providerModelId,  int? durationMs,  int? inputTokens,  int? outputTokens,  int? cachedInputTokens,  int? thoughtsTokens,  int? totalTokens,  double? credits,  double? energyKwh,  double? carbonGCo2,  double? waterLiters,  double? renewablePercent,  double? pue,  String? dataCenter,  String? upstreamProviderId)  $default,) {final _that = this;
switch (_that) {
case _AiConsumptionEvent():
return $default(_that.id,_that.createdAt,_that.providerType,_that.responseType,_that.vectorClock,_that.attributionId,_that.sequenceIndex,_that.interactionKind,_that.interactionStatus,_that.completedAt,_that.providerRequestId,_that.errorCode,_that.errorSummary,_that.payload,_that.cost,_that.recoveryCapsule,_that.parentId,_that.taskId,_that.categoryId,_that.entryId,_that.agentId,_that.wakeRunKey,_that.threadId,_that.turnIndex,_that.promptId,_that.skillId,_that.configId,_that.modelId,_that.providerModelId,_that.durationMs,_that.inputTokens,_that.outputTokens,_that.cachedInputTokens,_that.thoughtsTokens,_that.totalTokens,_that.credits,_that.energyKwh,_that.carbonGCo2,_that.waterLiters,_that.renewablePercent,_that.pue,_that.dataCenter,_that.upstreamProviderId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime createdAt,  InferenceProviderType providerType,  AiConsumptionResponseType responseType,  VectorClock? vectorClock,  String? attributionId,  int sequenceIndex,  AiInteractionKind? interactionKind,  AiInteractionStatus interactionStatus,  DateTime? completedAt,  String? providerRequestId,  String? errorCode,  String? errorSummary,  AiInteractionPayload? payload,  AiInteractionCost? cost,  AiAttributionRecoveryCapsule? recoveryCapsule,  String? parentId,  String? taskId,  String? categoryId,  String? entryId,  String? agentId,  String? wakeRunKey,  String? threadId,  int? turnIndex,  String? promptId,  String? skillId,  String? configId,  String? modelId,  String? providerModelId,  int? durationMs,  int? inputTokens,  int? outputTokens,  int? cachedInputTokens,  int? thoughtsTokens,  int? totalTokens,  double? credits,  double? energyKwh,  double? carbonGCo2,  double? waterLiters,  double? renewablePercent,  double? pue,  String? dataCenter,  String? upstreamProviderId)?  $default,) {final _that = this;
switch (_that) {
case _AiConsumptionEvent() when $default != null:
return $default(_that.id,_that.createdAt,_that.providerType,_that.responseType,_that.vectorClock,_that.attributionId,_that.sequenceIndex,_that.interactionKind,_that.interactionStatus,_that.completedAt,_that.providerRequestId,_that.errorCode,_that.errorSummary,_that.payload,_that.cost,_that.recoveryCapsule,_that.parentId,_that.taskId,_that.categoryId,_that.entryId,_that.agentId,_that.wakeRunKey,_that.threadId,_that.turnIndex,_that.promptId,_that.skillId,_that.configId,_that.modelId,_that.providerModelId,_that.durationMs,_that.inputTokens,_that.outputTokens,_that.cachedInputTokens,_that.thoughtsTokens,_that.totalTokens,_that.credits,_that.energyKwh,_that.carbonGCo2,_that.waterLiters,_that.renewablePercent,_that.pue,_that.dataCenter,_that.upstreamProviderId);case _:
  return null;
...
class _AiConsumptionEvent implements AiConsumptionEvent {
  const _AiConsumptionEvent({required this.id, required this.createdAt, required this.providerType, required this.responseType, required this.vectorClock, this.attributionId, this.sequenceIndex = 0, this.interactionKind, this.interactionStatus = AiInteractionStatus.succeeded, this.completedAt, this.providerRequestId, this.errorCode, this.errorSummary, this.payload, this.cost, this.recoveryCapsule, this.parentId, this.taskId, this.categoryId, this.entryId, this.agentId, this.wakeRunKey, this.threadId, this.turnIndex, this.promptId, this.skillId, this.configId, this.modelId, this.providerModelId, this.durationMs, this.inputTokens, this.outputTokens, this.cachedInputTokens, this.thoughtsTokens, this.totalTokens, this.credits, this.energyKwh, this.carbonGCo2, this.waterLiters, this.renewablePercent, this.pue, this.dataCenter, this.upstreamProviderId});
...
@override@JsonKey() final  int sequenceIndex;
...
@override final  AiInteractionPayload? payload;
@override final  AiInteractionCost? cost;
/// Durable publication-saga evidence written before an output is allowed
/// into the journal/agent sync path.
@override final  AiAttributionRecoveryCapsule? recoveryCapsule;
...
@override $AiInteractionPayloadCopyWith<$Res>? get payload;@override $AiInteractionCostCopyWith<$Res>? get cost;@override $AiAttributionRecoveryCapsuleCopyWith<$Res>? get recoveryCapsule;
