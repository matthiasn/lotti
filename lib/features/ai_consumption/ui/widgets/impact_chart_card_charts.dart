...
import 'package:lotti/features/insights/logic/chart_colors.dart' show bandEdgeColor;
import 'package:lotti/features/insights/logic/time_bucketing.dart' show epochDay;
                      ...
                      for (var s = 0; s < data.seriesKeys.length; s++) {
                        ...
                        stack.add(
                          BarChartRodStackItem(
                            from,
                            from + value,
                            resolver.fillColor(data.seriesKeys[s], brightness),
      ...
      LineChartData(
        ...
        lineBarsData: [
          for (var s = data.seriesKeys.length - 1; s >= 0; s--)
            () {
              final fill = resolver.fillColor(data.seriesKeys[s], brightness);
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: resolver.swatchColor(key, brightness),
                ),
              ),
