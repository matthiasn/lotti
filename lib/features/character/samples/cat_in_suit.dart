...
class CatClips {
  ...
  static const _danceTorsoKeys = [
    ...
    Keyframe(p: 15 / 16, rotation: -0.06, scaleY: 0.99, scaleX: 1.004),
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -10.4, dy: 5.6, rotation: -0.0048),
        RootKeyframe(p: 1 / 32, dx: -10.8, dy: 4.6, rotation: -0.005),
        RootKeyframe(p: 1 / 16, dx: -5.8, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 3 / 32, dx: 0.4, dy: 2.7),
        RootKeyframe(p: 1 / 8, dx: 10.4, dy: 5.6, rotation: 0.0048),
        RootKeyframe(p: 5 / 32, dx: 10.8, dy: 4.6, rotation: 0.005),
        RootKeyframe(p: 3 / 16, dx: 5.8, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 7 / 32, dx: 0.1, dy: 2.7),
        RootKeyframe(p: 1 / 4, dx: -10, dy: 5.5, rotation: -0.0045),
        RootKeyframe(p: 9 / 32, dx: -10.4, dy: 4.5, rotation: -0.0048),
        RootKeyframe(p: 5 / 16, dx: -5.2, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 11 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 3 / 8, dx: 10, dy: 5.5, rotation: 0.0045),
        RootKeyframe(p: 13 / 32, dx: 10.4, dy: 4.5, rotation: 0.0048),
        RootKeyframe(p: 7 / 16, dx: 5.2, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 15 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 1 / 2, dx: -10.8, dy: 5.7, rotation: -0.0048),
        RootKeyframe(p: 17 / 32, dx: -11.2, dy: 4.7, rotation: -0.005),
        RootKeyframe(p: 9 / 16, dx: -6, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 19 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 5 / 8, dx: 10.8, dy: 5.7, rotation: 0.0048),
        RootKeyframe(p: 21 / 32, dx: 11.2, dy: 4.7, rotation: 0.005),
        RootKeyframe(p: 11 / 16, dx: 6, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 23 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 3 / 4, dx: -10.4, dy: 5.6, rotation: -0.0045),
        RootKeyframe(p: 25 / 32, dx: -10, dy: 4.6, rotation: -0.0046),
        RootKeyframe(p: 13 / 16, dx: -5.2, dy: 0.9, rotation: -0.002),
        RootKeyframe(p: 27 / 32, dx: 0.4, dy: 2.8),
        RootKeyframe(p: 7 / 8, dx: 8.6, dy: 5.4, rotation: 0.004),
        RootKeyframe(p: 29 / 32, dx: 0.2, dy: 4.1, rotation: -0.0008),
        RootKeyframe(p: 15 / 16, dx: -5.8, dy: 1.2, rotation: -0.0025),
        RootKeyframe(p: 31 / 32, dx: -9.8, dy: 4.2, rotation: -0.0042),
        RootKeyframe(p: 1, dx: -10.4, dy: 5.6, rotation: -0.0048),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.08,
        bobPhase: 0.125,
