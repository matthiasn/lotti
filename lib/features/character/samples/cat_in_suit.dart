  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        ...
        RootKeyframe(p: 13 / 16, dx: 8, dy: 13.2, rotation: 0.008),
        RootKeyframe(p: 7 / 8, dx: 4, dy: 14.8, rotation: 0.006),
        RootKeyframe(p: 29 / 32, dx: -2, dy: 15.2, rotation: 0.001),
        RootKeyframe(p: 15 / 16, dx: -8, dy: 16, rotation: -0.003),
        RootKeyframe(p: 31 / 32, dx: -13, dy: 16.2, rotation: -0.006),
