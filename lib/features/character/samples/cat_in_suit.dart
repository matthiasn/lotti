  ...
  static const _danceLeadMoveSignatures = [
    ...
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        ...
        CatBones.footL: [
          DanceIkTargetKey(18, x: -48.4, y: 101.2),
          DanceIkTargetKey(19, x: -65.6, y: 97.8),
          DanceIkTargetKey(20, x: -72.6, y: 97.4),
          DanceIkTargetKey(21, x: -64.2, y: 100.3),
          DanceIkTargetKey(22, x: -43.6, y: 103.2),
    ...
    moveTargetOffsetArcs: [
      ...
      DanceMoveTargetOffsetArc(
        ...
        controlPoints: [
          ...
          DanceMoveTargetOffsetArcPoint(3, x: -0.4, y: 0, weight: 0.7),
        ],
      ),
      DanceMoveTargetOffsetArc(
