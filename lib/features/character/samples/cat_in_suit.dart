...
class CatClips {
  ...
  static final _danceFootLTarget = _dancePhrase.ikTargetChannel(
    const [
  ...
  static final _danceFootRTarget = _dancePhrase.ikTargetChannel(
    const [
  ...
  static final _danceHandLTarget = _dancePhrase.ikTargetChannel(
    const [
  ...
  static final _danceHandRTarget = _dancePhrase.ikTargetChannel(
    const [
      ...
      DanceIkTargetKey(15, x: 74, y: 23.6),
      DanceIkTargetKey(16, x: 94.6, y: 10.1),
      DanceIkTargetKey(17, x: 87.6, y: 15.5),
