...
class CatClips {
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.075, scaleY: 0.91, scaleX: 1.056),
    Keyframe(p: 1 / 16, rotation: -0.04, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 1 / 8, rotation: -0.038, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 3 / 16, rotation: 0.045, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 7 / 32, rotation: 0.06, scaleY: 0.955, scaleX: 1.025),
    Keyframe(p: 1 / 4, rotation: 0.08, scaleY: 0.91, scaleX: 1.056),
    Keyframe(p: 5 / 16, rotation: 0.036, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 3 / 8, rotation: 0.042, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 7 / 16, rotation: -0.042, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 15 / 32, rotation: -0.055, scaleY: 0.955, scaleX: 1.025),
    Keyframe(p: 1 / 2, rotation: 0.082, scaleY: 0.908, scaleX: 1.058),
    Keyframe(p: 9 / 16, rotation: 0.04, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 5 / 8, rotation: 0.046, scaleY: 0.925, scaleX: 1.044),
    Keyframe(p: 11 / 16, rotation: -0.042, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 23 / 32, rotation: -0.052, scaleY: 0.96, scaleX: 1.021),
    Keyframe(p: 3 / 4, rotation: -0.08, scaleY: 0.905, scaleX: 1.06),
    Keyframe(p: 13 / 16, rotation: -0.04, scaleY: 1.012, scaleX: 0.988),
    Keyframe(p: 7 / 8, rotation: -0.042, scaleY: 0.93, scaleX: 1.04),
    Keyframe(p: 15 / 16, rotation: -0.07, scaleY: 0.94, scaleX: 1.038),
    Keyframe(p: 31 / 32, rotation: -0.074, scaleY: 0.922, scaleX: 1.048),
    Keyframe(p: 1, rotation: -0.075, scaleY: 0.91, scaleX: 1.056),
  ];
  ...
  static const _danceArmUpperLKeys = [
    ...
    Keyframe(p: 1 / 16, rotation: 0.48),
    Keyframe(p: 1 / 8, rotation: 0.34),
    Keyframe(p: 3 / 16, rotation: 0.5),
    Keyframe(p: 7 / 32, rotation: 1.34),
    Keyframe(p: 1 / 4, rotation: 1.54),
    Keyframe(p: 5 / 16, rotation: 1.26),
    Keyframe(p: 3 / 8, rotation: 0.84),
    Keyframe(p: 7 / 16, rotation: 1.06),
  ...
  static const _danceArmUpperRKeys = [
    ...
    Keyframe(p: 3 / 8, rotation: -1.36),
    Keyframe(p: 7 / 16, rotation: -1.02),
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        ...
        RootKeyframe(p: 7 / 32, dx: 0.1, dy: 4.9),
        RootKeyframe(p: 1 / 4, dx: -10, dy: 6.7, rotation: -0.0045),
        ...
        RootKeyframe(p: 15 / 32, dx: 0.3, dy: 5),
        RootKeyframe(p: 1 / 2, dx: -10.8, dy: 6.8, rotation: -0.0048),
        ...
        RootKeyframe(p: 5 / 8, dx: 10.8, dy: 6.8, rotation: 0.0048),
        RootKeyframe(p: 21 / 32, dx: 11.2, dy: 5.4, rotation: 0.005),
        RootKeyframe(p: 11 / 16, dx: 6, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 23 / 32, dx: 0.5, dy: 5.4),
        RootKeyframe(p: 3 / 4, dx: -10.4, dy: 7, rotation: -0.0045),
        ...
        RootKeyframe(p: 1, dx: -10.4, dy: 6.8, rotation: -0.0048),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.08,
        bobPhase: 0.125,
