...
class CatClips {
  ...
  static const _danceHipKeys = [
    ...
    Keyframe(p: 15 / 16, rotation: 0.17),
    Keyframe(p: 1, rotation: 0.2),
  ];
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.092, scaleY: 0.925, scaleX: 1.044),
    Keyframe(p: 1 / 16, rotation: -0.025, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 1 / 8, rotation: -0.048, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 3 / 16, rotation: 0.032, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 1 / 4, rotation: 0.095, scaleY: 0.925, scaleX: 1.044),
    Keyframe(p: 5 / 16, rotation: 0.018, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 3 / 8, rotation: 0.052, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 7 / 16, rotation: -0.028, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 1 / 2, rotation: 0.102, scaleY: 0.923, scaleX: 1.046),
    Keyframe(p: 9 / 16, rotation: 0.022, scaleY: 1.014, scaleX: 0.986),
    Keyframe(p: 5 / 8, rotation: 0.058, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 11 / 16, rotation: -0.028, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 3 / 4, rotation: -0.098, scaleY: 0.923, scaleX: 1.046),
    Keyframe(p: 13 / 16, rotation: -0.026, scaleY: 1.012, scaleX: 0.988),
    Keyframe(p: 7 / 8, rotation: -0.052, scaleY: 0.93, scaleX: 1.04),
    Keyframe(p: 15 / 16, rotation: -0.078, scaleY: 0.946, scaleX: 1.032),
    Keyframe(p: 31 / 32, rotation: -0.072, scaleY: 0.966, scaleX: 1.018),
    Keyframe(p: 1, rotation: -0.092, scaleY: 0.925, scaleX: 1.044),
  ];
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -10.4, dy: 6.4, rotation: -0.0048),
        RootKeyframe(p: 1 / 32, dx: -10.8, dy: 5.1, rotation: -0.005),
        RootKeyframe(p: 1 / 16, dx: -5.8, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 3 / 32, dx: 0.4, dy: 2.7),
        RootKeyframe(p: 1 / 8, dx: 10.4, dy: 6.4, rotation: 0.0048),
        RootKeyframe(p: 5 / 32, dx: 10.8, dy: 5.1, rotation: 0.005),
        RootKeyframe(p: 3 / 16, dx: 5.8, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 7 / 32, dx: 0.1, dy: 2.7),
        RootKeyframe(p: 1 / 4, dx: -10, dy: 6.3, rotation: -0.0045),
        RootKeyframe(p: 9 / 32, dx: -10.4, dy: 5, rotation: -0.0048),
        RootKeyframe(p: 5 / 16, dx: -5.2, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 11 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 3 / 8, dx: 10, dy: 6.3, rotation: 0.0045),
        RootKeyframe(p: 13 / 32, dx: 10.4, dy: 5, rotation: 0.0048),
        RootKeyframe(p: 7 / 16, dx: 5.2, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 15 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 1 / 2, dx: -10.8, dy: 6.5, rotation: -0.0048),
        RootKeyframe(p: 17 / 32, dx: -11.2, dy: 5.2, rotation: -0.005),
        RootKeyframe(p: 9 / 16, dx: -6, dy: 0.8, rotation: -0.002),
        RootKeyframe(p: 19 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 5 / 8, dx: 10.8, dy: 6.5, rotation: 0.0048),
        RootKeyframe(p: 21 / 32, dx: 11.2, dy: 5.2, rotation: 0.005),
        RootKeyframe(p: 11 / 16, dx: 6, dy: 0.8, rotation: 0.002),
        RootKeyframe(p: 23 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 3 / 4, dx: -10.4, dy: 6.4, rotation: -0.0045),
        RootKeyframe(p: 25 / 32, dx: -10, dy: 5.1, rotation: -0.0046),
        RootKeyframe(p: 13 / 16, dx: -5.2, dy: 0.9, rotation: -0.002),
        RootKeyframe(p: 27 / 32, dx: 0.4, dy: 2.8),
        RootKeyframe(p: 7 / 8, dx: 8.6, dy: 6.2, rotation: 0.004),
        RootKeyframe(p: 29 / 32, dx: -4.8, dy: 3, rotation: -0.0015),
        RootKeyframe(p: 15 / 16, dx: -10, dy: 6.1, rotation: -0.0043),
        RootKeyframe(p: 31 / 32, dx: -10.8, dy: 5.2, rotation: -0.0048),
        RootKeyframe(p: 1, dx: -10.4, dy: 6.4, rotation: -0.0048),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.08,
        bobPhase: 0.125,
