...
class CatClips {
  ...
  static const _danceFootRKeys = [
    ...
    Keyframe(p: 1 / 2, rotation: 0.14),
    Keyframe(p: 9 / 16, rotation: 0.22),
    Keyframe(p: 5 / 8, rotation: -0.08),
    Keyframe(p: 11 / 16, rotation: -0.1),
    Keyframe(p: 3 / 4, rotation: 0.16),
    Keyframe(p: 13 / 16, rotation: 0.24),
  ...
  static const _danceBackupRightArmUpperLKeys = [
    ...
    Keyframe(p: 15 / 16, rotation: 1.12),
  ...
  static const _danceBackupRightArmUpperRKeys = [
    ...
    Keyframe(p: 15 / 16, rotation: -0.98),
  ...
  static const _danceBackupRightArmLowerRKeys = [
    ...
    Keyframe(p: 15 / 16, rotation: 0.28),
    Keyframe(p: 1, rotation: 0.28),
  ];
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.075, scaleY: 0.93, scaleX: 1.04),
    Keyframe(p: 1 / 16, rotation: -0.04, scaleY: 1.012, scaleX: 0.988),
    Keyframe(p: 1 / 8, rotation: 0.035, scaleY: 0.932, scaleX: 1.038),
    Keyframe(p: 3 / 16, rotation: -0.018, scaleY: 1.008, scaleX: 0.992),
    Keyframe(p: 1 / 4, rotation: 0.078, scaleY: 0.93, scaleX: 1.04),
    Keyframe(p: 5 / 16, rotation: 0.032, scaleY: 1.012, scaleX: 0.988),
    Keyframe(p: 3 / 8, rotation: -0.036, scaleY: 0.932, scaleX: 1.038),
    Keyframe(p: 7 / 16, rotation: 0.018, scaleY: 1.008, scaleX: 0.992),
    Keyframe(p: 1 / 2, rotation: 0.082, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 9 / 16, rotation: 0.038, scaleY: 1.012, scaleX: 0.988),
    Keyframe(p: 5 / 8, rotation: -0.032, scaleY: 0.932, scaleX: 1.038),
    Keyframe(p: 11 / 16, rotation: 0.02, scaleY: 1.008, scaleX: 0.992),
    Keyframe(p: 3 / 4, rotation: -0.08, scaleY: 0.928, scaleX: 1.042),
    Keyframe(p: 13 / 16, rotation: -0.04, scaleY: 1.01, scaleX: 0.99),
    Keyframe(p: 7 / 8, rotation: 0.028, scaleY: 0.934, scaleX: 1.036),
    Keyframe(p: 15 / 16, rotation: -0.052, scaleY: 0.99, scaleX: 1.004),
    Keyframe(p: 1, rotation: -0.075, scaleY: 0.93, scaleX: 1.04),
  ];
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -8.2, dy: 5.2, rotation: -0.004),
        RootKeyframe(p: 1 / 32, dx: -8.8, dy: 4.2, rotation: -0.0045),
        RootKeyframe(p: 1 / 16, dx: -5.2, dy: 0.9, rotation: -0.002),
        RootKeyframe(p: 3 / 32, dx: 0.4, dy: 2.7),
        RootKeyframe(p: 1 / 8, dx: 8.2, dy: 5.2, rotation: 0.004),
        RootKeyframe(p: 5 / 32, dx: 8.8, dy: 4.2, rotation: 0.0045),
        RootKeyframe(p: 3 / 16, dx: 5.2, dy: 0.9, rotation: 0.002),
        RootKeyframe(p: 7 / 32, dx: 0.1, dy: 2.7),
        RootKeyframe(p: 1 / 4, dx: -7.4, dy: 5.1, rotation: -0.0038),
        RootKeyframe(p: 9 / 32, dx: -8.1, dy: 4.1, rotation: -0.0043),
        RootKeyframe(p: 5 / 16, dx: -4.4, dy: 0.9, rotation: -0.002),
        RootKeyframe(p: 11 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 3 / 8, dx: 7.4, dy: 5.1, rotation: 0.0038),
        RootKeyframe(p: 13 / 32, dx: 8, dy: 4.1, rotation: 0.0043),
        RootKeyframe(p: 7 / 16, dx: 4.3, dy: 0.9, rotation: 0.002),
        RootKeyframe(p: 15 / 32, dx: 0.3, dy: 2.7),
        RootKeyframe(p: 1 / 2, dx: -8.4, dy: 5.4, rotation: -0.004),
        RootKeyframe(p: 17 / 32, dx: -9, dy: 4.3, rotation: -0.0048),
        RootKeyframe(p: 9 / 16, dx: -5.4, dy: 0.9, rotation: -0.002),
        RootKeyframe(p: 19 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 5 / 8, dx: 8.4, dy: 5.4, rotation: 0.004),
        RootKeyframe(p: 21 / 32, dx: 9, dy: 4.3, rotation: 0.0048),
        RootKeyframe(p: 11 / 16, dx: 5.4, dy: 0.9, rotation: 0.002),
        RootKeyframe(p: 23 / 32, dx: 0.5, dy: 2.8),
        RootKeyframe(p: 3 / 4, dx: -7.6, dy: 5.3, rotation: -0.0038),
        RootKeyframe(p: 25 / 32, dx: -7.8, dy: 4.2, rotation: -0.0042),
        RootKeyframe(p: 13 / 16, dx: -3.8, dy: 1, rotation: -0.002),
        RootKeyframe(p: 27 / 32, dx: 0.4, dy: 2.8),
        RootKeyframe(p: 7 / 8, dx: 6.2, dy: 5.2, rotation: 0.003),
        RootKeyframe(p: 29 / 32, dx: 0.4, dy: 4, rotation: -0.0005),
        RootKeyframe(p: 15 / 16, dx: -4.8, dy: 1.4, rotation: -0.002),
        RootKeyframe(p: 31 / 32, dx: -7.2, dy: 3.8, rotation: -0.0035),
        RootKeyframe(p: 1, dx: -8.2, dy: 5.2, rotation: -0.004),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.08,
        bobPhase: 0.125,
