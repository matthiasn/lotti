...
class CatClips {
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.1, scaleY: 0.91, scaleX: 1.056),
    ...
    Keyframe(p: 1 / 4, rotation: 0.104, scaleY: 0.91, scaleX: 1.056),
    ...
    Keyframe(p: 1 / 2, rotation: 0.112, scaleY: 0.908, scaleX: 1.058),
    ...
    Keyframe(p: 15 / 16, rotation: -0.084, scaleY: 0.94, scaleX: 1.038),
    Keyframe(p: 31 / 32, rotation: -0.096, scaleY: 0.9, scaleX: 1.064),
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        ...
        RootKeyframe(p: 29 / 32, dx: 3.8, dy: 4.2, rotation: 0.001),
        RootKeyframe(p: 15 / 16, dx: -5.8, dy: 5.8, rotation: -0.003),
        RootKeyframe(p: 31 / 32, dx: -9.8, dy: 7.2, rotation: -0.0048),
        RootKeyframe(p: 1, dx: -10.4, dy: 6.6, rotation: -0.0048),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.08,
        bobPhase: 0.125,
