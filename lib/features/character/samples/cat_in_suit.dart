  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        ...
        RootKeyframe(p: 7 / 32, dx: 2, dy: 13.4, rotation: 0.002),
        RootKeyframe(p: 1 / 4, dx: -18, dy: 16.2, rotation: 0.007),
        ...
        RootKeyframe(p: 23 / 32, dx: -8, dy: 13.4, rotation: 0.002),
        RootKeyframe(p: 3 / 4, dx: -18, dy: 16.4, rotation: 0.007),
        RootKeyframe(p: 13 / 16, dx: 18, dy: 13.2, rotation: 0.008),
        RootKeyframe(p: 7 / 8, dx: 24, dy: 14.8, rotation: 0.006),
