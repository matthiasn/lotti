...
class CatClips {
  ...
  static const _danceHipKeys = [
    Keyframe(p: 0, rotation: 0.43),
    Keyframe(p: 1 / 16, rotation: 0.39),
    Keyframe(p: 1 / 8, rotation: 0.22),
    Keyframe(p: 3 / 16, rotation: -0.06),
    Keyframe(p: 1 / 4, rotation: -0.43),
    Keyframe(p: 5 / 16, rotation: -0.39),
    Keyframe(p: 3 / 8, rotation: -0.18),
    Keyframe(p: 7 / 16, rotation: -0.15),
    Keyframe(p: 1 / 2, rotation: 0.43),
    Keyframe(p: 9 / 16, rotation: 0.39),
    Keyframe(p: 5 / 8, rotation: 0.2),
    Keyframe(p: 11 / 16, rotation: -0.06),
    Keyframe(p: 23 / 32, rotation: -0.18),
    Keyframe(p: 3 / 4, rotation: -0.42),
    Keyframe(p: 13 / 16, rotation: -0.38),
    Keyframe(p: 7 / 8, rotation: -0.17),
    Keyframe(p: 15 / 16, rotation: 0.38),
    Keyframe(p: 31 / 32, rotation: 0.43),
    Keyframe(p: 1, rotation: 0.43),
  ];
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.13, scaleY: 0.924, scaleX: 1.043),
    Keyframe(p: 1 / 16, rotation: -0.16, scaleY: 0.975, scaleX: 1.014),
    Keyframe(p: 1 / 8, rotation: -0.01, scaleY: 0.968, scaleX: 1.018),
    Keyframe(p: 3 / 16, rotation: 0.06, scaleY: 1.005, scaleX: 0.998),
    Keyframe(p: 7 / 32, rotation: 0.085, scaleY: 0.979, scaleX: 1.012),
    Keyframe(p: 1 / 4, rotation: 0.14, scaleY: 0.924, scaleX: 1.043),
    Keyframe(p: 5 / 16, rotation: 0.16, scaleY: 0.975, scaleX: 1.014),
    Keyframe(p: 3 / 8, rotation: 0.01, scaleY: 0.966, scaleX: 1.02),
    Keyframe(p: 7 / 16, rotation: -0.06, scaleY: 1.005, scaleX: 0.998),
    Keyframe(p: 15 / 32, rotation: -0.085, scaleY: 0.979, scaleX: 1.012),
    Keyframe(p: 1 / 2, rotation: -0.13, scaleY: 0.924, scaleX: 1.043),
    Keyframe(p: 9 / 16, rotation: -0.16, scaleY: 0.975, scaleX: 1.014),
    Keyframe(p: 5 / 8, rotation: -0.01, scaleY: 0.968, scaleX: 1.018),
    Keyframe(p: 11 / 16, rotation: 0.055, scaleY: 1.005, scaleX: 0.998),
    Keyframe(p: 23 / 32, rotation: 0.035, scaleY: 0.979, scaleX: 1.012),
    Keyframe(p: 3 / 4, rotation: 0.13, scaleY: 0.924, scaleX: 1.043),
    Keyframe(p: 13 / 16, rotation: 0.15, scaleY: 0.975, scaleX: 1.014),
    Keyframe(p: 7 / 8, rotation: -0.035, scaleY: 0.97, scaleX: 1.017),
    Keyframe(p: 15 / 16, rotation: -0.145, scaleY: 0.925, scaleX: 1.042),
    Keyframe(p: 31 / 32, rotation: -0.16, scaleY: 0.925, scaleX: 1.041),
    Keyframe(p: 1, rotation: -0.13, scaleY: 0.924, scaleX: 1.043),
  ];
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        ...
        RootKeyframe(p: 5 / 16, dx: 14, dy: 15.6, rotation: 0.008),
        RootKeyframe(p: 3 / 8, dx: 13, dy: 16.4, rotation: 0.006),
        RootKeyframe(p: 7 / 16, dx: 6, dy: 14.6, rotation: 0.002),
        RootKeyframe(p: 15 / 32, dx: -1, dy: 15.8, rotation: -0.001),
