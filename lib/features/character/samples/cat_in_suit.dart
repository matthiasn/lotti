...
class CatClips {
  ...
  static const _danceLegLowerLKeys = [
    ...
    Keyframe(p: 31 / 32, rotation: -0.94),
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.11, scaleY: 0.94, scaleX: 1.032),
    Keyframe(p: 1 / 16, rotation: -0.06, scaleY: 1.012, scaleX: 0.992),
    Keyframe(p: 1 / 8, rotation: 0.015, scaleY: 0.962, scaleX: 1.018),
    Keyframe(p: 3 / 16, rotation: 0.07, scaleY: 1.008, scaleX: 0.996),
    Keyframe(p: 7 / 32, rotation: 0.05, scaleY: 0.982, scaleX: 1.009),
    Keyframe(p: 1 / 4, rotation: 0.11, scaleY: 0.94, scaleX: 1.032),
    Keyframe(p: 5 / 16, rotation: 0.055, scaleY: 1.012, scaleX: 0.992),
    Keyframe(p: 3 / 8, rotation: -0.015, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 7 / 16, rotation: -0.07, scaleY: 1.008, scaleX: 0.996),
    Keyframe(p: 15 / 32, rotation: -0.05, scaleY: 0.982, scaleX: 1.009),
    Keyframe(p: 1 / 2, rotation: -0.11, scaleY: 0.94, scaleX: 1.032),
    Keyframe(p: 9 / 16, rotation: -0.055, scaleY: 1.012, scaleX: 0.992),
    Keyframe(p: 5 / 8, rotation: 0.02, scaleY: 0.96, scaleX: 1.02),
    Keyframe(p: 11 / 16, rotation: 0.075, scaleY: 1.008, scaleX: 0.996),
    Keyframe(p: 23 / 32, rotation: 0.055, scaleY: 0.982, scaleX: 1.009),
    Keyframe(p: 3 / 4, rotation: 0.105, scaleY: 0.94, scaleX: 1.032),
    Keyframe(p: 13 / 16, rotation: 0.055, scaleY: 1.012, scaleX: 0.992),
    Keyframe(p: 7 / 8, rotation: -0.055, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 15 / 16, rotation: -0.1, scaleY: 0.972, scaleX: 1.014),
    Keyframe(p: 31 / 32, rotation: -0.09, scaleY: 0.966, scaleX: 1.018),
    Keyframe(p: 1, rotation: -0.11, scaleY: 0.94, scaleX: 1.032),
  ];
  ...
  static const _danceArmUpperLKeys = [
    ...
    Keyframe(p: 7 / 8, rotation: 1.42),
    Keyframe(p: 29 / 32, rotation: 1.64),
    Keyframe(p: 15 / 16, rotation: 1.58),
    Keyframe(p: 31 / 32, rotation: 0.72),
    Keyframe(p: 1, rotation: 0.28),
  ];
  ...
  static const _danceArmUpperRKeys = [
    ...
    Keyframe(p: 7 / 8, rotation: -1.16),
    Keyframe(p: 29 / 32, rotation: -1.3),
    Keyframe(p: 15 / 16, rotation: -1.16),
  ...
  static const _danceArmLowerRKeys = [
    ...
    Keyframe(p: 29 / 32, rotation: 0.66),
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -16, dy: 14.8, rotation: -0.007),
        RootKeyframe(p: 1 / 16, dx: -20, dy: 14.2, rotation: -0.008),
        RootKeyframe(p: 1 / 8, dx: -22, dy: 13.2, rotation: -0.006),
        RootKeyframe(p: 3 / 16, dx: -12, dy: 12.4, rotation: -0.003),
        RootKeyframe(p: 7 / 32, dx: 2, dy: 13.4, rotation: 0.002),
        RootKeyframe(p: 1 / 4, dy: 14.8, rotation: 0.007),
        RootKeyframe(p: 5 / 16, dx: 16, dy: 14.2, rotation: 0.008),
        RootKeyframe(p: 3 / 8, dx: 22, dy: 13.2, rotation: 0.006),
        RootKeyframe(p: 7 / 16, dx: 14, dy: 12.4, rotation: 0.003),
        RootKeyframe(p: 15 / 32, dx: -2, dy: 13.4, rotation: -0.002),
        RootKeyframe(p: 1 / 2, dx: -4, dy: 14.8, rotation: -0.007),
        RootKeyframe(p: 9 / 16, dx: -18, dy: 14.2, rotation: -0.008),
        RootKeyframe(p: 5 / 8, dx: -22, dy: 13.2, rotation: -0.006),
        RootKeyframe(p: 11 / 16, dx: -14, dy: 12.4, rotation: -0.003),
        RootKeyframe(p: 23 / 32, dx: 2, dy: 13.4, rotation: 0.002),
        RootKeyframe(p: 3 / 4, dy: 14.8, rotation: 0.007),
        RootKeyframe(p: 13 / 16, dx: 18, dy: 14.2, rotation: 0.008),
        RootKeyframe(p: 7 / 8, dx: 24, dy: 13.4, rotation: 0.006),
        RootKeyframe(p: 29 / 32, dx: 8, dy: 13.8, rotation: 0.001),
        RootKeyframe(p: 15 / 16, dx: -10, dy: 15.2, rotation: -0.005),
        RootKeyframe(p: 31 / 32, dx: -15, dy: 15, rotation: -0.006),
        RootKeyframe(p: 1, dx: -16, dy: 14.8, rotation: -0.007),
      ]),
      SineRootChannel(
        bobAmplitude: -0.06,
        bobPhase: 0.125,
