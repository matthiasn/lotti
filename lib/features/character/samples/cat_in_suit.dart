...
class CatClips {
  ...
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.088, scaleY: 0.895, scaleX: 1.064),
  ...
  static const _danceArmLowerLKeys = [
    ...
    Keyframe(p: 7 / 8, rotation: 0.18),
    Keyframe(p: 15 / 16, rotation: -0.04),
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -14, dy: 15, rotation: -0.008),
        RootKeyframe(p: 1 / 16, dx: -9, dy: 11, rotation: -0.006),
        RootKeyframe(p: 1 / 8, dx: 4, dy: -7, rotation: 0.003),
        RootKeyframe(p: 3 / 16, dx: 12, dy: 4, rotation: 0.007),
        RootKeyframe(p: 1 / 4, dx: 14, dy: 15, rotation: 0.008),
        RootKeyframe(p: 5 / 16, dx: 7, dy: 6, rotation: 0.004),
        RootKeyframe(p: 3 / 8, dx: -6, dy: -6, rotation: -0.003),
        RootKeyframe(p: 7 / 16, dx: -13, dy: 12, rotation: -0.007),
        RootKeyframe(p: 1 / 2, dx: -16, dy: 17, rotation: -0.009),
        RootKeyframe(p: 9 / 16, dx: -7, dy: 5, rotation: -0.003),
        RootKeyframe(p: 5 / 8, dx: 8, dy: -8, rotation: 0.004),
        RootKeyframe(p: 11 / 16, dx: 15, dy: 6, rotation: 0.008),
        RootKeyframe(p: 3 / 4, dx: 17, dy: 16, rotation: 0.009),
        RootKeyframe(p: 13 / 16, dx: 10, dy: 5, rotation: 0.004),
        RootKeyframe(p: 7 / 8, dx: 2, dy: -14, rotation: -0.002),
        RootKeyframe(p: 29 / 32, dx: 2, dy: -12, rotation: -0.002),
        RootKeyframe(p: 15 / 16, dx: -9, dy: 11, rotation: -0.006),
        RootKeyframe(p: 1, dx: -14, dy: 15, rotation: -0.008),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.24,
        bobPhase: 0.125,
