...
class CatClips {
  ...
  static const _danceFootLTarget = KeyframeIkTargetChannel([
    IkTargetKeyframe(p: 0, x: 9.6, y: 94.4),
    IkTargetKeyframe(p: 1 / 32, x: 10.2, y: 93.9),
    IkTargetKeyframe(p: 2 / 32, x: 11.7, y: 93.1),
    IkTargetKeyframe(p: 3 / 32, x: 14.7, y: 92.2),
    IkTargetKeyframe(p: 4 / 32, x: 17.5, y: 91.4),
    IkTargetKeyframe(p: 5 / 32, x: 20.3, y: 90.4),
    IkTargetKeyframe(p: 6 / 32, x: 19.4, y: 91.1),
    IkTargetKeyframe(p: 7 / 32, x: 8.1, y: 95.2),
    IkTargetKeyframe(p: 8 / 32, x: -4.8, y: 97.9),
    IkTargetKeyframe(p: 9 / 32, x: -8.9, y: 98),
    IkTargetKeyframe(p: 10 / 32, x: -10.4, y: 98),
    IkTargetKeyframe(p: 11 / 32, x: -13.9, y: 98.4),
    IkTargetKeyframe(p: 12 / 32, x: -16.1, y: 98.8),
    IkTargetKeyframe(p: 13 / 32, x: -10.7, y: 98.5),
    IkTargetKeyframe(p: 14 / 32, x: -9.5, y: 99.3),
    IkTargetKeyframe(p: 15 / 32, x: -24, y: 101.5),
    IkTargetKeyframe(p: 16 / 32, x: -38, y: 102.1),
    IkTargetKeyframe(p: 17 / 32, x: -42, y: 102.3),
    IkTargetKeyframe(p: 18 / 32, x: -40.4, y: 102.8),
    IkTargetKeyframe(p: 19 / 32, x: -38.9, y: 103.3),
    IkTargetKeyframe(p: 20 / 32, x: -36.7, y: 103.6),
    IkTargetKeyframe(p: 21 / 32, x: -30.6, y: 103.3),
    IkTargetKeyframe(p: 22 / 32, x: -25.8, y: 102.6),
    IkTargetKeyframe(p: 23 / 32, x: -27.9, y: 102.6),
    IkTargetKeyframe(p: 24 / 32, x: -31.2, y: 102.9),
    IkTargetKeyframe(p: 25 / 32, x: -30.7, y: 103.4),
    IkTargetKeyframe(p: 26 / 32, x: -29.3, y: 104),
    IkTargetKeyframe(p: 27 / 32, x: -30.7, y: 104.7),
    IkTargetKeyframe(p: 28 / 32, x: -27.4, y: 105),
    IkTargetKeyframe(p: 29 / 32, x: -0.5, y: 97.7),
    IkTargetKeyframe(p: 30 / 32, x: 9.8, y: 94.9),
    IkTargetKeyframe(p: 31 / 32, x: 10.8, y: 94),
    IkTargetKeyframe(p: 1, x: 9.6, y: 94.4),
  ], smooth: true);

  static const _danceFootRTarget = KeyframeIkTargetChannel([
    IkTargetKeyframe(p: 0, x: 71.5, y: 85.2),
    IkTargetKeyframe(p: 1 / 32, x: 72.1, y: 81.1),
    IkTargetKeyframe(p: 2 / 32, x: 70.8, y: 78.4),
    IkTargetKeyframe(p: 3 / 32, x: 68.3, y: 78.7),
    IkTargetKeyframe(p: 4 / 32, x: 65.9, y: 80.6),
    IkTargetKeyframe(p: 5 / 32, x: 66.1, y: 83.2),
    IkTargetKeyframe(p: 6 / 32, x: 65.2, y: 87.6),
    IkTargetKeyframe(p: 7 / 32, x: 57.3, y: 96),
    IkTargetKeyframe(p: 8 / 32, x: 57.8, y: 91.1),
    IkTargetKeyframe(p: 9 / 32, x: 54.8, y: 94.5),
    IkTargetKeyframe(p: 10 / 32, x: 50.9, y: 98.7),
    IkTargetKeyframe(p: 11 / 32, x: 47.7, y: 101),
    IkTargetKeyframe(p: 12 / 32, x: 42.7, y: 103),
    IkTargetKeyframe(p: 13 / 32, x: 32.5, y: 105),
    IkTargetKeyframe(p: 14 / 32, x: 19.9, y: 105.5),
    IkTargetKeyframe(p: 15 / 32, x: 5.3, y: 103.8),
    IkTargetKeyframe(p: 16 / 32, x: -4.2, y: 100.2),
    IkTargetKeyframe(p: 17 / 32, x: -5.3, y: 99.2),
    IkTargetKeyframe(p: 18 / 32, x: -3.4, y: 99.6),
    IkTargetKeyframe(p: 19 / 32, x: -4.9, y: 99.3),
    IkTargetKeyframe(p: 20 / 32, x: -5.9, y: 99.5),
    IkTargetKeyframe(p: 21 / 32, x: -4.1, y: 100.3),
    IkTargetKeyframe(p: 22 / 32, x: -1, y: 101.5),
    IkTargetKeyframe(p: 23 / 32, x: 1.9, y: 102.4),
    IkTargetKeyframe(p: 24 / 32, x: 7.6, y: 102.3),
    IkTargetKeyframe(p: 25 / 32, x: 8.9, y: 102.7),
    IkTargetKeyframe(p: 26 / 32, x: 9.5, y: 103.3),
    IkTargetKeyframe(p: 27 / 32, x: 8.9, y: 103.6),
    IkTargetKeyframe(p: 28 / 32, x: 14.4, y: 104.4),
    IkTargetKeyframe(p: 29 / 32, x: 39.5, y: 102.6),
    IkTargetKeyframe(p: 30 / 32, x: 62.3, y: 94),
    IkTargetKeyframe(p: 31 / 32, x: 69.5, y: 88.6),
    IkTargetKeyframe(p: 1, x: 71.5, y: 85.2),
  ], smooth: true);

  static const _danceHipKeys = [
    DanceJointKey(0, rotation: 0.3),
    DanceJointKey(2, rotation: 0.36),
    DanceJointKey(4, rotation: 0.43),
    DanceJointKey(6, rotation: 0.34),
    DanceJointKey(8, rotation: 0.2),
    DanceJointKey(10, rotation: 0.08),
    DanceJointKey(12, rotation: -0.04),
    DanceJointKey(14, rotation: -0.2),
    DanceJointKey(16, rotation: -0.3),
    DanceJointKey(18, rotation: -0.36),
    DanceJointKey(20, rotation: -0.43),
    DanceJointKey(22, rotation: -0.34),
    DanceJointKey(24, rotation: -0.2),
    DanceJointKey(26, rotation: -0.08),
    DanceJointKey(28, rotation: 0.04),
    DanceJointKey(30, rotation: 0.2),
    DanceJointKey(31, rotation: 0.28),
  ...
  static const _danceTorsoKeys = [
    DanceJointKey(0, rotation: -0.08, scaleY: 0.956, scaleX: 1.024),
    DanceJointKey(2, rotation: -0.13, scaleY: 0.94, scaleX: 1.034),
    DanceJointKey(4, rotation: -0.18, scaleY: 0.918, scaleX: 1.052),
    DanceJointKey(6, rotation: -0.12, scaleY: 0.95, scaleX: 1.028),
    DanceJointKey(8, rotation: -0.02, scaleY: 0.982, scaleX: 1.01),
    DanceJointKey(10, rotation: 0.06, scaleY: 0.97, scaleX: 1.018),
    DanceJointKey(12, rotation: 0.1, scaleY: 0.96, scaleX: 1.024),
    DanceJointKey(14, rotation: 0.08, scaleY: 0.972, scaleX: 1.016),
    DanceJointKey(16, rotation: 0.08, scaleY: 0.956, scaleX: 1.024),
    DanceJointKey(18, rotation: 0.13, scaleY: 0.94, scaleX: 1.034),
    DanceJointKey(20, rotation: 0.18, scaleY: 0.918, scaleX: 1.052),
    DanceJointKey(22, rotation: 0.12, scaleY: 0.95, scaleX: 1.028),
    DanceJointKey(24, rotation: 0.02, scaleY: 0.982, scaleX: 1.01),
    DanceJointKey(26, rotation: -0.06, scaleY: 0.97, scaleX: 1.018),
    DanceJointKey(28, rotation: -0.1, scaleY: 0.96, scaleX: 1.024),
    DanceJointKey(30, rotation: -0.08, scaleY: 0.956, scaleX: 1.024),
    DanceJointKey(31, rotation: -0.08, scaleY: 0.956, scaleX: 1.024),
    DanceJointKey(32, rotation: -0.08, scaleY: 0.956, scaleX: 1.024),
  ];
  ...
  static const _danceHandLTarget = KeyframeIkTargetChannel([
    IkTargetKeyframe(p: 0, x: -56.1, y: 30.3),
    IkTargetKeyframe(p: 1 / 32, x: -41.1, y: 32.7),
    IkTargetKeyframe(p: 2 / 32, x: -29.5, y: 32.8),
    IkTargetKeyframe(p: 3 / 32, x: -22.8, y: 31.4),
    IkTargetKeyframe(p: 4 / 32, x: -14.2, y: 28.8),
    IkTargetKeyframe(p: 5 / 32, x: -12.8, y: 30.2),
    IkTargetKeyframe(p: 6 / 32, x: -19.7, y: 30.4),
    IkTargetKeyframe(p: 7 / 32, x: -57.2, y: 30.2),
    IkTargetKeyframe(p: 8 / 32, x: -92.3, y: 11.3),
    IkTargetKeyframe(p: 9 / 32, x: -93.1, y: 10.5),
    IkTargetKeyframe(p: 10 / 32, x: -82.5, y: 19.1),
    IkTargetKeyframe(p: 11 / 32, x: -70.8, y: 24.6),
    IkTargetKeyframe(p: 12 / 32, x: -55.7, y: 28.9),
    IkTargetKeyframe(p: 13 / 32, x: -75.2, y: 22.2),
    IkTargetKeyframe(p: 14 / 32, x: -80.7, y: 19.7),
    IkTargetKeyframe(p: 15 / 32, x: -66, y: 25.8),
    IkTargetKeyframe(p: 16 / 32, x: -47, y: 31.5),
    IkTargetKeyframe(p: 17 / 32, x: -29.7, y: 32.8),
    IkTargetKeyframe(p: 18 / 32, x: -25, y: 32.4),
    IkTargetKeyframe(p: 19 / 32, x: -40.7, y: 32.8),
    IkTargetKeyframe(p: 20 / 32, x: -49.4, y: 31.3),
    IkTargetKeyframe(p: 21 / 32, x: -48.5, y: 30.5),
    IkTargetKeyframe(p: 22 / 32, x: -45.3, y: 30.3),
    IkTargetKeyframe(p: 23 / 32, x: -53.9, y: 27.8),
    IkTargetKeyframe(p: 24 / 32, x: -72.2, y: 22.2),
    IkTargetKeyframe(p: 25 / 32, x: -63.6, y: 25.4),
    IkTargetKeyframe(p: 26 / 32, x: -43.7, y: 28.6),
    IkTargetKeyframe(p: 27 / 32, x: -67.1, y: 26.9),
    IkTargetKeyframe(p: 28 / 32, x: -88.2, y: 12.9),
    IkTargetKeyframe(p: 29 / 32, x: -98, y: -3),
    IkTargetKeyframe(p: 30 / 32, x: -94, y: 4),
    IkTargetKeyframe(p: 31 / 32, x: -75, y: 22),
    IkTargetKeyframe(p: 1, x: -56.1, y: 30.3),
  ], smooth: true);

  static const _danceHandRTarget = KeyframeIkTargetChannel([
    IkTargetKeyframe(p: 0, x: 54.4, y: 30.7),
    IkTargetKeyframe(p: 1 / 32, x: 37.2, y: 31.9),
    IkTargetKeyframe(p: 2 / 32, x: 22.3, y: 30.8),
    IkTargetKeyframe(p: 3 / 32, x: 11.7, y: 29.9),
    IkTargetKeyframe(p: 4 / 32, x: 13.6, y: 29.7),
    IkTargetKeyframe(p: 5 / 32, x: 21.4, y: 31.9),
    IkTargetKeyframe(p: 6 / 32, x: 30.5, y: 32),
    IkTargetKeyframe(p: 7 / 32, x: 22, y: 31),
    IkTargetKeyframe(p: 8 / 32, x: 27.5, y: 30.4),
    IkTargetKeyframe(p: 9 / 32, x: 26.8, y: 30.2),
    IkTargetKeyframe(p: 10 / 32, x: 26.1, y: 30.8),
    IkTargetKeyframe(p: 11 / 32, x: 31.7, y: 30.8),
    IkTargetKeyframe(p: 12 / 32, x: 44.8, y: 30.3),
    IkTargetKeyframe(p: 13 / 32, x: 48.6, y: 30.2),
    IkTargetKeyframe(p: 14 / 32, x: 54.4, y: 29.2),
    IkTargetKeyframe(p: 15 / 32, x: 74, y: 23.6),
    IkTargetKeyframe(p: 16 / 32, x: 94.6, y: 10.1),
    IkTargetKeyframe(p: 17 / 32, x: 87.6, y: 15.5),
    IkTargetKeyframe(p: 18 / 32, x: 72.8, y: 23.2),
    IkTargetKeyframe(p: 19 / 32, x: 61.4, y: 27.2),
    IkTargetKeyframe(p: 20 / 32, x: 60, y: 27.9),
    IkTargetKeyframe(p: 21 / 32, x: 63.5, y: 27.3),
    IkTargetKeyframe(p: 22 / 32, x: 72.5, y: 23.9),
    IkTargetKeyframe(p: 23 / 32, x: 89, y: 14.6),
    IkTargetKeyframe(p: 24 / 32, x: 73, y: 23.1),
    IkTargetKeyframe(p: 25 / 32, x: 74.1, y: 22.7),
    IkTargetKeyframe(p: 26 / 32, x: 78.2, y: 20.8),
    IkTargetKeyframe(p: 27 / 32, x: 61.8, y: 25.6),
    IkTargetKeyframe(p: 28 / 32, x: 51.2, y: 24.7),
    IkTargetKeyframe(p: 29 / 32, x: 63.1, y: 20.7),
    IkTargetKeyframe(p: 30 / 32, x: 62.6, y: 22.3),
    IkTargetKeyframe(p: 31 / 32, x: 74.1, y: 23.4),
    IkTargetKeyframe(p: 1, x: 54.4, y: 30.7),
  ], smooth: true);
  ...
  static Clip get dance => Clip(
    ...
    root: LayeredRootChannel([
      _dancePhrase.rootChannel(
        const [
          DanceRootKey(0, dx: -12, dy: 18.2, rotation: -0.007),
          DanceRootKey(2, dx: -14, dy: 15.6, rotation: -0.008),
          DanceRootKey(4, dx: -13, dy: 16.4, rotation: -0.006),
          DanceRootKey(6, dx: -6, dy: 14.6, rotation: -0.002),
          DanceRootKey(7, dx: 1, dy: 15.8, rotation: 0.001),
          DanceRootKey(8, dx: 12, dy: 18.2, rotation: 0.007),
          DanceRootKey(10, dx: 17, dy: 15.6, rotation: 0.008),
          DanceRootKey(12, dx: 21, dy: 16.4, rotation: 0.006),
          DanceRootKey(14, dx: 18, dy: 14.6, rotation: 0.002),
          DanceRootKey(15, dx: 8, dy: 15.8, rotation: -0.001),
          DanceRootKey(16, dx: -12, dy: 18.2, rotation: -0.007),
          DanceRootKey(18, dx: -14, dy: 15.6, rotation: -0.008),
          DanceRootKey(20, dx: -13, dy: 16.4, rotation: -0.006),
          DanceRootKey(22, dx: -5, dy: 14.6, rotation: -0.002),
          DanceRootKey(23, dx: 2, dy: 15.8, rotation: 0.001),
          DanceRootKey(24, dx: 12, dy: 18.2, rotation: 0.007),
          DanceRootKey(26, dx: 14, dy: 15.6, rotation: 0.008),
          DanceRootKey(28, dx: 12, dy: 16.4, rotation: 0.006),
          DanceRootKey(29, dx: 4, dy: 15.8, rotation: 0.002),
          DanceRootKey(30, dx: -6, dy: 17.8, rotation: -0.003),
          DanceRootKey(31, dx: -11, dy: 18.2, rotation: -0.006),
          DanceRootKey(32, dx: -12, dy: 18.2, rotation: -0.007),
        ],
        smooth: true,
      ),
    ...
    channels: {
      ...
      CatBones.hips: LayeredJointChannel([
        _dancePhrase.jointChannel(_danceHipKeys),
        const SineChannel(
      ...
      CatBones.torso: LayeredJointChannel([
        _dancePhrase.jointChannel(_danceTorsoKeys),
        const SineChannel(
