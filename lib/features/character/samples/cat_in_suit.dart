...
class CatClips {
  ...
  static const _danceLegUpperLKeys = [
    ...
    Keyframe(p: 29 / 32, rotation: 0.17),
  ...
  static const _danceLegLowerRKeys = [
    ...
    Keyframe(p: 9 / 16, rotation: -1.32),
    Keyframe(p: 5 / 8, rotation: -1.5),
  ...
  static const _danceFootLKeys = [
    ...
    Keyframe(p: 13 / 16, rotation: 0.34),
    Keyframe(p: 7 / 8, rotation: 0.08),
    Keyframe(p: 29 / 32, rotation: -0.06),
  ...
  static const _danceHipKeys = [
    ...
    Keyframe(p: 11 / 16, rotation: -0.08),
    Keyframe(p: 23 / 32, rotation: -0.18),
    Keyframe(p: 3 / 4, rotation: -0.4),
    Keyframe(p: 13 / 16, rotation: -0.32),
    Keyframe(p: 7 / 8, rotation: -0.14),
    Keyframe(p: 15 / 16, rotation: 0.4),
    Keyframe(p: 31 / 32, rotation: 0.42),
    Keyframe(p: 1, rotation: 0.42),
  ];

  // Backup-dancer roles are configured as small additive overlays in _danceArmRole
  // below. The shared base clip owns support timing and body mechanics.
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.2, scaleY: 0.92, scaleX: 1.045),
    ...
    Keyframe(p: 1 / 4, rotation: 0.2, scaleY: 0.92, scaleX: 1.045),
    ...
    Keyframe(p: 1 / 2, rotation: -0.2, scaleY: 0.92, scaleX: 1.045),
    ...
    Keyframe(p: 3 / 4, rotation: 0.18, scaleY: 0.92, scaleX: 1.045),
    Keyframe(p: 13 / 16, rotation: 0.1, scaleY: 1.015, scaleX: 0.99),
    Keyframe(p: 7 / 8, rotation: -0.06, scaleY: 0.946, scaleX: 1.027),
    Keyframe(p: 15 / 16, rotation: -0.17, scaleY: 0.925, scaleX: 1.04),
    Keyframe(p: 31 / 32, rotation: -0.19, scaleY: 0.932, scaleX: 1.038),
    Keyframe(p: 1, rotation: -0.2, scaleY: 0.92, scaleX: 1.045),
  ];
  ...
  static Clip get dance => const Clip(
    ...
    root: LayeredRootChannel([
      KeyframeRootChannel([
        RootKeyframe(p: 0, dx: -16, dy: 17.2, rotation: -0.01),
        RootKeyframe(p: 1 / 16, dx: -19, dy: 14.4, rotation: -0.012),
        RootKeyframe(p: 1 / 8, dx: -17, dy: 15.8, rotation: -0.008),
        RootKeyframe(p: 3 / 16, dx: -8, dy: 13.4, rotation: -0.003),
        RootKeyframe(p: 7 / 32, dx: 1, dy: 15, rotation: 0.002),
        RootKeyframe(p: 1 / 4, dx: 16, dy: 17.2, rotation: 0.01),
        RootKeyframe(p: 5 / 16, dx: 19, dy: 14.4, rotation: 0.012),
        RootKeyframe(p: 3 / 8, dx: 17, dy: 15.8, rotation: 0.008),
        RootKeyframe(p: 7 / 16, dx: 7, dy: 13.4, rotation: 0.003),
        RootKeyframe(p: 15 / 32, dx: -1, dy: 15, rotation: -0.002),
        RootKeyframe(p: 1 / 2, dx: -16, dy: 17.2, rotation: -0.01),
        RootKeyframe(p: 9 / 16, dx: -19, dy: 14.4, rotation: -0.012),
        RootKeyframe(p: 5 / 8, dx: -17, dy: 15.8, rotation: -0.008),
        RootKeyframe(p: 11 / 16, dx: -7, dy: 13.4, rotation: -0.003),
        RootKeyframe(p: 23 / 32, dx: 3, dy: 15, rotation: 0.002),
        RootKeyframe(p: 3 / 4, dx: 16, dy: 17.2, rotation: 0.01),
        RootKeyframe(p: 13 / 16, dx: 19, dy: 14.4, rotation: 0.012),
        RootKeyframe(p: 7 / 8, dx: 17, dy: 15.8, rotation: 0.008),
        RootKeyframe(p: 29 / 32, dx: 5, dy: 15.2, rotation: 0.003),
        RootKeyframe(p: 15 / 16, dx: -8, dy: 17, rotation: -0.004),
        RootKeyframe(p: 31 / 32, dx: -14, dy: 17.2, rotation: -0.008),
        RootKeyframe(p: 1, dx: -16, dy: 17.2, rotation: -0.01),
      ], smooth: true),
      SineRootChannel(
        bobAmplitude: -0.06,
        bobPhase: 0.125,
    ...
    channels: {
      ...
      CatBones.earL: SineChannel(amplitude: 0.04, phase: 0.35),
      CatBones.earR: SineChannel(amplitude: 0.045, phase: 0.8),
  ...
  static Clip get danceBackupLeft => _danceArmRole(
    ...
    armUpperR: const SineChannel(amplitude: 0.035, phase: 0.54, bias: -0.015),
    armLowerR: const SineChannel(amplitude: 0.045, phase: 0.68, bias: 0.015),
  );

  static Clip get danceBackupRight => _danceArmRole(
    name: 'danceBackupRight',
    armUpperL: const SineChannel(amplitude: 0.035, phase: 0.58, bias: -0.015),
    armLowerL: const SineChannel(amplitude: 0.045, phase: 0.7, bias: 0.015),
