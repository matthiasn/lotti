...
class CatClips {
  ...
  // 12-count dance phrase. Counts 1-8 are a grounded step-touch groove:
  // plant, compress, tap, rebound, then swap feet. Counts 9-12 keep the
  // Gbese-style toe-flick accent, but compact and under the hips. The previous
  // version threw the thighs sideways while the torso stayed almost fixed,
  // which read like impossible pendulum legs instead of weight transfer.
  static const _danceLegUpperLKeys = [
    Keyframe(p: 0, rotation: 0.1),
    Keyframe(p: 1 / 12, rotation: 0.12),
    Keyframe(p: 2 / 12, rotation: 0.02),
    Keyframe(p: 3 / 12, rotation: -0.06),
    Keyframe(p: 4 / 12, rotation: 0.1),
    Keyframe(p: 5 / 12, rotation: 0.12),
    Keyframe(p: 6 / 12, rotation: 0.02),
    Keyframe(p: 7 / 12, rotation: -0.06),
    Keyframe(p: 8 / 12, rotation: 0.08),
    Keyframe(p: 9 / 12, rotation: 0.04),
    Keyframe(p: 10 / 12, rotation: -0.04),
    Keyframe(p: 65 / 72, rotation: -0.14),
    Keyframe(p: 11 / 12, rotation: -0.24),
    Keyframe(p: 17 / 18, rotation: -0.18),
    Keyframe(p: 1, rotation: 0.1),
  ];
  static const _danceLegUpperRKeys = [
    Keyframe(p: 0, rotation: -0.04),
    Keyframe(p: 1 / 12, rotation: -0.12),
    Keyframe(p: 2 / 12, rotation: -0.18),
    Keyframe(p: 3 / 12, rotation: -0.2),
    Keyframe(p: 4 / 12, rotation: -0.02),
    Keyframe(p: 5 / 12, rotation: 0.06),
    Keyframe(p: 6 / 12, rotation: -0.18),
    Keyframe(p: 7 / 12, rotation: -0.2),
    Keyframe(p: 8 / 12, rotation: -0.08),
    Keyframe(p: 53 / 72, rotation: -0.14),
    Keyframe(p: 9 / 12, rotation: -0.22),
    Keyframe(p: 7 / 9, rotation: -0.16),
    Keyframe(p: 10 / 12, rotation: -0.14),
    Keyframe(p: 11 / 12, rotation: -0.12),
    Keyframe(p: 1, rotation: -0.04),
  ];
  static const _danceLegLowerLKeys = [
    Keyframe(p: 0, rotation: -0.72),
    Keyframe(p: 1 / 12, rotation: -0.84),
    Keyframe(p: 2 / 12, rotation: -0.58),
    Keyframe(p: 3 / 12, rotation: -0.48),
    Keyframe(p: 4 / 12, rotation: -0.72),
    Keyframe(p: 5 / 12, rotation: -0.84),
    Keyframe(p: 6 / 12, rotation: -0.58),
    Keyframe(p: 7 / 12, rotation: -0.48),
    Keyframe(p: 8 / 12, rotation: -0.74),
    Keyframe(p: 9 / 12, rotation: -0.82),
    Keyframe(p: 10 / 12, rotation: -0.58),
    Keyframe(p: 65 / 72, rotation: -0.58),
    Keyframe(p: 11 / 12, rotation: -0.62),
    Keyframe(p: 17 / 18, rotation: -0.56),
    Keyframe(p: 1, rotation: -0.72),
  ];
  static const _danceLegLowerRKeys = [
    Keyframe(p: 0, rotation: -0.58),
    Keyframe(p: 1 / 12, rotation: -0.48),
    Keyframe(p: 2 / 12, rotation: -0.45),
    Keyframe(p: 3 / 12, rotation: -0.56),
    Keyframe(p: 4 / 12, rotation: -0.58),
    Keyframe(p: 5 / 12, rotation: -0.48),
    Keyframe(p: 6 / 12, rotation: -0.45),
    Keyframe(p: 7 / 12, rotation: -0.56),
    Keyframe(p: 8 / 12, rotation: -0.62),
    Keyframe(p: 53 / 72, rotation: -0.54),
    Keyframe(p: 9 / 12, rotation: -0.58),
    Keyframe(p: 7 / 9, rotation: -0.54),
    Keyframe(p: 10 / 12, rotation: -0.45),
    Keyframe(p: 11 / 12, rotation: -0.56),
    Keyframe(p: 17 / 18, rotation: -0.5),
    Keyframe(p: 1, rotation: -0.58),
  ];
  static const _danceFootLKeys = [
    Keyframe(p: 0, rotation: -0.08),
    Keyframe(p: 1 / 24, rotation: -0.24),
    Keyframe(p: 1 / 12, rotation: -0.12),
    Keyframe(p: 1 / 8, rotation: 0.03),
    Keyframe(p: 2 / 12, rotation: 0.14),
    Keyframe(p: 5 / 24, rotation: 0.33),
    Keyframe(p: 3 / 12, rotation: 0.58),
    Keyframe(p: 13 / 48, rotation: 0.2),
    Keyframe(p: 4 / 12, rotation: -0.08),
    Keyframe(p: 3 / 8, rotation: -0.24),
    Keyframe(p: 5 / 12, rotation: -0.12),
    Keyframe(p: 11 / 24, rotation: 0.03),
    Keyframe(p: 6 / 12, rotation: 0.14),
    Keyframe(p: 13 / 24, rotation: 0.33),
    Keyframe(p: 7 / 12, rotation: 0.58),
    Keyframe(p: 29 / 48, rotation: 0.2),
    Keyframe(p: 8 / 12, rotation: -0.08),
    Keyframe(p: 17 / 24, rotation: -0.2),
    Keyframe(p: 9 / 12, rotation: -0.12),
    Keyframe(p: 19 / 24, rotation: 0.02),
    Keyframe(p: 10 / 12, rotation: 0.2),
    Keyframe(p: 65 / 72, rotation: 0.38),
    Keyframe(p: 11 / 12, rotation: 0.78),
    Keyframe(p: 45 / 48, rotation: 0.42),
    Keyframe(p: 17 / 18, rotation: 0.32),
    Keyframe(p: 1, rotation: -0.08),
  ];
  static const _danceFootRKeys = [
    Keyframe(p: 0, rotation: 0.14),
    Keyframe(p: 1 / 24, rotation: 0.33),
    Keyframe(p: 1 / 12, rotation: 0.58),
    Keyframe(p: 5 / 48, rotation: 0.2),
    Keyframe(p: 2 / 12, rotation: -0.08),
    Keyframe(p: 5 / 24, rotation: -0.2),
    Keyframe(p: 3 / 12, rotation: -0.12),
    Keyframe(p: 7 / 24, rotation: 0.02),
    Keyframe(p: 4 / 12, rotation: 0.14),
    Keyframe(p: 3 / 8, rotation: 0.33),
    Keyframe(p: 5 / 12, rotation: 0.58),
    Keyframe(p: 21 / 48, rotation: 0.2),
    Keyframe(p: 6 / 12, rotation: -0.08),
    Keyframe(p: 13 / 24, rotation: -0.2),
    Keyframe(p: 7 / 12, rotation: -0.12),
    Keyframe(p: 5 / 8, rotation: 0.02),
    Keyframe(p: 8 / 12, rotation: 0.2),
    Keyframe(p: 53 / 72, rotation: 0.38),
    Keyframe(p: 9 / 12, rotation: 0.78),
    Keyframe(p: 37 / 48, rotation: 0.42),
    Keyframe(p: 7 / 9, rotation: 0.32),
    Keyframe(p: 10 / 12, rotation: -0.08),
    Keyframe(p: 7 / 8, rotation: -0.2),
    Keyframe(p: 11 / 12, rotation: -0.12),
    Keyframe(p: 1, rotation: 0.14),
  ];
  static const _danceHipKeys = [
    Keyframe(p: 0, rotation: 0.26),
    Keyframe(p: 1 / 12, rotation: 0.36),
    Keyframe(p: 2 / 12, rotation: -0.26),
    Keyframe(p: 3 / 12, rotation: -0.36),
    Keyframe(p: 4 / 12, rotation: 0.26),
    Keyframe(p: 5 / 12, rotation: 0.36),
    Keyframe(p: 6 / 12, rotation: -0.26),
    Keyframe(p: 7 / 12, rotation: -0.36),
    Keyframe(p: 8 / 12, rotation: 0.28),
    Keyframe(p: 9 / 12, rotation: 0.38),
    Keyframe(p: 10 / 12, rotation: -0.28),
    Keyframe(p: 11 / 12, rotation: -0.38),
  ...
  static const _danceBackupLeftArmUpperLKeys = [
    ...
    Keyframe(p: 2 / 12, rotation: 0.42),
    Keyframe(p: 3 / 12, rotation: 0.78),
    Keyframe(p: 4 / 12, rotation: 0.48),
    Keyframe(p: 5 / 12, rotation: 0.62),
    Keyframe(p: 6 / 12, rotation: 1.02),
    Keyframe(p: 7 / 12, rotation: 2.12),
    Keyframe(p: 8 / 12, rotation: 1.05),
    Keyframe(p: 9 / 12, rotation: 0.95),
    Keyframe(p: 10 / 12, rotation: 0.68),
    Keyframe(p: 11 / 12, rotation: 2.08),
    Keyframe(p: 1, rotation: 2.48),
  ];
  static const _danceBackupLeftArmLowerLKeys = [
    Keyframe(p: 0, rotation: 0.55),
    Keyframe(p: 1 / 12, rotation: 0.24),
    Keyframe(p: 2 / 12, rotation: -0.12),
    Keyframe(p: 3 / 12, rotation: -0.55),
    Keyframe(p: 4 / 12, rotation: -0.22),
    Keyframe(p: 5 / 12, rotation: -0.48),
    Keyframe(p: 6 / 12, rotation: 0.12),
    Keyframe(p: 7 / 12, rotation: 0.28),
    Keyframe(p: 8 / 12, rotation: -0.1),
    Keyframe(p: 9 / 12, rotation: -0.14),
    Keyframe(p: 10 / 12, rotation: -0.08),
    Keyframe(p: 11 / 12, rotation: 0.36),
    Keyframe(p: 1, rotation: 0.55),
  ];
  static const _danceBackupLeftArmUpperRKeys = [
    Keyframe(p: 0, rotation: -0.28),
    Keyframe(p: 1 / 12, rotation: -0.42),
    Keyframe(p: 2 / 12, rotation: -0.1),
    Keyframe(p: 3 / 12, rotation: -0.22),
    Keyframe(p: 4 / 12, rotation: -1.55),
    Keyframe(p: 5 / 12, rotation: -1.2),
    Keyframe(p: 6 / 12, rotation: -0.22),
    Keyframe(p: 7 / 12, rotation: 0.08),
    Keyframe(p: 8 / 12, rotation: -0.52),
    Keyframe(p: 9 / 12, rotation: -1.12),
    Keyframe(p: 10 / 12, rotation: -0.38),
    Keyframe(p: 11 / 12, rotation: -0.48),
    Keyframe(p: 1, rotation: -0.28),
  ];
  static const _danceBackupLeftArmLowerRKeys = [
    Keyframe(p: 0, rotation: 0.1),
    Keyframe(p: 1 / 12, rotation: 0.32),
    Keyframe(p: 2 / 12, rotation: 0.08),
    Keyframe(p: 3 / 12, rotation: 0.42),
    Keyframe(p: 4 / 12, rotation: -0.25),
    Keyframe(p: 5 / 12, rotation: -0.1),
    Keyframe(p: 6 / 12, rotation: 0.04),
    Keyframe(p: 7 / 12, rotation: -0.1),
    Keyframe(p: 8 / 12, rotation: 0.08),
    Keyframe(p: 9 / 12, rotation: -0.16),
    Keyframe(p: 10 / 12, rotation: 0.08),
    Keyframe(p: 11 / 12, rotation: 0.12),
    Keyframe(p: 1, rotation: 0.1),
  ];
  static const _danceBackupRightArmUpperLKeys = [
    Keyframe(p: 0, rotation: 1.55),
    Keyframe(p: 1 / 12, rotation: 1.25),
    Keyframe(p: 2 / 12, rotation: 0.16),
    Keyframe(p: 3 / 12, rotation: 0.34),
    Keyframe(p: 4 / 12, rotation: 0.18),
    Keyframe(p: 5 / 12, rotation: 0.3),
    Keyframe(p: 6 / 12, rotation: 0.55),
    Keyframe(p: 7 / 12, rotation: 1.2),
    Keyframe(p: 8 / 12, rotation: 0.55),
    Keyframe(p: 9 / 12, rotation: 0.48),
    Keyframe(p: 10 / 12, rotation: 0.38),
    Keyframe(p: 11 / 12, rotation: 1.15),
    Keyframe(p: 1, rotation: 1.55),
  ];
  static const _danceBackupRightArmLowerLKeys = [
    ...
    Keyframe(p: 2 / 12, rotation: -0.12),
    Keyframe(p: 3 / 12, rotation: -0.36),
    Keyframe(p: 4 / 12, rotation: -0.16),
    Keyframe(p: 5 / 12, rotation: -0.32),
    Keyframe(p: 6 / 12, rotation: 0.04),
    Keyframe(p: 7 / 12, rotation: 0.12),
    Keyframe(p: 8 / 12, rotation: -0.08),
    Keyframe(p: 9 / 12, rotation: -0.12),
    Keyframe(p: 10 / 12, rotation: -0.08),
    Keyframe(p: 11 / 12, rotation: 0.18),
    Keyframe(p: 1, rotation: 0.28),
  ];
  static const _danceBackupRightArmUpperRKeys = [
    Keyframe(p: 0, rotation: -0.58),
    Keyframe(p: 1 / 12, rotation: -0.85),
    Keyframe(p: 2 / 12, rotation: -0.24),
    Keyframe(p: 3 / 12, rotation: -0.55),
    Keyframe(p: 4 / 12, rotation: -2.52),
    Keyframe(p: 5 / 12, rotation: -2.08),
    Keyframe(p: 6 / 12, rotation: -0.55),
    Keyframe(p: 7 / 12, rotation: 0.32),
    Keyframe(p: 8 / 12, rotation: -1.05),
    Keyframe(p: 9 / 12, rotation: -2.08),
    Keyframe(p: 10 / 12, rotation: -0.72),
    Keyframe(p: 11 / 12, rotation: -1),
    Keyframe(p: 1, rotation: -0.58),
  ];
  static const _danceBackupRightArmLowerRKeys = [
    Keyframe(p: 0, rotation: 0.28),
    Keyframe(p: 1 / 12, rotation: 0.66),
    Keyframe(p: 2 / 12, rotation: 0.2),
    Keyframe(p: 3 / 12, rotation: 0.82),
    Keyframe(p: 4 / 12, rotation: -0.56),
    Keyframe(p: 5 / 12, rotation: -0.26),
    Keyframe(p: 6 / 12, rotation: 0.12),
    Keyframe(p: 7 / 12, rotation: -0.18),
    Keyframe(p: 8 / 12, rotation: 0.22),
    Keyframe(p: 9 / 12, rotation: -0.36),
    Keyframe(p: 10 / 12, rotation: 0.18),
    Keyframe(p: 11 / 12, rotation: 0.28),
    Keyframe(p: 1, rotation: 0.28),
  ];
  static const _danceTorsoKeys = [
    Keyframe(p: 0, rotation: -0.025, scaleY: 0.93, scaleX: 1.036),
    Keyframe(p: 1 / 24, rotation: -0.014, scaleY: 0.972, scaleX: 1.014),
    Keyframe(p: 1 / 12, rotation: -0.035, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 1 / 8, rotation: -0.008, scaleY: 0.94, scaleX: 1.031),
    Keyframe(p: 2 / 12, rotation: 0.025, scaleY: 0.93, scaleX: 1.036),
    Keyframe(p: 5 / 24, rotation: 0.014, scaleY: 0.972, scaleX: 1.014),
    Keyframe(p: 3 / 12, rotation: 0.035, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 7 / 24, rotation: 0.008, scaleY: 0.94, scaleX: 1.031),
    Keyframe(p: 4 / 12, rotation: -0.025, scaleY: 0.93, scaleX: 1.036),
    Keyframe(p: 3 / 8, rotation: -0.014, scaleY: 0.972, scaleX: 1.014),
    Keyframe(p: 5 / 12, rotation: -0.035, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 11 / 24, rotation: -0.008, scaleY: 0.94, scaleX: 1.031),
    Keyframe(p: 6 / 12, rotation: 0.025, scaleY: 0.93, scaleX: 1.036),
    Keyframe(p: 13 / 24, rotation: 0.014, scaleY: 0.972, scaleX: 1.014),
    Keyframe(p: 7 / 12, rotation: 0.035, scaleY: 0.952, scaleX: 1.024),
    Keyframe(p: 5 / 8, rotation: 0.008, scaleY: 0.94, scaleX: 1.031),
    Keyframe(p: 8 / 12, rotation: -0.028, scaleY: 0.925, scaleX: 1.04),
    Keyframe(p: 17 / 24, rotation: -0.018, scaleY: 0.97, scaleX: 1.016),
    Keyframe(p: 9 / 12, rotation: -0.04, scaleY: 0.95, scaleX: 1.026),
    Keyframe(p: 19 / 24, rotation: -0.01, scaleY: 0.938, scaleX: 1.032),
    Keyframe(p: 10 / 12, rotation: 0.028, scaleY: 0.925, scaleX: 1.04),
    Keyframe(p: 7 / 8, rotation: 0.018, scaleY: 0.97, scaleX: 1.016),
    Keyframe(p: 11 / 12, rotation: 0.04, scaleY: 0.95, scaleX: 1.026),
    Keyframe(p: 23 / 24, rotation: 0.01, scaleY: 0.938, scaleX: 1.032),
  ...
  static const _danceArmUpperLKeys = [
    ...
    Keyframe(p: 1 / 12, rotation: 1.04),
    Keyframe(p: 2 / 12, rotation: 0.22),
    Keyframe(p: 3 / 12, rotation: 0.5),
    Keyframe(p: 4 / 12, rotation: 0.3),
    Keyframe(p: 5 / 12, rotation: 0.68),
    Keyframe(p: 6 / 12, rotation: 0.72),
    Keyframe(p: 7 / 12, rotation: 1.34),
    Keyframe(p: 8 / 12, rotation: 1.64),
    Keyframe(p: 17 / 24, rotation: 1.62),
    Keyframe(p: 9 / 12, rotation: 0.52),
    Keyframe(p: 10 / 12, rotation: 0.28),
    Keyframe(p: 11 / 12, rotation: 1.28),
    Keyframe(p: 1, rotation: 1.5),
  ];
  static const _danceArmLowerLKeys = [
    Keyframe(p: 0, rotation: 0.45),
    Keyframe(p: 1 / 24, rotation: 0.58),
    Keyframe(p: 1 / 12, rotation: 0.18),
    Keyframe(p: 5 / 48, rotation: 0.08),
    Keyframe(p: 2 / 12, rotation: -0.18),
    Keyframe(p: 5 / 24, rotation: -0.42),
    Keyframe(p: 3 / 12, rotation: -0.68),
    Keyframe(p: 13 / 48, rotation: -0.54),
    Keyframe(p: 4 / 12, rotation: -0.32),
    Keyframe(p: 3 / 8, rotation: -0.18),
    Keyframe(p: 5 / 12, rotation: -0.58),
    Keyframe(p: 7 / 16, rotation: -0.72),
    Keyframe(p: 6 / 12, rotation: 0.08),
    Keyframe(p: 13 / 24, rotation: 0.24),
    Keyframe(p: 7 / 12, rotation: 0.2),
    Keyframe(p: 29 / 48, rotation: 0.08),
    Keyframe(p: 8 / 12, rotation: -0.16),
    Keyframe(p: 17 / 24, rotation: -0.32),
    Keyframe(p: 9 / 12, rotation: -0.2),
    Keyframe(p: 19 / 24, rotation: -0.02),
    Keyframe(p: 10 / 12, rotation: -0.12),
    Keyframe(p: 7 / 8, rotation: 0.1),
    Keyframe(p: 11 / 12, rotation: 0.28),
    Keyframe(p: 15 / 16, rotation: 0.5),
    Keyframe(p: 1, rotation: 0.45),
  ];
  static const _danceArmUpperRKeys = [
    Keyframe(p: 0, rotation: -0.34),
    Keyframe(p: 1 / 12, rotation: -0.58),
    Keyframe(p: 2 / 12, rotation: -0.2),
    Keyframe(p: 3 / 12, rotation: -0.5),
    Keyframe(p: 4 / 12, rotation: -1.52),
    Keyframe(p: 5 / 12, rotation: -1.14),
    Keyframe(p: 6 / 12, rotation: -0.5),
    Keyframe(p: 7 / 12, rotation: 0.1),
    Keyframe(p: 8 / 12, rotation: -1.58),
    Keyframe(p: 17 / 24, rotation: -1.56),
    Keyframe(p: 9 / 12, rotation: -1.24),
    Keyframe(p: 10 / 12, rotation: -0.48),
    Keyframe(p: 11 / 12, rotation: -0.66),
    Keyframe(p: 1, rotation: -0.34),
  ];
  static const _danceArmLowerRKeys = [
    Keyframe(p: 0, rotation: 0.18),
    Keyframe(p: 1 / 24, rotation: 0.38),
    Keyframe(p: 1 / 12, rotation: 0.52),
    Keyframe(p: 5 / 48, rotation: 0.34),
    Keyframe(p: 2 / 12, rotation: 0.15),
    Keyframe(p: 5 / 24, rotation: 0.32),
    Keyframe(p: 3 / 12, rotation: 0.68),
    Keyframe(p: 13 / 48, rotation: 0.5),
    Keyframe(p: 4 / 12, rotation: -0.45),
    Keyframe(p: 3 / 8, rotation: -0.62),
    Keyframe(p: 5 / 12, rotation: -0.18),
    Keyframe(p: 7 / 16, rotation: -0.02),
    Keyframe(p: 6 / 12, rotation: 0.08),
    Keyframe(p: 13 / 24, rotation: 0.22),
    Keyframe(p: 7 / 12, rotation: -0.18),
    Keyframe(p: 29 / 48, rotation: -0.3),
    Keyframe(p: 8 / 12, rotation: 0.16),
    Keyframe(p: 17 / 24, rotation: 0.34),
    Keyframe(p: 9 / 12, rotation: -0.28),
    Keyframe(p: 19 / 24, rotation: -0.42),
    Keyframe(p: 10 / 12, rotation: 0.12),
    Keyframe(p: 7 / 8, rotation: 0.3),
    Keyframe(p: 11 / 12, rotation: 0.2),
  ...
  static Clip get dance => const Clip(
    ...
    duration: 6,
    contactSpans: [
      GroundSpan(CatBones.footL, 0, 2 / 12),
      GroundSpan(CatBones.footR, 2 / 12, 4 / 12),
      GroundSpan(CatBones.footL, 4 / 12, 6 / 12),
      GroundSpan(CatBones.footR, 6 / 12, 8 / 12),
      GroundSpan(CatBones.footL, 8 / 12, 10 / 12),
      GroundSpan(CatBones.footR, 10 / 12, 1),
    ],
