...
class CatClips {
    ...
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        ...
        CatBones.handR: [
          ...
          DanceIkTargetKey(4, x: 48.2, y: 21.8),
    ...
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        ...
        CatBones.footL: [
          ...
          DanceIkTargetKey(16, x: -44.2, y: 102.2),
        ],
        CatBones.footR: [
    ...
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        CatBones.handL: [
          ...
          DanceIkTargetKey(21, x: -63, y: 19),
          DanceIkTargetKey(22, x: -74.5, y: 15.6),
          DanceIkTargetKey(23, x: -80.2, y: 12.7),
        ],
        CatBones.handR: [
          DanceIkTargetKey(18, x: 72.8, y: 23.2),
          DanceIkTargetKey(19, x: 74.8, y: 18.4),
          DanceIkTargetKey(20, x: 78.2, y: 16.2),
          DanceIkTargetKey(21, x: 66.8, y: 20.2),
          DanceIkTargetKey(22, x: 84.4, y: 16),
          DanceIkTargetKey(23, x: 98.3, y: 10.2),
        ],
        CatBones.footL: [
          DanceIkTargetKey(18, x: -40.4, y: 102.2),
          DanceIkTargetKey(19, x: -52.4, y: 100.8),
          DanceIkTargetKey(20, x: -60.2, y: 97.6),
          DanceIkTargetKey(21, x: -44.2, y: 100.8),
          DanceIkTargetKey(22, x: -25.8, y: 102.5),
        ...
        CatBones.footR: [
          ...
          DanceIkTargetKey(16, x: -11.5, y: 100.2),
          DanceIkTargetKey(17, x: -12.7, y: 100.1),
          DanceIkTargetKey(18, x: -13.8, y: 100.2),
          DanceIkTargetKey(19, x: -15, y: 100.1),
          DanceIkTargetKey(20, x: -15.6, y: 100.2),
          DanceIkTargetKey(21, x: -14.4, y: 100.6),
          DanceIkTargetKey(22, x: -12.8, y: 101.6),
          DanceIkTargetKey(23, x: -10.8, y: 102.4),
        ],
      },
      jointKeys: {
        CatBones.armUpperL: [
        ...
        CatBones.footL: [
          ...
          DanceJointKey(19, rotation: 0.58),
          DanceJointKey(20, rotation: 0.34),
    ...
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        CatBones.footL: [
          ...
          DanceIkTargetKey(25, x: -39.8, y: 104.2),
          DanceIkTargetKey(26, x: -30.6, y: 105.1),
          DanceIkTargetKey(27, x: -21.4, y: 103.6),
        ],
      },
    ),
    DanceMoveSignature(
      ...
      ikTargetKeys: {
        ...
        CatBones.handR: [
          ...
          DanceIkTargetKey(31, x: 55.4, y: 30.8),
      ...
      .ikTargetChannel(
        _dancePhrase.mergeIkTargetKeys(
          baseKeys: const [
            ...
            DanceIkTargetKey(18, x: -5.8, y: 99.8),
            DanceIkTargetKey(19, x: -8.6, y: 99.6),
            DanceIkTargetKey(20, x: -13.4, y: 99.8),
            DanceIkTargetKey(21, x: -8.8, y: 100.5),
            DanceIkTargetKey(22, x: -5.2, y: 101.6),
            DanceIkTargetKey(23, x: -1.7, y: 102.4),
            DanceIkTargetKey(24, x: 3.4, y: 102.3),
            DanceIkTargetKey(25, x: 4.8, y: 102.8),
            DanceIkTargetKey(26, x: 4.1, y: 103.2),
            DanceIkTargetKey(27, x: 5.4, y: 103.6),
            DanceIkTargetKey(28, x: 10.8, y: 104.3),
  ...
  static const _danceBodyGrooveKeys = [
    ...
    DanceBodyKey(7, rootDx: -3, rootDy: 17.2, rootRotation: -0.001),
    DanceBodyKey(
      8,
      rootDx: 8,
      rootDy: 16.2,
            ...
            const [
              DanceIkTargetArc(
                ...
                controlPoints: [
                  ...
                  DanceIkTargetArcPoint(26, x: -55.6, y: 28),
      ...
      .mergeIkTargetKeys(
        baseKeys: [
          ...
          ...const [
            ...
            DanceIkTargetKey(24, x: 82.4, y: 18.8),
            DanceIkTargetKey(25, x: 78.8, y: 21.2),
            DanceIkTargetKey(26, x: 77.2, y: 21.4),
  ...
  static const _danceBackupLeftStyle = DanceRoleStyle(
    moveBodyAccents: [
      ...
      DanceMoveBodyAccent(
        moveName: 'lead Shaku pocket hit',
        offsetFrames: 2,
        // Delayed side answer: the lead lands the pocket first, then the
        // silver cat catches the next half-beat with opposite waist/shoulder.
        radiusFrames: 2,
        rootDx: -0.8,
        rootDy: 0.35,
        pelvisRotation: -0.055,
    ...
    ikTargetAccents: {
      CatBones.handR: [
        ...
        DanceIkTargetAccent(6, radiusFrames: 2, x: -9.4, y: -5.8),
  ...
  static const _danceBackupRightStyle = DanceRoleStyle(
    moveBodyAccents: [
      DanceMoveBodyAccent(
        moveName: 'lead Shaku pocket hit',
        offsetFrames: 1,
        // Dark cat answers earlier and smaller than the silver cat, so both
        // sides echo the lead without becoming a perfectly delayed duplicate.
        radiusFrames: 2,
        rootDx: 0.45,
        rootDy: 0.22,
        pelvisRotation: 0.04,
    ...
    ikTargetAccents: {
      CatBones.handL: [
        DanceIkTargetAccent(5, radiusFrames: 2, x: 8.2, y: -4.8),
