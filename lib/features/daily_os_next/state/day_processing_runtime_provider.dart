...
final Provider<DayAudioSpoolRecoveryService>
dayAudioSpoolRecoveryServiceProvider = Provider((ref) {
  return DayAudioSpoolRecoveryService(
    journalDb: getIt(),
...
final Provider<DayProcessingRuntime> dayProcessingRuntimeProvider = Provider((
  ...
  final spoolRecovery = ref.watch(dayAudioSpoolRecoveryServiceProvider);
  final runtime = DayProcessingRuntime(
    repository: outbox,
    drain: processor.drain,
    repair: () async {
      await spoolRecovery.recoverAll();
