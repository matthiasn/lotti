...
//
// Historical note: the `Test*` class prefix predates the promotion of these
// factories from `test/helpers/entity_factories.dart` into the demo feature.
// The names are kept so the ~30 existing test consumers (reached via the
// `test/helpers/entity_factories.dart` re-export shim) compile unchanged.
