/// Filled counterparts for the icons that carry an on/off state.
///
...
abstract final class LottiIconsFilled {
  ...
  /// Filled counterpart of `LottiIcons.radioUnselected` — a chosen dot.
  ...
  static const IconData star = IconData(0xea07, fontFamily: _family);
}
