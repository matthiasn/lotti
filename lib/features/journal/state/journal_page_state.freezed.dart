...
mixin _$JournalPageState {
 ...
 String get match; Set<DisplayFilter> get filters; bool get showPrivateEntries; bool get showTasks; List<String> get selectedEntryTypes;/// Entry types currently permitted by active feature flags (events, habits,
...
@useResult
$Res call({
 String match, Set<DisplayFilter> filters, bool showPrivateEntries, bool showTasks, List<String> selectedEntryTypes, List<String> allowedEntryTypes, Set<String> fullTextMatches,@JsonKey(includeFromJson: false, includeToJson: false) PagingController<int, JournalEntity>? pagingController, List<String> taskStatuses, Set<String> selectedTaskStatuses, Set<String> selectedCategoryIds, Set<String> selectedProjectIds, Set<String> selectedLabelIds, Set<String> selectedPriorities, TaskSortOption sortOption, bool showCreationDate, bool showDueDate, bool showCoverArt, bool showProjectsHeader, SearchMode searchMode, bool showDistances, AgentAssignmentFilter agentAssignmentFilter, bool enableVectorSearch, bool enableProjects, bool vectorSearchInFlight, Duration? vectorSearchElapsed, int vectorSearchResultCount, Map<String, double> vectorSearchDistances
});
...
as List<String>,allowedEntryTypes: null == allowedEntryTypes ? _self.allowedEntryTypes : allowedEntryTypes // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String match,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  List<String> allowedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
return $default(_that.match,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.allowedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedProjectIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.showProjectsHeader,_that.searchMode,_that.showDistances,_that.agentAssignmentFilter,_that.enableVectorSearch,_that.enableProjects,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String match,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  List<String> allowedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)  $default,) {final _that = this;
switch (_that) {
case _JournalPageState():
return $default(_that.match,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.allowedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedProjectIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.showProjectsHeader,_that.searchMode,_that.showDistances,_that.agentAssignmentFilter,_that.enableVectorSearch,_that.enableProjects,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String match,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  List<String> allowedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
return $default(_that.match,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.allowedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedProjectIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.showProjectsHeader,_that.searchMode,_that.showDistances,_that.agentAssignmentFilter,_that.enableVectorSearch,_that.enableProjects,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  return null;
...
class _JournalPageState implements JournalPageState {
  const _JournalPageState({this.match = '', final  Set<DisplayFilter> filters = const <DisplayFilter>{}, this.showPrivateEntries = false, this.showTasks = false, final  List<String> selectedEntryTypes = const [], final  List<String> allowedEntryTypes = const [], final  Set<String> fullTextMatches = const <String>{}, @JsonKey(includeFromJson: false, includeToJson: false) this.pagingController, final  List<String> taskStatuses = const [], final  Set<String> selectedTaskStatuses = const <String>{}, final  Set<String> selectedCategoryIds = const <String>{}, final  Set<String> selectedProjectIds = const <String>{}, final  Set<String> selectedLabelIds = const <String>{}, final  Set<String> selectedPriorities = const <String>{}, this.sortOption = TaskSortOption.byPriority, this.showCreationDate = false, this.showDueDate = true, this.showCoverArt = true, this.showProjectsHeader = true, this.searchMode = SearchMode.fullText, this.showDistances = false, this.agentAssignmentFilter = AgentAssignmentFilter.all, this.enableVectorSearch = false, this.enableProjects = false, this.vectorSearchInFlight = false, this.vectorSearchElapsed, this.vectorSearchResultCount = 0, final  Map<String, double> vectorSearchDistances = const <String, double>{}}): _filters = filters,_selectedEntryTypes = selectedEntryTypes,_allowedEntryTypes = allowedEntryTypes,_fullTextMatches = fullTextMatches,_taskStatuses = taskStatuses,_selectedTaskStatuses = selectedTaskStatuses,_selectedCategoryIds = selectedCategoryIds,_selectedProjectIds = selectedProjectIds,_selectedLabelIds = selectedLabelIds,_selectedPriorities = selectedPriorities,_vectorSearchDistances = vectorSearchDistances;
...
/// means the user deselected an allowed type. Distinct from a flag-hidden
/// type, which never appears here at all.
 final  List<String> _allowedEntryTypes;
/// Entry types currently permitted by active feature flags (events, habits,
/// dashboards). The un-narrowed selection equals this set; a strict subset
/// means the user deselected an allowed type. Distinct from a flag-hidden
/// type, which never appears here at all.
@override@JsonKey() List<String> get allowedEntryTypes {
  if (_allowedEntryTypes is EqualUnmodifiableListView) return _allowedEntryTypes;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_allowedEntryTypes);
}
...
/// Create a copy of JournalPageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? match = null,Object? filters = null,Object? showPrivateEntries = null,Object? showTasks = null,Object? selectedEntryTypes = null,Object? allowedEntryTypes = null,Object? fullTextMatches = null,Object? pagingController = freezed,Object? taskStatuses = null,Object? selectedTaskStatuses = null,Object? selectedCategoryIds = null,Object? selectedProjectIds = null,Object? selectedLabelIds = null,Object? selectedPriorities = null,Object? sortOption = null,Object? showCreationDate = null,Object? showDueDate = null,Object? showCoverArt = null,Object? showProjectsHeader = null,Object? searchMode = null,Object? showDistances = null,Object? agentAssignmentFilter = null,Object? enableVectorSearch = null,Object? enableProjects = null,Object? vectorSearchInFlight = null,Object? vectorSearchElapsed = freezed,Object? vectorSearchResultCount = null,Object? vectorSearchDistances = null,}) {
...
as List<String>,allowedEntryTypes: null == allowedEntryTypes ? _self._allowedEntryTypes : allowedEntryTypes // ignore: cast_nullable_to_non_nullable
