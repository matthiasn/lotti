...
@override
int get hashCode => Object.hashAll([runtimeType,match,const DeepCollectionEquality().hash(tagIds),const DeepCollectionEquality().hash(filters),showPrivateEntries,showTasks,const DeepCollectionEquality().hash(selectedEntryTypes),const DeepCollectionEquality().hash(fullTextMatches),pagingController,const DeepCollectionEquality().hash(taskStatuses),const DeepCollectionEquality().hash(selectedTaskStatuses),const DeepCollectionEquality().hash(selectedCategoryIds),const DeepCollectionEquality().hash(selectedLabelIds),const DeepCollectionEquality().hash(selectedPriorities),sortOption,showCreationDate,showDueDate,showCoverArt,searchMode,enableVectorSearch,vectorSearchInFlight,vectorSearchElapsed,vectorSearchResultCount,const DeepCollectionEquality().hash(vectorSearchDistances)]);
...
@useResult
$Res call({
 String match, Set<String> tagIds, Set<DisplayFilter> filters, bool showPrivateEntries, bool showTasks, List<String> selectedEntryTypes, Set<String> fullTextMatches,@JsonKey(includeFromJson: false, includeToJson: false) PagingController<int, JournalEntity>? pagingController, List<String> taskStatuses, Set<String> selectedTaskStatuses, Set<String> selectedCategoryIds, Set<String> selectedLabelIds, Set<String> selectedPriorities, TaskSortOption sortOption, bool showCreationDate, bool showDueDate, bool showCoverArt, SearchMode searchMode, bool enableVectorSearch, bool vectorSearchInFlight, Duration? vectorSearchElapsed, int vectorSearchResultCount, Map<String, double> vectorSearchDistances
});
...
as SearchMode,enableVectorSearch: null == enableVectorSearch ? _self.enableVectorSearch : enableVectorSearch // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  SearchMode searchMode,  bool enableVectorSearch,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
return $default(_that.match,_that.tagIds,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.searchMode,_that.enableVectorSearch,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  SearchMode searchMode,  bool enableVectorSearch,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)  $default,) {final _that = this;
switch (_that) {
case _JournalPageState():
return $default(_that.match,_that.tagIds,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.searchMode,_that.enableVectorSearch,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  SearchMode searchMode,  bool enableVectorSearch,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
return $default(_that.match,_that.tagIds,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.searchMode,_that.enableVectorSearch,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  return null;
...
mixin _$TasksFilter {
 ...
 Set<String> get selectedCategoryIds; Set<String> get selectedTaskStatuses; Set<String> get selectedLabelIds; Set<String> get selectedPriorities; TaskSortOption get sortOption; bool get showCreationDate; bool get showDueDate; bool get showCoverArt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TasksFilter&&const DeepCollectionEquality().equals(other.selectedCategoryIds, selectedCategoryIds)&&const DeepCollectionEquality().equals(other.selectedTaskStatuses, selectedTaskStatuses)&&const DeepCollectionEquality().equals(other.selectedLabelIds, selectedLabelIds)&&const DeepCollectionEquality().equals(other.selectedPriorities, selectedPriorities)&&(identical(other.sortOption, sortOption) || other.sortOption == sortOption)&&(identical(other.showCreationDate, showCreationDate) || other.showCreationDate == showCreationDate)&&(identical(other.showDueDate, showDueDate) || other.showDueDate == showDueDate)&&(identical(other.showCoverArt, showCoverArt) || other.showCoverArt == showCoverArt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(selectedCategoryIds),const DeepCollectionEquality().hash(selectedTaskStatuses),const DeepCollectionEquality().hash(selectedLabelIds),const DeepCollectionEquality().hash(selectedPriorities),sortOption,showCreationDate,showDueDate,showCoverArt);

@override
String toString() {
  return 'TasksFilter(selectedCategoryIds: $selectedCategoryIds, selectedTaskStatuses: $selectedTaskStatuses, selectedLabelIds: $selectedLabelIds, selectedPriorities: $selectedPriorities, sortOption: $sortOption, showCreationDate: $showCreationDate, showDueDate: $showDueDate, showCoverArt: $showCoverArt)';
}
...
@useResult
$Res call({
 Set<String> selectedCategoryIds, Set<String> selectedTaskStatuses, Set<String> selectedLabelIds, Set<String> selectedPriorities, TaskSortOption sortOption, bool showCreationDate, bool showDueDate, bool showCoverArt
});
...
/// Create a copy of TasksFilter
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedCategoryIds = null,Object? selectedTaskStatuses = null,Object? selectedLabelIds = null,Object? selectedPriorities = null,Object? sortOption = null,Object? showCreationDate = null,Object? showDueDate = null,Object? showCoverArt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Set<String> selectedCategoryIds,  Set<String> selectedTaskStatuses,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TasksFilter() when $default != null:
return $default(_that.selectedCategoryIds,_that.selectedTaskStatuses,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Set<String> selectedCategoryIds,  Set<String> selectedTaskStatuses,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt)  $default,) {final _that = this;
switch (_that) {
case _TasksFilter():
return $default(_that.selectedCategoryIds,_that.selectedTaskStatuses,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Set<String> selectedCategoryIds,  Set<String> selectedTaskStatuses,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt)?  $default,) {final _that = this;
switch (_that) {
case _TasksFilter() when $default != null:
return $default(_that.selectedCategoryIds,_that.selectedTaskStatuses,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt);case _:
  return null;
...
/// Create a copy of TasksFilter
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedCategoryIds = null,Object? selectedTaskStatuses = null,Object? selectedLabelIds = null,Object? selectedPriorities = null,Object? sortOption = null,Object? showCreationDate = null,Object? showDueDate = null,Object? showCoverArt = null,}) {
