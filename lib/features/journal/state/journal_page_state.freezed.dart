...
@useResult
$Res call({
 String match, Set<String> tagIds, Set<DisplayFilter> filters, bool showPrivateEntries, bool showTasks, List<String> selectedEntryTypes, Set<String> fullTextMatches,@JsonKey(includeFromJson: false, includeToJson: false) PagingController<int, JournalEntity>? pagingController, List<String> taskStatuses, Set<String> selectedTaskStatuses, Set<String> selectedCategoryIds, Set<String> selectedProjectIds, Set<String> selectedLabelIds, Set<String> selectedPriorities, TaskSortOption sortOption, bool showCreationDate, bool showDueDate, bool showCoverArt, bool showProjectsHeader, SearchMode searchMode, bool showDistances, AgentAssignmentFilter agentAssignmentFilter, bool enableVectorSearch, bool enableProjects, bool vectorSearchInFlight, Duration? vectorSearchElapsed, int vectorSearchResultCount, Map<String, double> vectorSearchDistances
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)  $default,) {final _that = this;
switch (_that) {
case _JournalPageState():
return $default(_that.match,_that.tagIds,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedProjectIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.showProjectsHeader,_that.searchMode,_that.showDistances,_that.agentAssignmentFilter,_that.enableVectorSearch,_that.enableProjects,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String match,  Set<String> tagIds,  Set<DisplayFilter> filters,  bool showPrivateEntries,  bool showTasks,  List<String> selectedEntryTypes,  Set<String> fullTextMatches, @JsonKey(includeFromJson: false, includeToJson: false)  PagingController<int, JournalEntity>? pagingController,  List<String> taskStatuses,  Set<String> selectedTaskStatuses,  Set<String> selectedCategoryIds,  Set<String> selectedProjectIds,  Set<String> selectedLabelIds,  Set<String> selectedPriorities,  TaskSortOption sortOption,  bool showCreationDate,  bool showDueDate,  bool showCoverArt,  bool showProjectsHeader,  SearchMode searchMode,  bool showDistances,  AgentAssignmentFilter agentAssignmentFilter,  bool enableVectorSearch,  bool enableProjects,  bool vectorSearchInFlight,  Duration? vectorSearchElapsed,  int vectorSearchResultCount,  Map<String, double> vectorSearchDistances)?  $default,) {final _that = this;
switch (_that) {
case _JournalPageState() when $default != null:
return $default(_that.match,_that.tagIds,_that.filters,_that.showPrivateEntries,_that.showTasks,_that.selectedEntryTypes,_that.fullTextMatches,_that.pagingController,_that.taskStatuses,_that.selectedTaskStatuses,_that.selectedCategoryIds,_that.selectedProjectIds,_that.selectedLabelIds,_that.selectedPriorities,_that.sortOption,_that.showCreationDate,_that.showDueDate,_that.showCoverArt,_that.showProjectsHeader,_that.searchMode,_that.showDistances,_that.agentAssignmentFilter,_that.enableVectorSearch,_that.enableProjects,_that.vectorSearchInFlight,_that.vectorSearchElapsed,_that.vectorSearchResultCount,_that.vectorSearchDistances);case _:
  return null;
