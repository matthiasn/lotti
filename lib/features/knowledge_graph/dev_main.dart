/// Standalone dev entrypoint to preview the knowledge-graph explorer
/// interactively
/// (pan / zoom / tap), without wiring it into the real app routes.
///
/// Run it directly, e.g.:
///   fvm flutter run -t lib/features/knowledge_graph/dev_main.dart -d macos
///   fvm flutter run -t lib/features/knowledge_graph/dev_main.dart -d linux
///   fvm flutter run -t lib/features/knowledge_graph/dev_main.dart -d DEVICE
///
