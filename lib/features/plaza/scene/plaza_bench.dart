...
/// `PLAZA_BENCH=1`: auto-walks the synthetic 300-task district from home
/// down the street through a fixed set of LOD budgets, printing an fps
/// table (`PLAZA_BENCH result` lines) to stdout.
class PlazaBench {
