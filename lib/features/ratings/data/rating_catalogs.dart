...
typedef CatalogFactory =
    List<RatingQuestion> Function(
...
List<RatingQuestion> sessionRatingCatalog(AppLocalizations messages) => [
  RatingQuestion(
    ...
    description:
        'Measures subjective productivity during the work '
  ...
  RatingQuestion(
    ...
    description:
        'Measures depth of focus during the work session. '
  ...
  RatingQuestion(
    ...
    description:
        'Challenge-skill balance (flow state indicator). '
