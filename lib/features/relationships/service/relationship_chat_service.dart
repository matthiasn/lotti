...
class RelationshipChatService {
  ...
  ///
  /// Throws [RelationshipChatTurnException] when the wake fails — including
  /// when the orchestrator shuts down first, which ends the completion
  /// stream without an event for this run. The caller holds the composer
  /// disabled for the duration of this future, so it must never be one that
  ...
  Future<void> retryMessage({
    ...
    final subscription = _orchestrator.runCompletions.listen(
      (event) {
