              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: colorScheme.surfaceContainerHighest
                      .withValues(alpha: ModalTheme.progressCardAlpha),
                  borderRadius:
                      BorderRadius.circular(ModalTheme.progressCardRadius),
                  boxShadow: [
                    BoxShadow(
                      color: colorScheme.primary
                          .withValues(alpha: AppTheme.alphaPrimary),
                      blurRadius: ModalTheme.progressCardShadowBlur,
                      offset: ModalTheme.progressCardShadowOffset,
                    ),
                  ],
                ),
