...
/// Agent entity/link/payload enqueue helpers of [OutboxService] plus the
/// sent-record bookkeeping. Split from [OutboxEnqueueDispatch] for file size;
/// all members are library-private, so no mock delegators are required.
extension OutboxEnqueueDispatchAgents on OutboxService {
