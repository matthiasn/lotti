...
class TitleDiff {
  ...
  /// and the picker UI does not need to render at all. Two empty
  /// titles also count as identical — they tokenize to empty segment
  /// lists rather than a single common segment, but the caller should
  /// still skip the picker.
