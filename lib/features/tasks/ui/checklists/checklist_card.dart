    ...
    return Material(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Body (animated) ───────────────────────────────────────────────
          // Only build _Body when expanded to avoid hidden provider work
          // from collapsed checklists (AnimatedCrossFade keeps both alive).
          AnimatedSize(
            ...
            child: showBody
                ? _Body(
                    ...
                    onCreateItem: (title) async {
                      if (_isCreatingItem) return false;
            ...
            child: ConstrainedBox(
              ...
              child: Row(
                children: [
                  ...
                  // Chevron — InkWell for keyboard/screen-reader access.
                  Semantics(
                    button: true,
                    label: context.messages.checklistToggleExpansion,
...
class _AddItemField extends StatefulWidget {
  ...
  /// Returns true if the item was created successfully; the field clears only
  /// on success so the user's draft is preserved on failure.
