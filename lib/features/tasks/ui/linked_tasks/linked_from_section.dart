...
/// Section displaying tasks that link TO the current task (incoming links).
///
/// Minimal design: just a small label and a list of text links.
class LinkedFromSection extends ConsumerWidget {
  const LinkedFromSection({
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text(
              context.messages.linkedFromLabel,
              style: context.textTheme.labelSmall?.copyWith(
                color: color,
                letterSpacing: 0.5,
                fontSize: 10,
