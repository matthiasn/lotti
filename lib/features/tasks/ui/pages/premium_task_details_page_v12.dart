...
class PremiumTaskDetailsPageV12 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV12({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV12> createState() =>
      _PremiumTaskDetailsPageV12State();
}

class _PremiumTaskDetailsPageV12State
    extends ConsumerState<PremiumTaskDetailsPageV12> {
  ...
  void _toggleSection(String key) {
    setState(() {
      _collapsedStates[key] = !(_collapsedStates[key] ?? false);
    });
  }
        ...
        children: [
          CustomScrollView(
            ...
            slivers: [
              ...
              // Task Header Section - Sticky
              SliverStickyHeader(
                header: _TaskHeaderBuilder(
                  task: task,
                  isCollapsed: _collapsedStates['task-header'] ?? false,
                  onToggle: () => _toggleSection('task-header'),
                ),
                sliver: SliverToBoxAdapter(
                  child: AnimatedContainer(
                    duration: const Duration(milliseconds: 300),
                    height: _collapsedStates['task-header'] ?? false ? 0 : null,
                    child: ColoredBox(
                      color: context.colorScheme.surface,
                      child: _collapsedStates['task-header'] ?? false
                          ? const SizedBox.shrink()
                          : _ExpandedTaskContent(task: task),
                    ),
                  ),
                ),
              ),

              // AI Summary Section - Sticky
              SliverStickyHeader(
                header: _SectionHeaderBuilder(
                  icon: MdiIcons.robotOutline,
                  title: 'AI Task Summary',
                  isCollapsed: _collapsedStates['ai-summary'] ?? false,
                  onToggle: () => _toggleSection('ai-summary'),
                ),
                sliver: SliverToBoxAdapter(
                  child: AnimatedContainer(
                    duration: const Duration(milliseconds: 300),
                    height: _collapsedStates['ai-summary'] ?? false ? 0 : null,
                    child: Container(
                      color: context.colorScheme.surface,
                      padding: const EdgeInsets.all(16),
                      child: _collapsedStates['ai-summary'] ?? false
                          ? const SizedBox.shrink()
              ...
              // Checklists Section - Sticky
              SliverStickyHeader(
                header: _ChecklistsHeaderBuilder(
                  task: task,
                  isCollapsed: _collapsedStates['checklists'] ?? false,
                  onToggle: () => _toggleSection('checklists'),
                ),
                sliver: SliverToBoxAdapter(
                  child: AnimatedContainer(
                    duration: const Duration(milliseconds: 300),
                    height: _collapsedStates['checklists'] ?? false ? 0 : null,
                    child: Container(
                      color: context.colorScheme.surface,
                      padding: const EdgeInsets.all(16),
                      child: _collapsedStates['checklists'] ?? false
                          ? const SizedBox.shrink()
