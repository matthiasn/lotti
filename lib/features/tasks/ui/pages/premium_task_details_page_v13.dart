...
class PremiumTaskDetailsPageV13 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV13({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV13> createState() =>
      _PremiumTaskDetailsPageV13State();
}

class _PremiumTaskDetailsPageV13State
    extends ConsumerState<PremiumTaskDetailsPageV13> {
  ...
  void _measureSectionHeights() {
    ...
    _checklistsScrollThreshold = _aiSummaryScrollThreshold + aiHeight;

    // Set positions for scrolling to sections
    // Account for sticky header heights when scrolling back
    _taskSectionPosition = 0; // Top of scroll view
    _aiSectionPosition = _taskHeaderScrollThreshold +
        taskHeight -
        60; // Minus task header height
    _checklistsSectionPosition =
        _aiSummaryScrollThreshold + aiHeight - 60 - 48; // Minus both headers
  }
    ...
    return Scaffold(
      ...
      body: NotificationListener<ScrollNotification>(
        onNotification: (notification) {
          // Don't consume the notification, let it propagate
          return false;
        },
        child: Stack(
          children: [
