...
class PremiumTaskDetailsPageV15 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV15({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV15> createState() =>
      _PremiumTaskDetailsPageV15State();
}
...
class _PremiumTaskDetailsPageV15State
    extends ConsumerState<PremiumTaskDetailsPageV15> {
  ...
  void _updateCollapseStates() {
    ...
    final newTaskCollapsed = offset > 10;
    final newAiCollapsed = offset > 350;
    final newChecklistCollapsed = offset > 650;
    ...
    if (_isTaskHeaderCollapsed != newTaskCollapsed ||
      ...
      setState(() {
        ...
        // Debug log
        debugPrint('STATE UPDATE - Offset: $offset, Task: $_isTaskHeaderCollapsed, AI: $_isAiSummaryCollapsed, Checklist: $_isChecklistsCollapsed');
      });
    }
  }
  ...
  void _scrollToSection(int sectionIndex) {
    _listController.animateToItem(
      ...
      alignment: 0, // Align to top of viewport
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('BUILD CALLED - Task: $_isTaskHeaderCollapsed, AI: $_isAiSummaryCollapsed, Checklist: $_isChecklistsCollapsed');
    ...
    final linkedEntriesProvider = linkedEntriesControllerProvider(id: task.meta.id);
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            ...
            itemBuilder: (context, index) {
              switch (index) {
                ...
                default:
                  ...
                  final entryIndex = index - _SectionIndices.linkedEntriesHeader - 1;
            ...
            itemCount: _SectionIndices.linkedEntriesHeader + 1 + linkedEntries.length + 1, // +1 for bottom padding
            ),
          ),
                ...
                children: [
                  ...
                  if (_isTaskHeaderCollapsed)
                    Container(
                      ...
                      child: const Center(
                        child: Text(
                          'TASK HEADER SHOULD BE VISIBLE HERE',
          ...
          Positioned(
            ...
            child: IgnorePointer(
              child: Container(
                ...
                child: Text(
                  'Scroll: ${_scrollController.hasClients ? _scrollController.offset.toStringAsFixed(0) : 0} - Task: $_isTaskHeaderCollapsed, AI: $_isAiSummaryCollapsed, Checklist: $_isChecklistsCollapsed',
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Offset: ${_scrollController.hasClients ? _scrollController.offset.toStringAsFixed(0) : "0"}',
                  ...
                  Text(
                    'Task: $_isTaskHeaderCollapsed, AI: $_isAiSummaryCollapsed, Checklist: $_isChecklistsCollapsed',
                    style: const TextStyle(
                      color: Colors.black,
                      fontSize: 12,
                      fontWeight: FontWeight.bold,
...
class _TaskHeaderBuilder extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentRecording = ref.watch(
