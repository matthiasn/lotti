...
class PremiumTaskDetailsPageV6 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV6({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV6> createState() =>
      _PremiumTaskDetailsPageV6State();
}

class _PremiumTaskDetailsPageV6State
    extends ConsumerState<PremiumTaskDetailsPageV6> {
  ...
  bool _isChecklistsExpanded = true;
            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: _ChecklistsSection(
                  task: task,
                  isExpanded: _isChecklistsExpanded,
                  onToggle: () => setState(
                      () => _isChecklistsExpanded = !_isChecklistsExpanded),
                ),
              ),
