...
class PremiumTaskDetailsPageV8 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV8({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV8> createState() =>
      _PremiumTaskDetailsPageV8State();
}

class _PremiumTaskDetailsPageV8State
    extends ConsumerState<PremiumTaskDetailsPageV8> {
        ...
        children: [
          CustomScrollView(
            ...
            slivers: [
              ...
              // Task Header Section - Collapsible
              SliverAppBar(
                ...
                flexibleSpace: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return _TaskHeaderFlexibleSpace(
                      task: task,
              ...
              SliverAppBar(
                ...
                flexibleSpace: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    const completedItems = 0; // TODO: Calculate actual
...
// Task Header Flexible Space
class _TaskHeaderFlexibleSpace extends ConsumerWidget {
  const _TaskHeaderFlexibleSpace({
    required this.task,
