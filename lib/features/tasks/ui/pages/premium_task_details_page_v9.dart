...
class PremiumTaskDetailsPageV9 extends ConsumerStatefulWidget {
  const PremiumTaskDetailsPageV9({
  ...
  @override
  ConsumerState<PremiumTaskDetailsPageV9> createState() =>
      _PremiumTaskDetailsPageV9State();
}

class _PremiumTaskDetailsPageV9State
    extends ConsumerState<PremiumTaskDetailsPageV9> {
        ...
        children: [
          CustomScrollView(
            ...
            slivers: [
              ...
              // Task Header Section with sticky collapsed view
              MultiSliver(
                pushPinnedChildren: true,
                children: [
                  // Collapsed header - always visible when scrolled
                  SliverPinnedHeader(
              ...
              // AI Summary Section with sticky header
              MultiSliver(
                pushPinnedChildren: true,
                children: [
                  // Sticky header
              ...
              // Checklists Section with sticky header
              MultiSliver(
                pushPinnedChildren: true,
                children: [
                  // Sticky header
...
// Collapsed task header - always visible when scrolled
