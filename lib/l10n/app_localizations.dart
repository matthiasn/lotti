...
abstract class AppLocalizations {
  ...
  /// No description provided for @addActionAddMeasurable.
  ///
  /// In en, this message translates to:
  /// **'Measurable'**
  String get addActionAddMeasurable;
  ...
  /// No description provided for @addActionAddSurvey.
  ///
  /// In en, this message translates to:
  /// **'Fill Survey'**
  String get addActionAddSurvey;
  ...
  /// No description provided for @addMeasurementNoneDefined.
  ///
  /// In en, this message translates to:
  /// **'Add Measurable Data Type'**
  String get addMeasurementNoneDefined;
  ...
  /// No description provided for @aiAssistantCreateChecklist.
  ///
  /// In en, this message translates to:
  /// **'Create checklist items'**
  String get aiAssistantCreateChecklist;

  /// No description provided for @aiAssistantRunPrompt.
  ///
  /// In en, this message translates to:
  /// **'Ask Llama3'**
  String get aiAssistantRunPrompt;
  ...
  /// No description provided for @aiConfigCategoryFieldLabel.
  ///
  /// In en, this message translates to:
  /// **'Category (Optional)'**
  String get aiConfigCategoryFieldLabel;
  ...
  /// No description provided for @aiConfigDefaultVariablesFieldLabel.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aiConfigListPromptTemplateSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aiConfigModelFieldLabel.
  ///
  /// In en, this message translates to:
  /// **'Model'**
  String get aiConfigModelFieldLabel;

  /// No description provided for @aiConfigModelLoadError.
  ///
  /// In en, this message translates to:
  /// **'Could not load model details.'**
  String get aiConfigModelLoadError;
  ...
  /// No description provided for @aiConfigModelSupportsReasoning.
  ///
  /// In en, this message translates to:
  /// **'Supports reasoning'**
  String get aiConfigModelSupportsReasoning;
  ...
  /// No description provided for @aiConfigSelectModelModalTitle.
  ///
  /// In en, this message translates to:
  /// **'Select AI Model'**
  String get aiConfigSelectModelModalTitle;
  ...
  /// No description provided for @aiConfigTemplateEmptyError.
  ///
  /// In en, this message translates to:
  /// **'Template cannot be empty'**
  String get aiConfigTemplateEmptyError;
  ...
  /// No description provided for @aiTaskNoSummaryTitle.
  ///
  /// In en, this message translates to:
  /// **'No AI Task Summary created yet'**
  ...
  /// No description provided for @apiKeyFormApiKeyError.
  ///
  /// In en, this message translates to:
  /// **'API key cannot be empty'**
  String get apiKeyFormApiKeyError;

  /// No description provided for @apiKeyFormApiKeyLabel.
  ///
  /// In en, this message translates to:
  /// **'API Key'**
  String get apiKeyFormApiKeyLabel;

  /// No description provided for @apiKeyFormBaseUrlError.
  ///
  /// In en, this message translates to:
  /// **'Please enter a valid URL'**
  String get apiKeyFormBaseUrlError;

  /// No description provided for @apiKeyFormBaseUrlLabel.
  ///
  /// In en, this message translates to:
  /// **'Base URL'**
  String get apiKeyFormBaseUrlLabel;

  /// No description provided for @apiKeyFormCommentLabel.
  ///
  /// In en, this message translates to:
  /// **'Comment (Optional)'**
  String get apiKeyFormCommentLabel;
  ...
  /// No description provided for @apiKeyFormNameError.
  ///
  /// In en, this message translates to:
  /// **'Name must be at least 3 characters'**
  String get apiKeyFormNameError;

  /// No description provided for @apiKeyFormNameLabel.
  ///
  /// In en, this message translates to:
  /// **'Name'**
  String get apiKeyFormNameLabel;

  /// No description provided for @apiKeyFormSaveError.
  ///
  /// In en, this message translates to:
  /// **'Failed to save API key configuration'**
  String get apiKeyFormSaveError;

  /// No description provided for @apiKeyFormShowApiKey.
  ///
  /// In en, this message translates to:
  /// **'Show API Key'**
  String get apiKeyFormShowApiKey;
  ...
  /// No description provided for @configInvalidCert.
  ///
  /// In en, this message translates to:
  /// **'Allow invalid SSL certificate?'**
  String get configInvalidCert;
  ...
  /// No description provided for @dashboardAddStoryButton.
  ///
  /// In en, this message translates to:
  /// **'Story/Time Charts'**
  String get dashboardAddStoryButton;

  /// No description provided for @dashboardAddStoryTitle.
  ///
  /// In en, this message translates to:
  /// **'Story/Time Charts'**
  String get dashboardAddStoryTitle;
  ...
  /// No description provided for @dashboardReviewTimeLabel.
  ///
  /// In en, this message translates to:
  /// **'Daily Review Time:'**
  String get dashboardReviewTimeLabel;

  /// No description provided for @dashboardSaveLabel.
  ///
  /// In en, this message translates to:
  /// **'Save'**
  String get dashboardSaveLabel;

  /// No description provided for @dashboardsEmptyHint.
  ///
  /// In en, this message translates to:
  /// **'Nothing to see here yet, please create a new Dashboard in Settings, Dashboard Management. \n\nThe cogs button above will take you there directly.'**
  String get dashboardsEmptyHint;

  /// No description provided for @dashboardsHowToHint.
  ///
  /// In en, this message translates to:
  /// **'How to use Lotti'**
  String get dashboardsHowToHint;

  /// No description provided for @dashboardsLoadingHint.
  ///
  /// In en, this message translates to:
  /// **'Loading...'**
  String get dashboardsLoadingHint;
  ...
  /// No description provided for @fileInputTypeAll.
  ///
  /// In en, this message translates to:
  /// **'All files'**
  String get fileInputTypeAll;

  /// No description provided for @fileInputTypeAudio.
  ///
  /// In en, this message translates to:
  /// **'Audio files'**
  String get fileInputTypeAudio;
  ...
  /// No description provided for @habitActiveUntilLabel.
  ///
  /// In en, this message translates to:
  /// **'Active until'**
  String get habitActiveUntilLabel;
  ...
  /// No description provided for @habitsLongerStreaksEmptyHeader.
  ///
  /// In en, this message translates to:
  /// **'No week-long streaks at the moment'**
  String get habitsLongerStreaksEmptyHeader;

  /// No description provided for @habitsLongerStreaksHeader.
  ///
  /// In en, this message translates to:
  /// **'Week-long streaks (or longer)'**
  ...
  /// No description provided for @habitsShortStreaksEmptyHeader.
  ///
  /// In en, this message translates to:
  /// **'No three day streaks at the moment'**
  String get habitsShortStreaksEmptyHeader;

  /// No description provided for @habitsShortStreaksHeader.
  ///
  /// In en, this message translates to:
  /// **'Three day streaks (or longer)'**
  String get habitsShortStreaksHeader;
  ...
  /// No description provided for @journalDateSaveHint.
  ///
  /// In en, this message translates to:
  /// **'Save entry'**
  String get journalDateSaveHint;
  ...
  /// No description provided for @journalHeaderContract.
  ///
  /// In en, this message translates to:
  /// **'Show less'**
  String get journalHeaderContract;

  /// No description provided for @journalHeaderExpand.
  ///
  /// In en, this message translates to:
  /// **'Show all'**
  String get journalHeaderExpand;
  ...
  /// No description provided for @journalToolbarSaveHint.
  ///
  /// In en, this message translates to:
  /// **'Save entry'**
  String get journalToolbarSaveHint;
  ...
  /// No description provided for @journalUnlinkText.
  ///
  /// In en, this message translates to:
  /// **'Unlink entry'**
  String get journalUnlinkText;

  /// No description provided for @maintenanceAssignCategoriesToChecklists.
  ///
  /// In en, this message translates to:
  /// **'Assign categories to checklists'**
  String get maintenanceAssignCategoriesToChecklists;

  /// No description provided for @maintenanceAssignCategoriesToLinked.
  ///
  /// In en, this message translates to:
  /// **'Assign categories to entries linked from entries with categories'**
  String get maintenanceAssignCategoriesToLinked;

  /// No description provided for @maintenanceAssignCategoriesToLinkedFromTasks.
  ///
  /// In en, this message translates to:
  /// **'Assign categories to entries linked from tasks'**
  String get maintenanceAssignCategoriesToLinkedFromTasks;

  /// No description provided for @maintenanceCancelNotifications.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @maintenanceRecreateTagged.
  ///
  /// In en, this message translates to:
  /// **'Recreate tagged'**
  String get maintenanceRecreateTagged;

  /// No description provided for @maintenanceReprocessSync.
  ///
  /// In en, this message translates to:
  /// **'Reprocess sync messages'**
  String get maintenanceReprocessSync;

  /// No description provided for @maintenanceResetHostId.
  ///
  /// In en, this message translates to:
  /// **'Reset Host ID'**
  String get maintenanceResetHostId;
  ...
  /// No description provided for @maintenanceStories.
  ///
  /// In en, this message translates to:
  /// **'Assign stories from parent entries'**
  String get maintenanceStories;

  /// No description provided for @maintenanceSyncCategories.
  ///
  /// In en, this message translates to:
  /// **'Sync categories'**
  String get maintenanceSyncCategories;

  /// No description provided for @maintenanceSyncDefinitions.
  ///
  /// In en, this message translates to:
  /// **'Sync tags, measurables, dashboards, habits'**
  String get maintenanceSyncDefinitions;

  /// No description provided for @maintenanceSyncSkip.
  ///
  /// In en, this message translates to:
  /// **'Skip sync message'**
  String get maintenanceSyncSkip;

  /// No description provided for @manualLinkText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @navTabTitleFlagged.
  ///
  /// In en, this message translates to:
  /// **'Flagged'**
  String get navTabTitleFlagged;
  ...
  /// No description provided for @settingsCategoryShowCaseCatTooltip.
  ///
  /// In en, this message translates to:
  /// **'Toggle this option to mark the category as active. Active categories are currently in use and will be prominently displayed for easier accessibility.'**
  ...
  /// No description provided for @settingsHabitsFavoriteLabel.
  ///
  /// In en, this message translates to:
  /// **'Favorite: '**
  String get settingsHabitsFavoriteLabel;
  ...
  /// No description provided for @settingsHabitsStoryLabel.
  ///
  /// In en, this message translates to:
  /// **'Habit completion story'**
  String get settingsHabitsStoryLabel;
  ...
  /// No description provided for @settingsMatrixAcceptIncomingVerificationLabel.
  ///
  /// In en, this message translates to:
  /// **'Accept Verification'**
  ...
  /// No description provided for @settingsMatrixRoomIdLabel.
  ///
  /// In en, this message translates to:
  /// **'Room ID'**
  String get settingsMatrixRoomIdLabel;

  /// No description provided for @settingsMatrixSaveLabel.
  ///
  /// In en, this message translates to:
  /// **'Save'**
  String get settingsMatrixSaveLabel;
  ...
  /// No description provided for @settingsPlaygroundTitle.
  ///
  /// In en, this message translates to:
  /// **'Developer Playground'**
  String get settingsPlaygroundTitle;

  /// No description provided for @settingsPlaygroundTutorialTitle.
  ///
  /// In en, this message translates to:
  /// **'Run Sliding Tutorial'**
  String get settingsPlaygroundTutorialTitle;
  ...
  /// No description provided for @settingsSpeechDownloadButton.
  ///
  /// In en, this message translates to:
  /// **'download'**
  String get settingsSpeechDownloadButton;
  ...
  /// No description provided for @settingsSyncCancelButton.
  ///
  /// In en, this message translates to:
  /// **'Cancel'**
  String get settingsSyncCancelButton;

  /// No description provided for @settingsSyncCfgTitle.
  ///
  /// In en, this message translates to:
  /// **'Sync Assistant'**
  String get settingsSyncCfgTitle;

  /// No description provided for @settingsSyncCloseButton.
  ///
  /// In en, this message translates to:
  /// **'Close'**
  String get settingsSyncCloseButton;

  /// No description provided for @settingsSyncCopyButton.
  ///
  /// In en, this message translates to:
  /// **'Copy'**
  String get settingsSyncCopyButton;

  /// No description provided for @settingsSyncCopyCfg.
  ///
  /// In en, this message translates to:
  /// **'Copy SyncConfig to Clipboard?'**
  String get settingsSyncCopyCfg;

  /// No description provided for @settingsSyncCopyCfgWarning.
  ///
  /// In en, this message translates to:
  /// **'The SyncConfig is encrypted since with this data, anyone can read your journal. A random one-time password for decryption will be shown after copying. Keep open or note in a safe place, it will not be shown again. ARE YOU SURE you want to proceed?'**
  String get settingsSyncCopyCfgWarning;

  /// No description provided for @settingsSyncDeleteConfigButton.
  ///
  /// In en, this message translates to:
  /// **'Delete Sync Configuration'**
  String get settingsSyncDeleteConfigButton;

  /// No description provided for @settingsSyncDeleteImapButton.
  ///
  /// In en, this message translates to:
  /// **'Delete IMAP Config'**
  String get settingsSyncDeleteImapButton;

  /// No description provided for @settingsSyncDeleteKeyButton.
  ///
  /// In en, this message translates to:
  /// **'Delete Shared Key'**
  String get settingsSyncDeleteKeyButton;

  /// No description provided for @settingsSyncFolderLabel.
  ///
  /// In en, this message translates to:
  /// **'IMAP Folder'**
  String get settingsSyncFolderLabel;

  /// No description provided for @settingsSyncGenKey.
  ///
  /// In en, this message translates to:
  /// **'Generating shared key...'**
  String get settingsSyncGenKey;

  /// No description provided for @settingsSyncGenKeyButton.
  ///
  /// In en, this message translates to:
  /// **'Generate Shared Key'**
  String get settingsSyncGenKeyButton;

  /// No description provided for @settingsSyncHostLabel.
  ///
  /// In en, this message translates to:
  /// **'Host'**
  String get settingsSyncHostLabel;

  /// No description provided for @settingsSyncImportButton.
  ///
  /// In en, this message translates to:
  /// **'Import SyncConfig'**
  String get settingsSyncImportButton;

  /// No description provided for @settingsSyncIncompleteConfig.
  ///
  /// In en, this message translates to:
  /// **'Sync config is incomplete'**
  String get settingsSyncIncompleteConfig;

  /// No description provided for @settingsSyncLoadingKey.
  ///
  /// In en, this message translates to:
  /// **'Loading shared key...'**
  String get settingsSyncLoadingKey;

  /// No description provided for @settingsSyncNotInitialized.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsSyncPasswordLabel.
  ///
  /// In en, this message translates to:
  /// **'Password'**
  String get settingsSyncPasswordLabel;

  /// No description provided for @settingsSyncPasteCfg.
  ///
  /// In en, this message translates to:
  /// **'Import SyncConfig from Clipboard?'**
  String get settingsSyncPasteCfg;

  /// No description provided for @settingsSyncPasteCfgWarning.
  ///
  /// In en, this message translates to:
  /// **'Do you want to import the SyncConfig from the clipboard? Enter the one-time password below, then proceed.'**
  String get settingsSyncPasteCfgWarning;

  /// No description provided for @settingsSyncPortLabel.
  ///
  /// In en, this message translates to:
  /// **'Port'**
  String get settingsSyncPortLabel;

  /// No description provided for @settingsSyncReGenKeyButton.
  ///
  /// In en, this message translates to:
  /// **'Re-generate Shared Key'**
  String get settingsSyncReGenKeyButton;

  /// No description provided for @settingsSyncSaveButton.
  ///
  /// In en, this message translates to:
  /// **'Save IMAP Config'**
  String get settingsSyncSaveButton;

  /// No description provided for @settingsSyncScanning.
  ///
  /// In en, this message translates to:
  /// **'Scanning Shared Secret...'**
  String get settingsSyncScanning;

  /// No description provided for @settingsSyncSuccessCloseButton.
  ///
  /// In en, this message translates to:
  /// **'Close'**
  String get settingsSyncSuccessCloseButton;

  /// No description provided for @settingsSyncTestConnectionButton.
  ///
  /// In en, this message translates to:
  /// **'Test IMAP Config'**
  String get settingsSyncTestConnectionButton;

  /// No description provided for @settingsSyncUserLabel.
  ///
  /// In en, this message translates to:
  /// **'Username'**
  String get settingsSyncUserLabel;
  ...
  /// No description provided for @syncAssistantHeadline.
  ///
  /// In en, this message translates to:
  /// **'Sync Assistant'**
  String get syncAssistantHeadline;

  /// No description provided for @syncAssistantPage1.
  ///
  /// In en, this message translates to:
  /// **'Let\'s get the synchronization between Lotti on Desktop and Lotti on your mobile device set up, shall we? You need to start on the desktop side.'**
  String get syncAssistantPage1;

  /// No description provided for @syncAssistantPage2.
  ///
  /// In en, this message translates to:
  /// **'The communication between happens without you having to give your data away to cloud-based services. Instead, you provide your own email account and each device in the communication stores encrypted messages for your other devices in an IMAP folder. Please provide your server settings on the next page.'**
  String get syncAssistantPage2;

  /// No description provided for @syncAssistantPage2mobile.
  ///
  /// In en, this message translates to:
  /// **'Please scan the generated QR code with your settings on the next page. If you haven\'t done so, please start the sync setup on a Lotti desktop version.'**
  String get syncAssistantPage2mobile;

  /// No description provided for @syncAssistantPage3.
  ///
  /// In en, this message translates to:
  /// **'In addition to using an email that you provide, all communication is also encrypted using the so called AES-GCM algorithm, where a secret is shared between your devices. We will generate this key now if it doesn\'t exist yet, and then generate a QR code that contains all this information. Please be mindful that this QR code contains all the information required to interact with your journal and access the email account you provide. Don\'t share this with anyone.'**
  String get syncAssistantPage3;

  /// No description provided for @syncAssistantStatusEmpty.
  ///
  /// In en, this message translates to:
  /// **'Please enter valid account details.'**
  String get syncAssistantStatusEmpty;

  /// No description provided for @syncAssistantStatusGenerating.
  ///
  /// In en, this message translates to:
  /// **'Generating secret...'**
  String get syncAssistantStatusGenerating;

  /// No description provided for @syncAssistantStatusLoading.
  ///
  /// In en, this message translates to:
  /// **'Loading...'**
  String get syncAssistantStatusLoading;

  /// No description provided for @syncAssistantStatusSaved.
  ///
  /// In en, this message translates to:
  /// **'IMAP configuration saved.'**
  String get syncAssistantStatusSaved;

  /// No description provided for @syncAssistantStatusSuccess.
  ///
  /// In en, this message translates to:
  /// **'Account is successfully configured.'**
  String get syncAssistantStatusSuccess;

  /// No description provided for @syncAssistantStatusTesting.
  ///
  /// In en, this message translates to:
  /// **'Testing IMAP connection...'**
  String get syncAssistantStatusTesting;

  /// No description provided for @syncAssistantStatusValid.
  ///
  /// In en, this message translates to:
  /// **'Account is valid.'**
  String get syncAssistantStatusValid;
  ...
  /// No description provided for @taskEditHint.
  ///
  /// In en, this message translates to:
  /// **'Edit Task'**
  ...
  /// No description provided for @viewMenuDisableBrightTheme.
  ///
  /// In en, this message translates to:
  /// **'Disable Bright Theme'**
  String get viewMenuDisableBrightTheme;

  /// No description provided for @viewMenuEnableBrightTheme.
  ///
  /// In en, this message translates to:
  /// **'Enable Bright Theme'**
  String get viewMenuEnableBrightTheme;

  /// No description provided for @viewMenuHideThemeConfig.
  ///
  /// In en, this message translates to:
  /// **'Hide Theme Config'**
  String get viewMenuHideThemeConfig;

  /// No description provided for @viewMenuShowThemeConfig.
  ///
  /// In en, this message translates to:
  /// **'Show Theme Config'**
  String get viewMenuShowThemeConfig;
