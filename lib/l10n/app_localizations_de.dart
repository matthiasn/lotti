...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String relationshipAgentNotEnrolledBody(String name) {
    return 'Markiere $name als wichtig, um ein Briefing, Erinnerungen nach längerer Funkstille und einen Chat zu bekommen. Bis dahin läuft nichts von selbst; nur ein Chat, den du selbst startest, nutzt die KI.';
  }
