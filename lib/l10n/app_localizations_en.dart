...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String goalDaysToRecover(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count days to recover',
      one: '1 day to recover',
    );
    return '$_temp0';
  }
  ...
  @override
  String get goalFormKeepAsNote => 'Keep as a note — no coaching';
  ...
  @override
  String get goalFormWatchAnotherHabit => 'Watch another habit';

  @override
  String get goalFormWeeklyCheckIn => 'Weekly check-in — tell me how it went';
  ...
  String goalProgressDaysToHealthy(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count days to healthy',
      one: '1 day to healthy',
    );
    return '$_temp0';
  }
