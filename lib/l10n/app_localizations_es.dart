...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get checkInMoreCaption => 'Temas · próxima vez · evitar';
  ...
  String relationshipImportReviewSubtitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count seleccionados · los números se quedan en este dispositivo',
      one: '1 seleccionado · los números se quedan en este dispositivo',
    );
    return '$_temp0';
  }
