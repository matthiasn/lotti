...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get addMeasurementNoneDefined =>
      'Ajouter un type de données mesurable';
  ...
  String get aiAssistantCreateChecklist =>
      'Créer des éléments de liste de contrôle';
  ...
  String get aiTaskNoSummaryTitle =>
      'Aucun résumé de tâche IA créé pour l\'instant';
  ...
  String get dashboardsEmptyHint =>
      'Il n\'y encore rien ici, veuillez créer un nouveau Tableau de bord dans Paramètres > Gestion du tableau de bord.\n\nLe bouton va vous y amener directement.';
  ...
  String get habitsLongerStreaksEmptyHeader =>
      'Aucune série d\'une semaine pour le moment';
  ...
  String get habitsShortStreaksEmptyHeader =>
      'Aucune série de trois jours pour le moment';
  ...
  String get maintenanceAssignCategoriesToChecklists =>
      'Attribuer des catégories aux listes de contrôle';

  @override
  String get maintenanceAssignCategoriesToLinked =>
      'Attribuer des catégories aux entrées liées à des entrées avec catégories';

  @override
  String get maintenanceAssignCategoriesToLinkedFromTasks =>
      'Attribuer des catégories aux entrées liées à des tâches';
  ...
  String get maintenanceReprocessSync =>
      'Retraiter les messages de synchronisation';
  ...
  String get maintenanceSyncDefinitions =>
      'Synchroniser les balises, les éléments mesurables, les tableaux de bord, les habitudes';
  ...
  String get settingsHabitsStoryLabel =>
      'Historique d\'achèvement des habitudes';
  ...
  String get settingsSyncCopyCfg =>
      'Copier SyncConfig dans le presse-papiers ?';

  @override
  String get settingsSyncCopyCfgWarning =>
      'Avec ces données, tout le monde peut lire votre journal. Ne faites une copie que si vous savez exactement ce que vous faites. Êtes-vous CERTAIN de vouloir continuer ?';

  @override
  String get settingsSyncDeleteConfigButton =>
      'Supprimer la configuration de synchronisation';
  ...
  String get settingsSyncNotInitialized =>
      'La synchronisation n\'a pas été initialisée...';
  ...
  String get settingsSyncPasteCfg =>
      'Importer la SyncConfig du presse-papiers ?';

  @override
  String get settingsSyncPasteCfgWarning =>
      'Voulez-vous vraiment importer la SyncConfig du presse-papiers ? Continuez UNIQUEMENT si vous savez exactement ce que vous faites.';
  ...
  String get syncAssistantPage1 =>
      'Démarrons la synchronisation entre Lotti sur votre bureau et Lotti sur votre appareil mobile. Vous devez commencer par Lotti sur le bureau.';

  @override
  String get syncAssistantPage2 =>
      'Les communications se font sans exposer vos données personnelles à des services en ligne. À la place, votre adresse électronique est utilisée pour chiffrer et enregistrer les messages de chaque appareil dans un dossier IMAP. Veuillez fournir les paramètres du serveur à la page suivante.';

  @override
  String get syncAssistantPage2mobile =>
      'Scannez le code QR de paramétrage à la page suivante. Si vous ne l\'avez pas déjà fait, veuillez commencer le processus de synchronisation sur une version de bureau de Lotti.';
  ...
  String get syncAssistantStatusEmpty =>
      'Veuillez saisir des informations de compte valides.';
  ...
  String get syncAssistantStatusSuccess =>
      'Le compte est configuré avec succès.';
