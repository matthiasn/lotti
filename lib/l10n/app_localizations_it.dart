...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String goalAgentLifetimeTimePill(String duration) {
    return '$duration di IA';
  }

  @override
  String goalAgentLifetimeTimeTooltip(String calls) {
    return 'Tempo di calcolo totale dell\'agente su $calls chiamate al modello.';
  }
  ...
  @override
  String get goalAssessmentMet => 'Incontrato';
  ...
  String goalAssessmentSuggestedProvenance(String agentName) {
    return '$agentName suggerito, hai accettato';
  }

  @override
  String get goalAssessmentSuggestedProvenanceGeneric =>
      'Il tuo agente obiettivo ha suggerito, hai accettato';
  ...
  String get goalBannerActionFailed =>
      'Non è stato salvato: riprova per favore.';
  ...
  String goalCompositeProgressSummary(
    ...
    return 'Ieri sono state soddisfatte $metCount dimensioni su $dimensionCount · $requiredCount richieste.';
  }
  ...
  String goalDaysToRecover(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count giorni per recuperare',
      one: '1 giorno per recuperare',
    );
    return '$_temp0';
  }
  ...
  String get goalDimensionNeedsAttentionNote =>
      'Questa dimensione necessita di attenzione; la sua stessa prova rimane visibile.';
  ...
  String get goalFormCostHonesty =>
      'Usa il provider IA che hai configurato. Il consumo effettivo appare negli indicatori del consumo totale di questo obiettivo.';
  ...
  String goalFormHabitCadence(String habit, int count) {
    return '$habit ($count× a settimana)';
  }

  @override
  String get goalFormHabitSignal => 'spunta dell’abitudine';
