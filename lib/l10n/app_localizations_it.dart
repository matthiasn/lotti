...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get categoryKnowledgeBriefHint =>
      'App Flutter, repository su github.com/…, test con make test, …';

  @override
  String get categoryKnowledgeBriefLabel => 'Conoscenze della categoria';

  @override
  String get categoryKnowledgeBriefSectionDescription =>
      'Ciò che ogni prompt IA per le attività di questa categoria dovrebbe sapere: di cosa si tratta, dove si trova il codice, convenzioni, insidie. Viene inserito parola per parola.';

  @override
  String get categoryKnowledgeBriefSectionTitle => 'Conoscenze della categoria';
  ...
  @override
  String get checkInRemoveTake => 'Rimuovi la registrazione';
  ...
  String get checkInTakeWordsFollow =>
      'Puoi già salvare: le parole arriveranno dopo.';
  ...
  String checklistItemApprovedInChat(String date) {
    return 'Approvato da te nella chat · $date';
  }
  ...
  @override
  String get queryActionsAcceptAll => 'Accetta tutti';

  @override
  String get queryActionsDismiss => 'Ignora';

  @override
  String get queryActionsDismissAll => 'Ignora tutti';
  ...
  String relationshipAgentNotEnrolledBody(String name) {
    return 'Attiva i promemoria per $name per avere una chat, un promemoria quando è passato un po’ di tempo e un briefing.';
  }
  ...
  String get relationshipChatUnavailable =>
      'Nessun agente ancora: prima attiva i promemoria per questa persona.';
  ...
  @override
  String get relationshipImportantLabel => 'Con promemoria';
  ...
  String relationshipNextTimeFromEarlier(String day) {
    return 'Dal tuo check-in di $day';
  }
  ...
  @override
  String get relationshipNotEnrolled => 'Senza promemoria';
  ...
  String relationshipPostCallAskCall(String name) {
    return 'Hai raggiunto $name?';
  }

  @override
  String relationshipPostCallAskMessage(String name) {
    return 'Hai scritto a $name?';
  }
  ...
  @override
  String get relationshipPostCallYes => 'Sì, annotalo';
  ...
  String relationshipRemindersPillSemantics(String cadence) {
    return 'Promemoria: $cadence. Tocca per cambiare.';
  }

  @override
  String get relationshipRemindersSheetTitle => 'Promemoria';
  ...
  String relationshipsSummaryNotEnrolled(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count persone senza promemoria',
      one: '1 persona senza promemoria',
    );
    return '$_temp0';
  }
  ...
  @override
  String get relationshipStatusLineAddedNoCadence => 'Appena aggiunto';
  ...
  @override
  String get relationshipTurnRemindersOff => 'Disattiva promemoria';
  ...
  String get settingsNotificationsExplanation =>
      'Gli avvisi arrivano tramite le notifiche del tuo dispositivo. Scegli cosa ne merita uno; tutto resta comunque nella campanella di Lotti.';
  ...
  String get settingsNotificationsKindsNote =>
      'Disattivare un tipo ferma solo i suoi avvisi. Le sue voci restano nella campanella.';
