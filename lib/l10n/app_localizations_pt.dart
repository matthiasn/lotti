...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get categoryKnowledgeBriefHint =>
      'App Flutter, repositório em github.com/…, testes com make test, …';

  @override
  String get categoryKnowledgeBriefLabel => 'Conhecimento da categoria';
  ...
  @override
  String get checkInRemoveTake => 'Remover gravação';
  ...
  String get checkInTakeWordsFollow =>
      'Você já pode salvar — as palavras vêm depois.';
  ...
  String checklistItemApprovedInChat(String date) {
    return 'Aprovado por você no chat · $date';
  }
  ...
  @override
  String get queryActionsAcceptAll => 'Aceitar todos';

  @override
  String get queryActionsDismiss => 'Descartar';

  @override
  String get queryActionsDismissAll => 'Descartar todos';
  ...
  String relationshipAgentNotEnrolledBody(String name) {
    return 'Ativa os lembretes de $name para ter um chat, um aviso quando já passou algum tempo e um briefing.';
  }
  ...
  @override
  String get relationshipCheckInCommentHint => 'Adicione um comentário…';

  @override
  String get relationshipCheckInEmpty =>
      'Nada adicionado ainda. Adicione um comentário, uma gravação ou uma foto.';

  @override
  String get relationshipCheckInGone => 'Este check-in não existe mais.';

  @override
  String get relationshipCheckInNoteLabel => 'Anotado ao registrar';
  ...
  String get relationshipImportSelectHint =>
      'Assinala as pessoas que queres adicionar. No passo seguinte escolhes de quem queres lembretes.';
  ...
  @override
  String get relationshipNotEnrolled => 'Sem lembretes';
  ...
  String get relationshipsEmptyHint =>
      'Aponta uma linha depois de falarem. O Lotti mostra com quem não falas há algum tempo e, se quiseres, lembra-te.';
  ...
  @override
  String get relationshipsSummaryNextDueCaption => 'A seguir';
  ...
  String relationshipsSummaryNotEnrolled(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count pessoas sem lembretes',
      one: '1 pessoa sem lembretes',
    );
    return '$_temp0';
  }
  ...
  String get settingsFlagsEmptySearchSectionsHint =>
      'Procurando Hábitos, Projetos ou Daily OS? Eles ficam em Configurações → Seções.';

  @override
  String get settingsFlagsGroupAdvanced => 'AVANÇADO E EXPERIMENTAL';

  @override
  String get settingsFlagsGroupPreferences => 'PREFERÊNCIAS';
  ...
  String get settingsNotificationsAgentCopyDescription =>
      'Um aviso de objetivo ou de contacto usa as palavras do banner do agente em vez de uma linha fixa. Pode mencionar detalhes e aparece no ecrã de bloqueio.';

  @override
  String get settingsNotificationsAgentCopyTitle =>
      'Avisos nas palavras do agente';
  ...
  @override
  String get settingsNotificationsWordingHeading => 'Formulação';
  ...
  String get settingsSectionsIntro =>
      'Cada seção que você ativa ganha seu próprio lugar na navegação. Desativá-la apenas a oculta — nada do que você registrou é excluído.';

  @override
  String get settingsSectionsSubtitle =>
      'Escolha quais partes do Lotti você usa';
  ...
  String taskAgentUpdateNowCountdown(String countdown) {
    return 'Atualizar agora · $countdown';
  }
  ...
  String unlinkTaskConfirmNamed(String title) {
    return 'Desvincular «$title»? A tarefa em si não é excluída.';
  }
