...
class AppLocalizationsRo extends AppLocalizations {
  ...
  @override
  String get createNewLinkedTaskTitle => 'Creați o sarcină nouă asociată';
  ...
  @override
  String get linkExistingTaskTitle => 'Leagă o sarcină existentă';
  ...
  String taskBlockedByChipTooltip(int count, String title) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Atinge pentru $count blocaje',
