...
// Error messages
const String noScreenshotToolAvailableMessage = 'No screenshot tool available. Please install one of: ';
...
const String screencaptureFailedMessage = 'macOS screencapture failed with exit code ';
const String unsupportedPlatformMessage = 'Screenshot functionality is not supported on ';

// Process configuration
const bool runInShell = true;
