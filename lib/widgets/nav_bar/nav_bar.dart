...
enum SpotifyStyleBottomNavigationBarType {
...
class SpotifyStyleBottomNavigationBar extends StatefulWidget {
  ...
  @override
  State<SpotifyStyleBottomNavigationBar> createState() =>
      _SpotifyStyleBottomNavigationBarState();
}
...
class _SpotifyStyleBottomNavigationBarState
    extends State<SpotifyStyleBottomNavigationBar>
  ...
  SpotifyStyleBottomNavigationBarType get _effectiveType {
    return widget.type ??
        (widget.items.length <= 3
            ? SpotifyStyleBottomNavigationBarType.fixed
            : SpotifyStyleBottomNavigationBarType.shifting);
  }
  ...
  @override
  void didUpdateWidget(SpotifyStyleBottomNavigationBar oldWidget) {
...
class _Circle {
  ...
  final _SpotifyStyleBottomNavigationBarState state;
  final int index;
  final Color color;
