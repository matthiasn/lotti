...
def main():
    ...
    parser.add_argument("--model", choices=["e2b", "e4b", "E2B", "E4B"], default="E2B", help="Model variant to use")
    ...
    parser.add_argument(
        "--test",
        choices=["health", "download", "transcribe", "context", "streaming", "errors", "formats"],
    ...
    # Initialize tester
    tester = GemmaServiceTester(host=args.host, port=args.port, model_variant=args.model.upper())
