...
class TestAPIEndpoints:
    ...
    def test_health_endpoint(self, client, mock_container):
    ...
    def test_chat_completion_streaming(self, client, mock_container):
    ...
    def test_chat_completion_model_not_found(self, client, mock_container):
    ...
    def test_model_pull_streaming(self, client, mock_container):
        ...
        async def mock_download_stream(model_name, stream):
    ...
    def test_model_pull_non_streaming(self, client, mock_container):
    ...
    def test_list_models(self, client, mock_container):
    ...
    def test_load_model_success(self, client, mock_container):
    ...
    def test_load_model_already_loaded(self, client, mock_container):
