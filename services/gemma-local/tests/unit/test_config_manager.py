...
class TestConfigManager:
    ...
    def test_get_model_id_from_env(self):
    ...
    def test_set_model_id_empty_raises_error(self):
    ...
    def test_get_huggingface_token_priority(self):
    ...
    def test_get_port_invalid_raises_error(self):
    ...
    def test_validate_config_creates_cache_dir(self, tmp_path):
    ...
    def test_validate_config_invalid_model_id(self):
