...
class TestModelValidator:
    ...
    def test_validate_model_request_empty_name_raises_error(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_validate_model_request_model_exists(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_validate_model_request_model_missing(self, mock_config_manager, mock_model_manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_model_available_missing_model(self, mock_config_manager, mock_model_manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_model_available_same_model(self, mock_config_manager, mock_model_manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_model_available_different_model(self, mock_config_manager, mock_model_manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_switch_model_config_e4b(self, mock_config_manager, mock_model_manager) -> None:
    ...
    @pytest.mark.asyncio
    async def test_switch_model_config_e2b(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_get_model_path_without_prefix(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_get_model_path_with_prefix(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_get_available_models_no_models_dir(self, mock_config_manager, mock_model_manager) -> None:
    ...
    def test_get_available_models_with_models(self, mock_config_manager, mock_model_manager) -> None:
