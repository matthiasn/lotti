"""Model management for Qwen Image Service."""
...
class QwenImageModelManager:
    """Manages Qwen Image model downloading, loading, and lifecycle."""

    def __init__(self) -> None:
        self.pipe: Optional[Any] = None  # DiffusionPipeline, typed as Any to allow lazy import
        ...
        logger.info(f"Initialized QwenImageModelManager with device: {self.device}")
    ...
    async def download_model(self) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        async with self._lock:
            try:
                ...
                # Qwen-Image is Apache 2.0, no token required
            ...
            try:
                ...
                def load_model_sync() -> None:
                    ...
                    try:
                        ...
                        # Fallback: try loading without moving to device
                        self.pipe = DiffusionPipeline.from_pretrained(
                            model_path,
                            torch_dtype=ServiceConfig.TORCH_DTYPE,
                            local_files_only=True,
...
# Global instance
model_manager = QwenImageModelManager()
