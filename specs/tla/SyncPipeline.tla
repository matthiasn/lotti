...
(*                                                                         *)
(* Recovery is an explicit release/startup/request opportunity. Its weak   *)
(* fairness is an ENVIRONMENT obligation: production does not continuously *)
(* retry failed orphan settlement. See the scope/obligation table in README.*)
