...
(* originator's answer.                                                    *)
(*                                                                         *)
(* Counters start at 1, as VectorClockService's firstVectorClockCounter    *)
(* does since ADR 0080; a watermark of 0 means nothing is resolved yet.    *)
(* Hosts that older builds created also handed out a counter 0, which      *)
(* this model, like gap detection, leaves out.                             *)
(*                                                                         *)
(* OwnCounterSettlement.tla expands the atomic settlement and fallback     *)
(* migration below into their database reads/writes and batch enqueues.    *)
(*                                                                         *)
