...
void main() {
  group('BeamerDelegates', () {
    test('habitsBeamerDelegate returns HabitsLocation', () {
      ...
      final location = habitsBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
    ...
    test('dashboardsBeamerDelegate returns DashboardsLocation', () {
      ...
      final location = dashboardsBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
    ...
    test('journalBeamerDelegate returns JournalLocation', () {
      ...
      final location = journalBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
    ...
    test('tasksBeamerDelegate returns TasksLocation', () {
      ...
      final location = tasksBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
    ...
    test('calendarBeamerDelegate returns CalendarLocation', () {
      ...
      final location = calendarBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
    ...
    test('returns NotFound for unknown routes', () {
      ...
      final habitsLocation = habitsBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
      final dashboardsLocation = dashboardsBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
      final journalLocation = journalBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
      ...
      final calendarLocation = calendarBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
      final settingsLocation = settingsBeamerDelegate.locationBuilder(
        routeInformation,
        null,
      );
