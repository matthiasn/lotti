...
final _bulkTestDate = DateTime(2024, 1, 15);
...
JournalEntity _makeTask(
  ...
  final date = dateFrom ?? _bulkTestDate;
  return JournalEntity.task(
    meta: Metadata(
      id: id,
      createdAt: _bulkTestDate,
      updatedAt: _bulkTestDate,
      dateFrom: date,
      dateTo: date,
    ...
    group('basic functionality', () {
      ...
      test('handles multiple linked entities per parent ID', () async {
        ...
        final aiResponse2 = JournalEntity.aiResponse(
          meta: Metadata(
            id: 'ai-response-2',
            createdAt: _bulkTestDate.add(const Duration(hours: 1)),
            updatedAt: _bulkTestDate.add(const Duration(hours: 1)),
            dateFrom: _bulkTestDate.add(const Duration(hours: 1)),
            dateTo: _bulkTestDate.add(const Duration(hours: 1)),
          ),
    ...
    group('deduplication and sorting', () {
      ...
      test('sorts linked entities by dateFrom in descending order', () async {
        ...
        final newestEntry = JournalEntity.journalEntry(
          meta: Metadata(
            id: 'newest-entry',
            createdAt: _bulkTestDate.add(const Duration(days: 3)),
            updatedAt: _bulkTestDate.add(const Duration(days: 3)),
            dateFrom: _bulkTestDate.add(const Duration(days: 3)), // Newest
            dateTo: _bulkTestDate.add(const Duration(days: 3, hours: 1)),
          ),
        ...
        final middleEntry = JournalEntity.journalEntry(
          meta: Metadata(
            id: 'middle-entry',
            createdAt: _bulkTestDate.add(const Duration(days: 2)),
            updatedAt: _bulkTestDate.add(const Duration(days: 2)),
            dateFrom: _bulkTestDate.add(const Duration(days: 2)), // Middle
            dateTo: _bulkTestDate.add(const Duration(days: 2, hours: 1)),
          ),
        ...
        final oldestEntry = JournalEntity.journalEntry(
          meta: Metadata(
            id: 'oldest-entry',
            createdAt: _bulkTestDate.add(const Duration(days: 1)),
            updatedAt: _bulkTestDate.add(const Duration(days: 1)),
            dateFrom: _bulkTestDate.add(const Duration(days: 1)), // Oldest
            dateTo: _bulkTestDate.add(const Duration(days: 1, hours: 1)),
          ),
