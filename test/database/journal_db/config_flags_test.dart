  ...
  group('initConfigFlags', () {
    test('inserts every expected flag with the documented default', () async {
      ...
      const defaults = <String, bool>{
        ...
        // The per-kind preferences narrow what the master flag lets through,
        // so they start on: switching notifications on means every kind.
        notifyTaskSuggestionsFlag: true,
        notifyCheckInRemindersFlag: true,
        notifyGoalAlertsFlag: true,
        notifyHabitRemindersFlag: true,
        notifyHabitAutoCompletionsFlag: true,
        ...
        // so the user says when (ADR 0074).
