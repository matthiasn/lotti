...
/// subscription throws on [StreamSubscription.cancel], used to exercise the
/// controller's error handling for the `record.Amplitude` amplitude stream.
...
void main() {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Error-path coverage for _cleanupInternal
  // ─────────────────────────────────────────────────────────────────────────
    ...
    test('invokes getTemporaryDirectory() and records (line 91)', () async {
      ...
      addTearDown(() async {
        ...
        try {
          ...
          // Already removed by the controller's unawaited dispose cleanup,
          // which races this teardown.
        }
      });
