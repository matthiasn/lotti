...
void main() {
  ...
  test(
    ...
    () async {
      ...
      when(() => mockJournalDb.getLabelDefinitionById('A')).thenAnswer(
      ...
      when(() => mockJournalDb.getLabelDefinitionById('B')).thenAnswer(
        (_) async => LabelDefinition(
          id: 'B',
          name: 'B',
          color: '#000',
      ...
      when(
        () => mockJournalDb.getLabelDefinitionById('X'),
  ...
  test(
    ...
    () async {
      ...
      when(
        () => mockJournalDb.getLabelDefinitionById(vh1),
      ).thenAnswer((_) => def(vh1));
      when(
        () => mockJournalDb.getLabelDefinitionById(h1),
      ).thenAnswer((_) => def(h1));
      when(
        () => mockJournalDb.getLabelDefinitionById(h2),
      ).thenAnswer((_) => def(h2));
      when(
        () => mockJournalDb.getLabelDefinitionById(m1),
      ).thenAnswer((_) => def(m1));
      when(
        () => mockJournalDb.getLabelDefinitionById(low1),
      ...
      expect(
        (result['assigned'] as List).cast<String>(),
        equals([vh1, h1, h2]),
      );
    },
  );
  ...
  test('handles retry with corrected label IDs in conversation', () async {
    ...
    when(() => mockJournalDb.getLabelDefinitionById('valid-1')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'valid-1',
        name: 'Valid 1',
        color: '#000',
    ...
    when(() => mockJournalDb.getLabelDefinitionById('valid-2')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'valid-2',
        name: 'Valid 2',
        color: '#000',
    ...
    when(
      () => mockJournalDb.getLabelDefinitionById('typo-id'),
    ).thenAnswer((_) async => null);
    when(() => mockJournalDb.getLabelDefinitionById('deleted-id')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'deleted-id',
        name: 'Deleted',
        color: '#000',
    ...
    when(() => mockJournalDb.getLabelDefinitionById('valid-3')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'valid-3',
        name: 'Valid 3',
        color: '#000',
    ...
    when(() => mockJournalDb.getLabelDefinitionById('valid-4')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'valid-4',
        name: 'Valid 4',
        color: '#000',
    ...
    final secondResMap = Map<String, dynamic>.from(
      secondResult['result'] as Map,
    );
  ...
  test('handles conversation interruption and recovery', () async {
    ...
    when(() => mockJournalDb.getLabelDefinitionById('label-2')).thenAnswer(
      (_) async => LabelDefinition(
        id: 'label-2',
        name: 'Label 2',
        color: '#000',
