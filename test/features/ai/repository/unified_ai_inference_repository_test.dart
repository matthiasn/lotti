...
// Removed MockLoggingService - using HybridLoggingService instead
...
void main() {
  ...
  setUp(() {
    ...
    // Removed mockLoggingService setup - using HybridLoggingService
    ...
    // HybridLoggingService is already registered by setupTestEnvironment()
    getIt
  ...
  tearDown(() {
    ...
    // HybridLoggingService cleanup is handled by teardownTestEnvironment()
  });
