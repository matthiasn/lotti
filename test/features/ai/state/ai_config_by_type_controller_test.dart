...
void main() {
  ...
  group('AiConfigByTypeController Tests', () {
    ...
    test('should add a new configuration', () async {
      ...
      await controller.addConfig(testApiConfig);

      // Assert
      verify(() => mockRepository.saveConfig(testApiConfig)).called(1);
    });
    ...
    test('should update an existing configuration', () async {
      ...
      final updatedConfig = AiConfig.apiKey(
        ...
        apiKey: 'updated-key',
        name: 'Updated API',
        createdAt: testApiConfig.createdAt,
      );
      await controller.updateConfig(updatedConfig);

      // Assert
      verify(() => mockRepository.saveConfig(updatedConfig)).called(1);
    });
