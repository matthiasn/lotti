    ...
    group('filterPrompts', () {
      ...
      test('filters prompts by description', () {
        ...
        expect(
          result,
          hasLength(1),
        ); // Only "Image Analysis" contains "analyze" in description
      });
      ...
      test('returns all prompts when no response types selected', () {
        final filterState = AiSettingsFilterState.initial().copyWith(
          selectedResponseTypes: <AiResponseType>{},
        );
        final result = service.filterPrompts(testPrompts, filterState);
      ...
      test(
        'returns empty list when response type filter excludes all prompts',
        () {
          final filterState = AiSettingsFilterState.initial().copyWith(
