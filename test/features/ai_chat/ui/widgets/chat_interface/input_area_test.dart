...
void main() {
  ...
  testWidgets('mic tap starts batch recording', (tester) async {
  ...
  testWidgets('transcript auto-sends when canSend is true', (tester) async {
    ...
    controller.emitTranscript('Hello from recorder');
    await tester.pumpAndSettle();

    expect(sentMessage, 'Hello from recorder');
...
/// Test controller that starts idle and tracks start calls
class _IdleControllerWithCallbacks extends ChatRecorderController {
  _IdleControllerWithCallbacks({this.onStartCalled});
