...
void main() {
  group('buildDesignSystemTaskFilterWidgetbookComponent', () {
    testWidgets('renders the task filter overview page', (tester) async {
      ...
      expect(find.text('Open, In Progress'), findsOneWidget);
      expect(find.text('Learn, Study'), findsOneWidget);
      expect(find.text('AI Coding, Agents'), findsOneWidget);
    ...
    testWidgets('updates serialized state through widget callbacks', (
      ...
      expect(
        (clearedState['statusField'] as Map<String, dynamic>)['selectedIds'],
        isEmpty,
      );
      expect(
        (clearedState['categoryField'] as Map<String, dynamic>)['selectedIds'],
        isEmpty,
      );
      expect(
        (clearedState['labelField'] as Map<String, dynamic>)['selectedIds'],
        isEmpty,
      );
