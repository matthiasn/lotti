...
void main() {
  ...
  test(
    ...
    () async {
      ...
      AgentDomainEntity spec(String agentId, String title) =>
          AgentDomainEntity.goalSpecVersion(
            ...
            criteria: GoalCriterion.allOf(
              ...
              criteria: [
                ...
                GoalCriterion.habit(
                  criterionId: '$agentId-own',
                  habitId: '$agentId-own-habit',
      ...
      // The shared habit carries BOTH goals; each goal's private habit only
      // its own.
      expect(
        [for (final m in memberships['walk']!) m.title],
        ['Fitness', 'goal-b'],
      );
      expect(
        [for (final m in memberships['goal-a-own-habit']!) m.agentId],
        ['goal-a'],
      );
      expect(
        [for (final m in memberships['goal-b-own-habit']!) m.agentId],
        ['goal-b'],
      );
    },
  );
