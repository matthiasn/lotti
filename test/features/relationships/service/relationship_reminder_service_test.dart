...
void main() {
  ...
  group('RelationshipReminderService.arm', () {
    ...
    test('arms for a lapsed cadence too, not only a healthy one', () async {
      // The reminder is armed from the derivation, whatever its verdict: a
      // person marked important with an old check-in is due immediately, and
      // the scheduler's show-now path handles an instant already in the past.
      await service.arm(
        relationship: relationship(),
