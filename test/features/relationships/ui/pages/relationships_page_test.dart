...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // the repository's recency contract rendered per row.
      expect(
        find.text(entryDateLabelForTest(tester, DateTime(2026, 8, 12, 18))),
        findsOneWidget,
      );
      expect(
        find.text(entryDateLabelForTest(tester, testDate)),
        findsOneWidget,
      );
      expect(
        find.text('Add the people you want to stay close to.'),
