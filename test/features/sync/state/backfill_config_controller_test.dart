  ...
  group('BackfillConfigController', () {
    test('initial state defaults to enabled', () async {
      final state = await container.read(
        backfillConfigControllerProvider.future,
      );
      expect(state, isTrue);
    });

    test(
      'initial state reads from SharedPreferences when set to false',
      () async {
    ...
    test(
      'initial state reads from SharedPreferences when set to true',
      () async {
    ...
    test('setEnabled updates state to false', () async {
      final controller = container.read(
        backfillConfigControllerProvider.notifier,
      );
