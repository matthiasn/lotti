...
import 'task_progress_repository_test_helpers.dart';
...
void main() {
  ...
  group('sumTimeSpentFromEntities', () {
    ...
    test('sums multiple non-overlapping text entries correctly', () {
      // Arrange
      final textEntry1 = hMakeJournalEntry(
        'text-entry-1',
        DateTime(2022, 7, 7, 9),
        DateTime(2022, 7, 7, 10), // 1 hour
      );
      final textEntry2 = hMakeJournalEntry(
        'text-entry-2',
    ...
    test('merges overlapping entries to prevent double-counting', () {
      ...
      final gymTrip = hMakeJournalEntry(
        'gym-trip',
        DateTime(2022, 7, 7, 10),
        DateTime(2022, 7, 7, 11, 30), // 1.5 hours
      );
      final fitnessEntry = hMakeJournalEntry(
        'fitness-entry',
    ...
    test('merges partially overlapping entries correctly', () {
      ...
      final entry1 = hMakeJournalEntry(
        'entry-1',
        DateTime(2022, 7, 7, 10),
        DateTime(2022, 7, 7, 11, 30), // 10:00-11:30
      );
      final entry2 = hMakeJournalEntry(
        'entry-2',
