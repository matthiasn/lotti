    ...
    test(
      ...
      () {
        expect(
          ...
          [
            Observation(DateTime(2022, 7, 1), 0.0),
            Observation(DateTime(2022, 7, 2), 0.0),
            Observation(DateTime(2022, 7, 3), 0.0),
            Observation(DateTime(2022, 7, 4), 0.0),
            Observation(DateTime(2022, 7, 5), 0.0),
            Observation(DateTime(2022, 7, 6), 0.0),
            Observation(DateTime(2022, 7, 7), 0.0),
          ],
        );
      },
    );
      ...
      () {
        expect(
          ...
          [
            Observation(DateTime(2022, 7, 1), 0.0),
            Observation(DateTime(2022, 7, 2), 0.0),
            Observation(DateTime(2022, 7, 3), 1.0),
            Observation(DateTime(2022, 7, 4), 4.1925),
            Observation(DateTime(2022, 7, 5), 0.0),
          ],
        );
      },
    ...
    test(
      ...
      () {
        expect(
          ...
          [
            Observation(DateTime(2022, 7, 1), 1.0),
            Observation(DateTime(2022, 7, 2), 4.0),
            Observation(DateTime(2022, 7, 3), 24.0),
            Observation(DateTime(2022, 7, 4), 24.0),
            Observation(DateTime(2022, 7, 5), 1.0),
            Observation(DateTime(2022, 7, 6), 0.0),
          ],
        );
      },
    ...
    test(
      ...
      () {
        expect(
          ...
          const [
            WeeklyAggregate('2022-W22', 98.0),
            WeeklyAggregate('2022-W23', 145.0),
            WeeklyAggregate('2022-W24', 0.0),
            WeeklyAggregate('2022-W25', 0.0),
            WeeklyAggregate('2022-W26', 29.0),
            WeeklyAggregate('2022-W27', 25.0),
            WeeklyAggregate('2022-W28', 0.0),
          ],
        );
      },
    );
    ...
    test(
      ...
      () {
        expect(
          ...
          const [
            WeeklyAggregate('2022-W22', 0.0),
            WeeklyAggregate('2022-W23', 0.0),
            WeeklyAggregate('2022-W24', 0.0),
            WeeklyAggregate('2022-W25', 0.0),
            WeeklyAggregate('2022-W26', 0.0),
          ],
        );
      },
    );
