...
class _GeneratedMetadataUpdateScenario {
  const _GeneratedMetadataUpdateScenario({
    required this.mask,
    required this.seed,
  });
  ...
  @override
  String toString() {
    return '_GeneratedMetadataUpdateScenario('
        'mask: $mask, '
        'seed: $seed)';
  }
}

extension _AnyGeneratedMetadataUpdateScenario on glados.Any {
  glados.Generator<_GeneratedMetadataUpdateScenario>
  get metadataUpdateScenario => glados.CombinableAny(this).combine2(
    glados.IntAnys(this).intInRange(0, 1 << 8),
    glados.IntAnys(this).intInRange(0, 10000),
    (int mask, int seed) => _GeneratedMetadataUpdateScenario(
      mask: mask,
      seed: seed,
    ),
  );
