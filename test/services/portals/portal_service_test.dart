...
void main() {
  group('PortalService', () {
    ...
    group('Initialization', () {
      test('should handle initialization when shouldUsePortal is false', () async {
    ...
    group('Client Access', () {
      ...
      test('should throw StateError when accessing client outside Flatpak', () async {
        await service.initialize();
        expect(() => service.client, throwsStateError);
      });
    });
    ...
    group('Portal Object Creation', () {
      test('should create portal object with correct parameters when in Flatpak', () async {
    ...
    group('Interface Availability', () {
      test('should return false for ScreenshotPortalService when not in Flatpak', () async {
      ...
      test('should return true for AudioPortalService when not in Flatpak', () async {
        final available = await PortalService.isInterfaceAvailable(
      ...
      test('should handle interface availability check errors gracefully', () async {
      ...
      test('should handle interface availability check for unknown service', () async {
        final available = await PortalService.isInterfaceAvailable(
    ...
    group('Constants', () {
      test('should have correct portal constants', () {
        expect(PortalConstants.portalBusName, equals('org.freedesktop.portal.Desktop'));
        expect(PortalConstants.portalPath, equals('/org/freedesktop/portal/desktop'));
