...
void main() {
  group('Screenshot Tests', () {
    ...
    group('takeScreenshot', () {
      ...
      test('logs exception and rethrows when error occurs', () async {
        // Mock the directory creation to throw
        when(() => mockDirectory.create(recursive: any(named: 'recursive')))
        ...
        // The logging service should be called when an exception occurs
        // but the exact timing depends on platform behavior
