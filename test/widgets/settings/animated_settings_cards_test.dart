...
void main() {
  ...
  group('AnimatedModernMaintenanceCard', () {
    ...
    testWidgets('calls onTap when tapped', (WidgetTester tester) async {
      ...
      await tester.tap(find.byType(AnimatedModernMaintenanceCard));
      await tester.pump();

      expect(tapped, isTrue);
    });

    testWidgets('renders in destructive mode', (WidgetTester tester) async {
      await tester.pumpWidget(
        makeTestableWidget(
          AnimatedModernMaintenanceCard(
            title: 'Test Title',
      ...
      // You might need more specific checks for destructive mode,
      // like checking colors of widgets. This requires a bit more setup.
      // For now, we ensure it renders without error.
      expect(find.text('Test Title'), findsOneWidget);
    });
