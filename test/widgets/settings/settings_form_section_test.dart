...
void main() {
  testWidgets('renders header with icon, title, and description above the '
      'card children', (tester) async {
  ...
  testWidgets('omits icon chip and description when not provided', (
    tester,
  ) async {
    await tester.pumpWidget(
      const WidgetTestBench(
