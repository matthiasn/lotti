...
final class _DesignTokenGenerator {
  ...
  _Node _buildColorsNode() {
    final categories = <_Node>[
      ...
      _buildColorGroupNode(
        fieldName: 'aiCard',
        className: 'DsColorsAiCard',
        jsonMap: _colorJson['aiCard'] as Map<String, dynamic>,
        path: const ['color', 'aiCard'],
      ),
      _buildColorGroupNode(
        fieldName: 'proposalKind',
        className: 'DsColorsProposalKind',
      ...
      _buildColorGroupNode(
        ...
        className: 'DsColorsAiProvider',
        jsonMap: _colorJson['aiProvider'] as Map<String, dynamic>,
        path: const ['color', 'aiProvider'],
      ),
    ];
